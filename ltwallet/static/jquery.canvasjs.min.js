...
*/
(function(){function pa(h,m){h.prototype=db(m.prototype);h.prototype.constructor=h;h.base=m.prototype}function db(h){function m(){}m.prototype=h;return new m}function Wa(h,m,G){"millisecond"===G?h.setMilliseconds(h.getMilliseconds()+1*m):"second"===G?h.setSeconds(h.getSeconds()+1*m):"minute"===G?h.setMinutes(h.getMinutes()+1*m):"hour"===G?h.setHours(h.getHours()+1*m):"day"===G?h.setDate(h.getDate()+1*m):"week"===G?h.setDate(h.getDate()+7*m):"month"===G?h.setMonth(h.getMonth()+1*m):"year"===G&&h.setFullYear(h.getFullYear()+
1*m);return h}function da(h,m){var G=!1;0>h&&(G=!0,h*=-1);h=""+h;for(m=m?m:1;h.length<m;)h="0"+h;return G?"-"+h:h}function Ga(h){if(!h)return h;h=h.replace(/^\s\s*/,"");for(var m=/\s/,G=h.length;m.test(h.charAt(--G)););return h.slice(0,G+1)}function Ca(h){h.roundRect=function(h,G,r,v,ra,E,F,w){F&&(this.fillStyle=F);w&&(this.strokeStyle=w);"undefined"===typeof ra&&(ra=5);this.lineWidth=E;this.beginPath();this.moveTo(h+ra,G);this.lineTo(h+r-ra,G);this.quadraticCurveTo(h+r,G,h+r,G+ra);this.lineTo(h+
r,G+v-ra);this.quadraticCurveTo(h+r,G+v,h+r-ra,G+v);this.lineTo(h+ra,G+v);this.quadraticCurveTo(h,G+v,h,G+v-ra);this.lineTo(h,G+ra);this.quadraticCurveTo(h,G,h+ra,G);this.closePath();F&&this.fill();w&&0<E&&this.stroke()}}function Qa(h,m){return h-m}function P(h){var m=((h&16711680)>>16).toString(16),G=((h&65280)>>8).toString(16);h=((h&255)>>0).toString(16);m=2>m.length?"0"+m:m;G=2>G.length?"0"+G:G;h=2>h.length?"0"+h:h;return"#"+m+G+h}function eb(h,m){var G=this.length>>>0,r=Number(m)||0,r=0>r?Math.ceil(r):
Math.floor(r);for(0>r&&(r+=G);r<G;r++)if(r in this&&this[r]===h)return r;return-1}function r(h){return null===h||"undefined"===typeof h}function Da(h){h.indexOf||(h.indexOf=eb);return h}function fb(h){if(T.fSDec)h[ja("`eeDwdouMhrudods")](ja("e`u`@ohl`uhnoHuds`uhnoDoe"),function(){T._fTWm&&T._fTWm(h)})}function Xa(h,m,G){G=G||"normal";var r=h+"_"+m+"_"+G,v=Ya[r];if(isNaN(v)){try{if(!sa){var ra=document.body;sa=document.createElement("span");sa.innerHTML="";var E=document.createTextNode("Mpgyi");sa.appendChild(E);
ra.appendChild(sa)}sa.style.display="";L(sa,{position:"absolute",left:"0px",top:"-20000px",padding:"0px",margin:"0px",border:"none",whiteSpace:"pre",lineHeight:"normal",fontFamily:h,fontSize:m+"px",fontWeight:G});v=Math.round(sa.offsetHeight);sa.style.display="none"}catch(F){v=Math.ceil(1.1*m)}v=Math.max(v,m);Ya[r]=v}return v}function J(h,m){var G=[];if(G={solid:[],shortDash:[3,1],shortDot:[1,1],shortDashDot:[3,1,1,1],shortDashDotDot:[3,1,1,1,1,1],dot:[1,2],dash:[4,2],dashDot:[4,2,1,2],longDash:[8,
2],longDashDot:[8,2,1,2],longDashDotDot:[8,2,1,2,1,2]}[h||"solid"])for(var r=0;r<G.length;r++)G[r]*=m;else G=[];return G}function R(h,m,G,v,ia){v=v||[];ia=r(ia)?gb?{passive:!1,capture:!1}:!1:ia;v.push([h,m,G,ia]);return h.addEventListener?(h.addEventListener(m,G,ia),G):h.attachEvent?(v=function(m){m=m||window.event;m.preventDefault=m.preventDefault||function(){m.returnValue=!1};m.stopPropagation=m.stopPropagation||function(){m.cancelBubble=!0};G.call(h,m)},h.attachEvent("on"+m,v),v):!1}function hb(h){if(h._menuButton)h.exportEnabled?
(L(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColor,color:h.toolbar.fontColor}),La(h._menuButton),h._menuButton.title=h._cultureInfo.menuText):va(h._menuButton);else if(h.exportEnabled&&v){var m=!1;h._menuButton=document.createElement("button");wa(h,h._menuButton,"menu");h._toolBar.appendChild(h._menuButton);R(h._menuButton,"touchstart",function(h){m=!0},h.allDOMEventHandlers);R(h._menuButton,"click",function(){"none"!==h._dropdownMenu.style.display||h._dropDownCloseTime&&500>=(new Date).getTime()-
h._dropDownCloseTime.getTime()||(h._dropdownMenu.style.display="block",h._menuButton.blur(),h._dropdownMenu.focus())},h.allDOMEventHandlers,!0);R(h._menuButton,"mousemove",function(){m||(L(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColorOnHover,color:h.toolbar.fontColorOnHover}),0>=navigator.userAgent.search("MSIE")&&L(h._menuButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},h.allDOMEventHandlers,!0);R(h._menuButton,"mouseout",function(){m||(L(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColor,
color:h.toolbar.fontColor}),0>=navigator.userAgent.search("MSIE")&&L(h._menuButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},h.allDOMEventHandlers,!0)}if(h.exportEnabled&&h._dropdownMenu){L(h._dropdownMenu,{backgroundColor:h.toolbar.itemBackgroundColor,color:h.toolbar.fontColor});for(var G=h._dropdownMenu.childNodes,r=[h._cultureInfo.printText,h._cultureInfo.saveJPGText,h._cultureInfo.savePNGText],ia=0;ia<G.length;ia++)L(G[ia],{backgroundColor:h.toolbar.itemBackgroundColor,
color:h.toolbar.fontColor}),G[ia].innerHTML=r[ia]}else!h._dropdownMenu&&(h.exportEnabled&&v)&&(m=!1,h._dropdownMenu=document.createElement("div"),h._dropdownMenu.setAttribute("tabindex",-1),G=-1!==h.theme.indexOf("dark")?"black":"#888888",L(h._dropdownMenu,{position:"absolute",zIndex:1,userSelect:"none",MozUserSeelct:"none",WebkitUserSelect:"none",msUserSelect:"none",cursor:"pointer",right:"0px",top:"25px",minWidth:"120px",outline:0,fontSize:"14px",fontFamily:"Arial, Helvetica, sans-serif",padding:"5px 0px 5px 0px",
textAlign:"left",lineHeight:"10px",backgroundColor:h.toolbar.itemBackgroundColor,boxShadow:"2px 2px 10px"+G}),h._dropdownMenu.style.display="none",h._toolBar.appendChild(h._dropdownMenu),R(h._dropdownMenu,"blur",function(){va(h._dropdownMenu);h._dropDownCloseTime=new Date},h.allDOMEventHandlers,!0),G=document.createElement("div"),L(G,{padding:"12px 8px 12px 8px"}),G.innerHTML=h._cultureInfo.printText,G.style.backgroundColor=h.toolbar.itemBackgroundColor,G.style.color=h.toolbar.fontColor,h._dropdownMenu.appendChild(G),
R(G,"touchstart",function(h){m=!0},h.allDOMEventHandlers),R(G,"mousemove",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColorOnHover,this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0),R(G,"mouseout",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColor,this.style.color=h.toolbar.fontColor)},h.allDOMEventHandlers,!0),R(G,"click",function(){h.print();va(h._dropdownMenu)},h.allDOMEventHandlers,!0),G=document.createElement("div"),L(G,{padding:"12px 8px 12px 8px"}),
G.innerHTML=h._cultureInfo.saveJPGText,G.style.backgroundColor=h.toolbar.itemBackgroundColor,G.style.color=h.toolbar.fontColor,h._dropdownMenu.appendChild(G),R(G,"touchstart",function(h){m=!0},h.allDOMEventHandlers),R(G,"mousemove",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColorOnHover,this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0),R(G,"mouseout",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColor,this.style.color=h.toolbar.fontColor)},
h.allDOMEventHandlers,!0),R(G,"click",function(){h.exportChart({format:"jpeg",fileName:h.exportFileName});va(h._dropdownMenu)},h.allDOMEventHandlers,!0),G=document.createElement("div"),L(G,{padding:"12px 8px 12px 8px"}),G.innerHTML=h._cultureInfo.savePNGText,G.style.backgroundColor=h.toolbar.itemBackgroundColor,G.style.color=h.toolbar.fontColor,h._dropdownMenu.appendChild(G),R(G,"touchstart",function(h){m=!0},h.allDOMEventHandlers),R(G,"mousemove",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColorOnHover,
this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0),R(G,"mouseout",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColor,this.style.color=h.toolbar.fontColor)},h.allDOMEventHandlers,!0),R(G,"click",function(){h.exportChart({format:"png",fileName:h.exportFileName});va(h._dropdownMenu)},h.allDOMEventHandlers,!0))}function Za(h,m,G){h*=la;m*=la;h=G.getImageData(h,m,2,2).data;m=!0;for(G=0;4>G;G++)if(h[G]!==h[G+4]|h[G]!==h[G+8]|h[G]!==h[G+12]){m=!1;break}return m?
h[0]<<16|h[1]<<8|h[2]:0}function ma(h,m,G){return h in m?m[h]:G[h]}function Ma(h,m,G){if(v&&$a){var r=h.getContext("2d");Na=r.webkitBackingStorePixelRatio||r.mozBackingStorePixelRatio||r.msBackingStorePixelRatio||r.oBackingStorePixelRatio||r.backingStorePixelRatio||1;la=Ra/Na;h.width=m*la;h.height=G*la;Ra!==Na&&(h.style.width=m+"px",h.style.height=G+"px",r.scale(la,la))}else h.width=m,h.height=G}function ib(h){if(!jb){var m=!1,r=!1;"undefined"===typeof qa.Chart.creditHref?(h.creditHref=ja("iuuqr;..b`ow`rkr/bnl."),
h.creditText=ja("B`ow`rKR/bnl")):(m=h.updateOption("creditText"),r=h.updateOption("creditHref"));if(h.creditHref&&h.creditText){h._creditLink||(h._creditLink=document.createElement("a"),h._creditLink.setAttribute("class","canvasjs-chart-credit"),h._creditLink.setAttribute("title","JavaScript Charts"),L(h._creditLink,{outline:"none",margin:"0px",position:"absolute",right:"2px",top:h.height-14+"px",color:"dimgrey",textDecoration:"none",fontSize:"11px",fontFamily:"Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"}),
...
var r=document.createElement("canvas");r.setAttribute("class","canvasjs-chart-canvas");Ma(r,h,m);v||"undefined"===typeof G_vmlCanvasManager||G_vmlCanvasManager.initElement(r);return r}function L(h,m){for(var r in m)h.style[r]=m[r]}function wa(h,m,r){m.getAttribute("state")||(m.style.backgroundColor=h.toolbar.itemBackgroundColor,m.style.color=h.toolbar.fontColor,m.style.border="none",L(m,{WebkitUserSelect:"none",MozUserSelect:"none",msUserSelect:"none",userSelect:"none"}));m.getAttribute("state")!==
r&&(m.setAttribute("state",r),m.setAttribute("type","button"),L(m,{padding:"5px 12px",cursor:"pointer","float":"left",width:"40px",height:"25px",outline:"0px",verticalAlign:"baseline",lineHeight:"0"}),m.setAttribute("title",h._cultureInfo[r+"Text"]),m.innerHTML="<img src='"+kb[r].image+"' alt='"+h._cultureInfo[r+"Text"]+"' />",L(m.childNodes[0],{height:"95%",pointerEvents:"none"}))}function La(){for(var h=null,m=0;m<arguments.length;m++)h=arguments[m],h.style&&(h.style.display="inline")}function va(){for(var h=
null,m=0;m<arguments.length;m++)(h=arguments[m])&&h.style&&(h.style.display="none")}function Sa(h,m,r,v,ia){if(null===h||"undefined"===typeof h)return"undefined"===typeof r?m:r;h=parseFloat(h.toString())*(0<=h.toString().indexOf("%")?m/100:1);"undefined"!==typeof v&&(h=Math.min(v,h),"undefined"!==typeof ia&&(h=Math.max(ia,h)));return!isNaN(h)&&h<=m&&0<=h?h:"undefined"===typeof r?m:r}function Y(h,m,G,v,ia){this._defaultsKey=h;this._themeOptionsKey=m;this._index=v;this.parent=ia;this._eventListeners=
[];h={};this.theme&&r(this.parent)&&r(m)&&r(v)?h=r(this.predefinedThemes[this.theme])?this.predefinedThemes.light1:this.predefinedThemes[this.theme]:this.parent&&(this.parent.themeOptions&&this.parent.themeOptions[m])&&(null===v?h=this.parent.themeOptions[m]:0<this.parent.themeOptions[m].length&&(v=Math.min(this.parent.themeOptions[m].length-1,v),h=this.parent.themeOptions[m][v]));this.themeOptions=h;this.options=G?G:{_isPlaceholder:!0};this.setOptions(this.options,h)}function Ea(h,m,r,v,ia){"undefined"===
typeof ia&&(ia=0);this._padding=ia;this._x1=h;this._y1=m;this._x2=r;this._y2=v;this._rightOccupied=this._leftOccupied=this._bottomOccupied=this._topOccupied=this._padding}function ka(h,m){ka.base.constructor.call(this,"TextBlock",null,m,null,null);this.ctx=h;this._isDirty=!0;this._wrappedText=null;this._initialize()}function Ta(h,m){Ta.base.constructor.call(this,"Toolbar","toolbar",m,null,h);this.chart=h;this.canvas=h.canvas;this.ctx=this.chart.ctx;this.optionsName="toolbar"}function ya(h,m){ya.base.constructor.call(this,
"Title","title",m,null,h);this.chart=h;this.canvas=h.canvas;this.ctx=this.chart.ctx;this.optionsName="title";if(r(this.options.margin)&&h.options.subtitles)for(var G=h.options.subtitles,v=0;v<G.length;v++)if((r(G[v].horizontalAlign)&&"center"===this.horizontalAlign||G[v].horizontalAlign===this.horizontalAlign)&&(r(G[v].verticalAlign)&&"top"===this.verticalAlign||G[v].verticalAlign===this.verticalAlign)&&!G[v].dockInsidePlotArea===!this.dockInsidePlotArea){this.margin=0;break}"undefined"===typeof this.options.fontSize&&
...
[]}function Ja(h){var m;h&&Ka[h]&&(m=Ka[h]);Ja.base.constructor.call(this,"CultureInfo",null,m,null,null)}var Ha=!1,T={},v=!!document.createElement("canvas").getContext,qa={Chart:{width:500,height:400,zoomEnabled:!1,zoomType:"x",backgroundColor:"white",theme:"light1",animationEnabled:!1,animationDuration:1200,dataPointWidth:null,dataPointMinWidth:null,dataPointMaxWidth:null,colorSet:"colorSet1",culture:"en",creditText:"CanvasJS",interactivityEnabled:!0,exportEnabled:!1,exportFileName:"Chart",rangeChanging:null,
...
Ka={en:{}},F=v?"Trebuchet MS, Helvetica, sans-serif":"Arial",Fa=v?"Impact, Charcoal, sans-serif":"Arial",za={colorSet1:"#4F81BC #C0504E #9BBB58 #23BFAA #8064A1 #4AACC5 #F79647 #7F6084 #77A033 #33558B #E59566".split(" "),colorSet2:"#6D78AD #51CDA0 #DF7970 #4C9CA0 #AE7D99 #C9D45C #5592AD #DF874D #52BCA8 #8E7AA3 #E3CB64 #C77B85 #C39762 #8DD17E #B57952 #FCC26C".split(" "),colorSet3:"#8CA1BC #36845C #017E82 #8CB9D0 #708C98 #94838D #F08891 #0366A7 #008276 #EE7757 #E5BA3A #F2990B #03557B #782970".split(" ")},
K,ca,Z,V,W;ca="#333333";Z="#000000";K="#666666";W=V="#000000";var fa=20,w=14,Va={colorSet:"colorSet1",backgroundColor:"#FFFFFF",title:{fontFamily:Fa,fontSize:32,fontColor:ca,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Fa,fontSize:w,fontColor:ca,fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelFontFamily:F,indexLabelFontSize:w,indexLabelFontColor:ca,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:F,titleFontSize:fa,titleFontColor:ca,
titleFontWeight:"normal",labelFontFamily:F,labelFontSize:w,labelFontColor:Z,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:F,labelFontSize:w,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:F,labelFontSize:w,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:W,color:V,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",
spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisX2:[{titleFontFamily:F,titleFontSize:fa,titleFontColor:ca,titleFontWeight:"normal",labelFontFamily:F,labelFontSize:w,labelFontColor:Z,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:F,labelFontSize:w,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:F,
labelFontSize:w,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:W,color:V,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{titleFontFamily:F,titleFontSize:fa,titleFontColor:ca,titleFontWeight:"normal",labelFontFamily:F,labelFontSize:w,labelFontColor:Z,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:F,
labelFontSize:w,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:F,labelFontSize:w,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:W,color:V,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:F,titleFontSize:fa,titleFontColor:ca,titleFontWeight:"normal",labelFontFamily:F,labelFontSize:w,
labelFontColor:Z,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:F,labelFontSize:w,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:F,labelFontSize:w,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:W,color:V,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,
lineDashType:"solid"}}],legend:{fontFamily:F,fontSize:14,fontColor:ca,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:F,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1},toolbar:{itemBackgroundColor:"white",itemBackgroundColorOnHover:"#2196f3",buttonBorderColor:"#2196f3",buttonBorderThickness:1,fontColor:"black",fontColorOnHover:"white"}};Z=ca="#F5F5F5";K="#FFFFFF";V="#40BAF1";W="#F5F5F5";var fa=20,w=14,ab={colorSet:"colorSet2",title:{fontFamily:F,
fontSize:33,fontColor:"#3A3A3A",fontWeight:"bold",verticalAlign:"top",margin:5},subtitles:[{fontFamily:F,fontSize:w,fontColor:"#3A3A3A",fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelFontFamily:F,indexLabelFontSize:w,indexLabelFontColor:"#666666",indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:F,titleFontSize:fa,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:F,labelFontSize:w,labelFontColor:"#666666",labelFontWeight:"normal",
lineThickness:1,lineColor:"#BBBBBB",tickThickness:1,tickColor:"#BBBBBB",gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:F,labelFontSize:w,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:F,labelFontSize:w,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,
lineDashType:"solid"}}],axisX2:[{titleFontFamily:F,titleFontSize:fa,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:F,labelFontSize:w,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:1,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:F,labelFontSize:w,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:F,labelFontSize:w,
labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{titleFontFamily:F,titleFontSize:fa,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:F,labelFontSize:w,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:0,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",
stripLines:[{labelFontFamily:F,labelFontSize:w,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:F,labelFontSize:w,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:F,titleFontSize:fa,titleFontColor:"#666666",titleFontWeight:"normal",
labelFontFamily:F,labelFontSize:w,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:0,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:F,labelFontSize:w,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:F,labelFontSize:w,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},
scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],legend:{fontFamily:F,fontSize:14,fontColor:"#3A3A3A",fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:F,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1},toolbar:{itemBackgroundColor:"white",itemBackgroundColorOnHover:"#2196f3",buttonBorderColor:"#2196f3",buttonBorderThickness:1,fontColor:"black",fontColorOnHover:"white"}};Z=ca="#F5F5F5";K="#FFFFFF";
V="#40BAF1";W="#F5F5F5";fa=20;w=14;Fa={colorSet:"colorSet12",backgroundColor:"#2A2A2A",title:{fontFamily:Fa,fontSize:32,fontColor:ca,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Fa,fontSize:w,fontColor:ca,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{itemBackgroundColor:"#666666",itemBackgroundColorOnHover:"#FF7372",buttonBorderColor:"#FF7372",buttonBorderThickness:1,fontColor:"#F5F5F5",fontColorOnHover:"#F5F5F5"},data:[{indexLabelFontFamily:F,indexLabelFontSize:w,
indexLabelFontColor:Z,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:F,titleFontSize:fa,titleFontColor:Z,titleFontWeight:"normal",labelFontFamily:F,labelFontSize:w,labelFontColor:Z,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:F,labelFontSize:w,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:F,
labelFontSize:w,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:W,color:V,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisX2:[{titleFontFamily:F,titleFontSize:fa,titleFontColor:Z,titleFontWeight:"normal",labelFontFamily:F,labelFontSize:w,labelFontColor:Z,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:F,
labelFontSize:w,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:F,labelFontSize:w,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:W,color:V,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY:[{titleFontFamily:F,titleFontSize:fa,titleFontColor:Z,titleFontWeight:"normal",labelFontFamily:F,labelFontSize:w,
labelFontColor:Z,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:F,labelFontSize:w,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:F,labelFontSize:w,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:W,color:V,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,
lineDashType:"solid",color:"#111111"}}],axisY2:[{titleFontFamily:F,titleFontSize:fa,titleFontColor:Z,titleFontWeight:"normal",labelFontFamily:F,labelFontSize:w,labelFontColor:Z,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:F,labelFontSize:w,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:F,labelFontSize:w,labelFontColor:"#000000",
labelFontWeight:"normal",labelBackgroundColor:W,color:V,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],legend:{fontFamily:F,fontSize:14,fontColor:ca,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:F,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1,fontColor:Z,backgroundColor:"rgba(0, 0, 0, .7)"}};K="#FFFFFF";Z=ca="#FAFAFA";V="#40BAF1";W="#F5F5F5";
var fa=20,w=14,bb={light1:Va,light2:ab,dark1:Fa,dark2:{colorSet:"colorSet2",backgroundColor:"#32373A",title:{fontFamily:F,fontSize:32,fontColor:ca,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:F,fontSize:w,fontColor:ca,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{itemBackgroundColor:"#666666",itemBackgroundColorOnHover:"#FF7372",buttonBorderColor:"#FF7372",buttonBorderThickness:1,fontColor:"#F5F5F5",fontColorOnHover:"#F5F5F5"},data:[{indexLabelFontFamily:F,
indexLabelFontSize:w,indexLabelFontColor:Z,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:F,titleFontSize:fa,titleFontColor:Z,titleFontWeight:"normal",labelFontFamily:F,labelFontSize:w,labelFontColor:Z,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:F,labelFontSize:w,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:F,
labelFontSize:w,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:W,color:V,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisX2:[{titleFontFamily:F,titleFontSize:fa,titleFontColor:Z,titleFontWeight:"normal",labelFontFamily:F,labelFontSize:w,labelFontColor:Z,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:F,
labelFontSize:w,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:F,labelFontSize:w,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:W,color:V,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY:[{titleFontFamily:F,titleFontSize:fa,titleFontColor:Z,titleFontWeight:"normal",labelFontFamily:F,labelFontSize:w,
labelFontColor:Z,labelFontWeight:"normal",lineThickness:0,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:F,labelFontSize:w,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:F,labelFontSize:w,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:W,color:V,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,
lineDashType:"solid",color:"#111111"}}],axisY2:[{titleFontFamily:F,titleFontSize:fa,titleFontColor:Z,titleFontWeight:"normal",labelFontFamily:F,labelFontSize:w,labelFontColor:Z,labelFontWeight:"normal",lineThickness:0,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:F,labelFontSize:w,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:F,labelFontSize:w,labelFontColor:"#000000",
labelFontWeight:"normal",labelBackgroundColor:W,color:V,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],legend:{fontFamily:F,fontSize:14,fontColor:ca,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:F,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1,fontColor:Z,backgroundColor:"rgba(0, 0, 0, .7)"}},theme1:Va,theme2:ab,theme3:Va},X={numberDuration:1,
yearDuration:314496E5,monthDuration:2592E6,weekDuration:6048E5,dayDuration:864E5,hourDuration:36E5,minuteDuration:6E4,secondDuration:1E3,millisecondDuration:1,dayOfWeekFromInt:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ")};(function(){T.fSDec=function(h){for(var m="",r=0;r<h.length;r++)m+=String.fromCharCode(h[r]-111);return m};T.str={ncv:[189,222,221,156,178,222,220,220,212,225,210,216,208,219,143,197,212,225,226,216,222,221],fntStr:[223,231,143,178,208,219,216,209,225,216,
155,143,187,228,210,216,211,208,143,182,225,208,221,211,212,155,143,187,228,210,216,211,208,143,194,208,221,226,143,196,221,216,210,222,211,212,155,143,176,225,216,208,219,155,143,226,208,221,226,156,226,212,225,216,213],tBl:[227,212,231,227,177,208,226,212,219,216,221,212],fnt:[213,222,221,227],fSy:[213,216,219,219,194,227,232,219,212],fTx:[213,216,219,219,195,212,231,227],gr:[214,225,212,232],ct:[210,227,231],tp:[227,222,223]};delete qa[T.fSDec([178,215,208,225,227])][T.fSDec([210,225,212,211,216,
227,183,225,212,213])];T.pro={sCH:qa[T.fSDec([178,215,208,225,227])][T.fSDec([210,225,212,211,216,227,183,225,212,213])]};T._fTWm=function(h){if("undefined"===typeof T.pro.sCH&&!cb){var m=h[T.fSDec(T.str.ct)];m[T.fSDec(T.str.tBl)]=T.fSDec(T.str.tp);m[T.fSDec(T.str.fnt)]=11+T.fSDec(T.str.fntStr);m[T.fSDec(T.str.fSy)]=T.fSDec(T.str.gr);m[T.fSDec(T.str.fTx)](T.fSDec(T.str.ncv),2,h.height-11-2)}}})();var gb=function(){var h=!1;try{var m=Object.defineProperty&&Object.defineProperty({},"passive",{get:function(){h=
!0;return!1}});window.addEventListener&&(window.addEventListener("test",null,m),window.removeEventListener("test",null,m))}catch(r){h=!1}return h}(),Ya={},sa=null,lb=function(){this.ctx.clearRect(0,0,this.width,this.height);this.backgroundColor&&(this.ctx.fillStyle=this.backgroundColor,this.ctx.fillRect(0,0,this.width,this.height))},xa=function(h){h.width=1;h.height=1;h.getContext("2d")&&h.getContext("2d").clearRect(0,0,1,1)},mb=function(h,m,r){m=Math.min(this.width,this.height);return Math.max("theme4"===
...
E=/[^-+\dA-Z]/g;return function(w,J,O){var K=O?O.days:m,P=O?O.months:v,R=O?O.shortDays:r,X=O?O.shortMonths:ia;O="";var T=!1;w=w&&w.getTime?w:w?new Date(w):new Date;if(isNaN(w))throw SyntaxError("invalid date");"UTC:"===J.slice(0,4)&&(J=J.slice(4),T=!0);O=T?"getUTC":"get";var L=w[O+"Date"](),M=w[O+"Day"](),$=w[O+"Month"](),a=w[O+"FullYear"](),d=w[O+"Hours"](),c=w[O+"Minutes"](),b=w[O+"Seconds"](),e=w[O+"Milliseconds"](),f=T?0:w.getTimezoneOffset();return O=J.replace(h,function(l){switch(l){case "D":return L;
case "DD":return da(L,2);case "DDD":return R[M];case "DDDD":return K[M];case "M":return $+1;case "MM":return da($+1,2);case "MMM":return X[$];case "MMMM":return P[$];case "Y":return parseInt(String(a).slice(-2));case "YY":return da(String(a).slice(-2),2);case "YYY":return da(String(a).slice(-3),3);case "YYYY":return da(a,4);case "h":return d%12||12;case "hh":return da(d%12||12,2);case "H":return d;case "HH":return da(d,2);case "m":return c;case "mm":return da(c,2);case "s":return b;case "ss":return da(b,
2);case "f":return da(String(e),3).slice(0,1);case "ff":return da(String(e),3).slice(0,2);case "fff":return da(String(e),3).slice(0,3);case "t":return 12>d?"a":"p";case "tt":return 12>d?"am":"pm";case "T":return 12>d?"A":"P";case "TT":return 12>d?"AM":"PM";case "K":return T?"UTC":(String(w).match(F)||[""]).pop().replace(E,"");case "z":return(0<f?"-":"+")+Math.floor(Math.abs(f)/60);case "zz":return(0<f?"-":"+")+da(Math.floor(Math.abs(f)/60),2);case "zzz":return(0<f?"-":"+")+da(Math.floor(Math.abs(f)/
60),2)+da(Math.abs(f)%60,2);default:return l.slice(1,l.length-1)}})}}(),ea=function(h,m,r){if(null===h)return"";if(!isFinite(h))return h;h=Number(h);var v=0>h?!0:!1;v&&(h*=-1);var F=r?r.decimalSeparator:".",w=r?r.digitGroupSeparator:",",E="";m=String(m);var E=1,J=r="",K=-1,O=[],P=[],T=0,R=0,X=0,L=!1,Y=0,J=m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);m=null;for(var M=0;J&&M<J.length;M++)if(m=J[M],"."===m&&0>K)K=M;else{if("%"===m)E*=100;else if("\u2030"===m){E*=1E3;continue}else if(","===
m[0]&&"."===m[m.length-1]){E/=Math.pow(1E3,m.length-1);K=M+m.length-1;continue}else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||(L=!0);0>K?(O.push(m),"#"===m||"0"===m?T++:","===m&&X++):(P.push(m),"#"!==m&&"0"!==m||R++)}L&&(m=Math.floor(h),J=-Math.floor(Math.log(h)/Math.LN10+1),Y=0===h?0:0===m?-(T+J):String(m).length-T,E/=Math.pow(10,Y));0>K&&(K=M);E=(h*E).toFixed(R);m=E.split(".");E=(m[0]+"").split("");h=(m[1]+"").split("");E&&"0"===E[0]&&E.shift();for(L=J=M=R=K=0;0<O.length;)if(m=O.pop(),"#"===m||
"0"===m)if(K++,K===T){var $=E,E=[];if("0"===m)for(m=T-R-($?$.length:0);0<m;)$.unshift("0"),m--;for(;0<$.length;)r=$.pop()+r,L++,0===L%J&&(M===X&&0<$.length)&&(r=w+r)}else 0<E.length?(r=E.pop()+r,R++,L++):"0"===m&&(r="0"+r,R++,L++),0===L%J&&(M===X&&0<E.length)&&(r=w+r);else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?","===m?(M++,J=L,L=0,0<E.length&&(r=w+r)):r=1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?m.slice(1,m.length-1)+r:m+r:(m=0>Y?
m.replace("+","").replace("-",""):m.replace("-",""),r+=m.replace(/[0]+/,function(a){return da(Y,a.length)}));w="";for(O=!1;0<P.length;)m=P.shift(),"#"===m||"0"===m?0<h.length&&0!==Number(h.join(""))?(w+=h.shift(),O=!0):"0"===m&&(w+="0",O=!0):1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?w+=m.slice(1,m.length-1):"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?w+=m:(m=0>Y?m.replace("+","").replace("-",""):m.replace("-",""),w+=m.replace(/[0]+/,function(a){return da(Y,
a.length)}));r+=(O?F:"")+w;return v?"-"+r:r},Oa=function(h){var m=0,r=0;h=h||window.event;h.offsetX||0===h.offsetX?(m=h.offsetX,r=h.offsetY):h.layerX||0==h.layerX?(m=h.layerX,r=h.layerY):(m=h.pageX-h.target.offsetLeft,r=h.pageY-h.target.offsetTop);return{x:m,y:r}},$a=!0,Ra=window.devicePixelRatio||1,Na=1,la=$a?Ra/Na:1,ba=function(h,m,r,v,w,F,E,J,K,O,P,R,T){"undefined"===typeof T&&(T=1);E=E||0;J=J||"black";var L=15<v-m&&15<w-r?8:0.35*Math.min(v-m,w-r);h.beginPath();h.moveTo(m,r);h.save();h.fillStyle=
F;h.globalAlpha=T;h.fillRect(m,r,v-m,w-r);h.globalAlpha=1;0<E&&(T=0===E%2?0:0.5,h.beginPath(),h.lineWidth=E,h.strokeStyle=J,h.moveTo(m,r),h.rect(m-T,r-T,v-m+2*T,w-r+2*T),h.stroke());h.restore();!0===K&&(h.save(),h.beginPath(),h.moveTo(m,r),h.lineTo(m+L,r+L),h.lineTo(v-L,r+L),h.lineTo(v,r),h.closePath(),E=h.createLinearGradient((v+m)/2,r+L,(v+m)/2,r),E.addColorStop(0,F),E.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=E,h.fill(),h.restore());!0===O&&(h.save(),h.beginPath(),h.moveTo(m,w),h.lineTo(m+
L,w-L),h.lineTo(v-L,w-L),h.lineTo(v,w),h.closePath(),E=h.createLinearGradient((v+m)/2,w-L,(v+m)/2,w),E.addColorStop(0,F),E.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=E,h.fill(),h.restore());!0===P&&(h.save(),h.beginPath(),h.moveTo(m,r),h.lineTo(m+L,r+L),h.lineTo(m+L,w-L),h.lineTo(m,w),h.closePath(),E=h.createLinearGradient(m+L,(w+r)/2,m,(w+r)/2),E.addColorStop(0,F),E.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=E,h.fill(),h.restore());!0===R&&(h.save(),h.beginPath(),h.moveTo(v,
r),h.lineTo(v-L,r+L),h.lineTo(v-L,w-L),h.lineTo(v,w),E=h.createLinearGradient(v-L,(w+r)/2,v,(w+r)/2),E.addColorStop(0,F),E.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=E,E.addColorStop(0,F),E.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=E,h.fill(),h.closePath(),h.restore())},ja=function(h){for(var m="",r=0;r<h.length;r++)m+=String.fromCharCode(Math.ceil(h.length/57/5)^h.charCodeAt(r));return m},cb=window&&window[ja("mnb`uhno")]&&window[ja("mnb`uhno")].href&&window[ja("mnb`uhno")].href.indexOf&&
...
Y.prototype.setOptions=function(h,m){if(qa[this._defaultsKey]){var r=qa[this._defaultsKey],v;for(v in r)"publicProperties"!==v&&r.hasOwnProperty(v)&&(this[v]=h&&v in h?h[v]:m&&v in m?m[v]:r[v])}else Ha&&window.console&&console.log("defaults not set")};Y.prototype.get=function(h){var m=qa[this._defaultsKey];if("options"===h)return this.options&&this.options._isPlaceholder?null:this.options;if(m.hasOwnProperty(h)||m.publicProperties&&m.publicProperties.hasOwnProperty(h))return this[h];window.console&&
window.console.log('Property "'+h+"\" doesn't exist. Please check for typo.")};Y.prototype.set=function(h,m,r){r="undefined"===typeof r?!0:r;var v=qa[this._defaultsKey];if("options"===h)this.createUserOptions(m);else if(v.hasOwnProperty(h)||v.publicProperties&&v.publicProperties.hasOwnProperty(h)&&"readWrite"===v.publicProperties[h])this.options._isPlaceholder&&this.createUserOptions(),this.options[h]=m;else{window.console&&(v.publicProperties&&v.publicProperties.hasOwnProperty(h)&&"readOnly"===v.publicProperties[h]?
window.console.log('Property "'+h+'" is read-only.'):window.console.log('Property "'+h+"\" doesn't exist. Please check for typo."));return}r&&(this.stockChart||this.chart||this).render()};Y.prototype.addTo=function(h,m,r,v){v="undefined"===typeof v?!0:v;var w=qa[this._defaultsKey];w.hasOwnProperty(h)||w.publicProperties&&w.publicProperties.hasOwnProperty(h)&&"readWrite"===w.publicProperties[h]?(this.options._isPlaceholder&&this.createUserOptions(),"undefined"===typeof this.options[h]&&(this.options[h]=
[]),h=this.options[h],r="undefined"===typeof r||null===r?h.length:r,h.splice(r,0,m),v&&(this.stockChart||this.chart||this).render()):window.console&&(w.publicProperties&&w.publicProperties.hasOwnProperty(h)&&"readOnly"===w.publicProperties[h]?window.console.log('Property "'+h+'" is read-only.'):window.console.log('Property "'+h+"\" doesn't exist. Please check for typo."))};Y.prototype.createUserOptions=function(h){if("undefined"!==typeof h||this.options._isPlaceholder)if(this.parent.options._isPlaceholder&&
...
m=r):m=void 0,h[m]=this.options};Y.prototype.remove=function(h){h="undefined"===typeof h?!0:h;if(this.isOptionsInArray){var m=this.parent.options[this.optionsName];Da(m);var r=m.indexOf(this.options);0<=r&&m.splice(r,1)}else delete this.parent.options[this.optionsName];h&&(this.stockChart||this.chart||this).render()};Y.prototype.updateOption=function(h){!qa[this._defaultsKey]&&(Ha&&window.console)&&console.log("defaults not set");var m=qa[this._defaultsKey],v={},w=this[h],F=this._themeOptionsKey,
J=this._index;this.theme&&r(this.parent)&&r(F)&&r(J)?v=r(this.predefinedThemes[this.theme])?this.predefinedThemes.light1:this.predefinedThemes[this.theme]:this.parent&&(this.parent.themeOptions&&this.parent.themeOptions[F])&&(null===J?v=this.parent.themeOptions[F]:0<this.parent.themeOptions[F].length&&(v=Math.min(this.parent.themeOptions[F].length-1,J),v=this.parent.themeOptions[F][v]));this.themeOptions=v;h in m&&(w=h in this.options?this.options[h]:v&&h in v?v[h]:m[h]);if(w===this[h])return!1;this[h]=
w;return!0};Y.prototype.trackChanges=function(h){if(!this.sessionVariables)throw"Session Variable Store not set";this.sessionVariables[h]=this.options[h]};Y.prototype.isBeingTracked=function(h){this.options._oldOptions||(this.options._oldOptions={});return this.options._oldOptions[h]?!0:!1};Y.prototype.hasOptionChanged=function(h){if(!this.sessionVariables)throw"Session Variable Store not set";return this.sessionVariables[h]!==this.options[h]};Y.prototype.addEventListener=function(h,m,r){h&&m&&(this._eventListeners[h]=
this._eventListeners[h]||[],this._eventListeners[h].push({context:r||this,eventHandler:m}))};Y.prototype.removeEventListener=function(h,m){if(h&&m&&this._eventListeners[h])for(var r=this._eventListeners[h],v=0;v<r.length;v++)if(r[v].eventHandler===m){r[v].splice(v,1);break}};Y.prototype.removeAllEventListeners=function(){this._eventListeners=[]};Y.prototype.dispatchEvent=function(h,m,r){if(h&&this._eventListeners[h]){m=m||{};for(var v=this._eventListeners[h],w=0;w<v.length;w++)v[w].eventHandler.call(v[w].context,
...
function(){return{x1:this._x1+this._leftOccupied,y1:this._y1+this._topOccupied,x2:this._x2-this._rightOccupied,y2:this._y2-this._bottomOccupied,width:this._x2-this._x1-this._rightOccupied-this._leftOccupied,height:this._y2-this._y1-this._bottomOccupied-this._topOccupied}};Ea.prototype.reset=function(){this._rightOccupied=this._leftOccupied=this._bottomOccupied=this._topOccupied=this._padding};pa(ka,Y);ka.prototype._initialize=function(){r(this.padding)||"object"!==typeof this.padding?this.topPadding=
...
this.measureText(this.ctx);this.ctx.translate(this.x,this.y+r);"middle"===this.textBaseline&&(r=-this._lineHeight/2);this.ctx.font=this._getFontString();this.ctx.rotate(Math.PI/180*this.angle);var v=0,w=this.topPadding,F=null;this.ctx.roundRect||Ca(this.ctx);(0<this.borderThickness&&this.borderColor||this.backgroundColor)&&this.ctx.roundRect(0,r,this.width,this.height,this.cornerRadius,this.borderThickness,this.backgroundColor,this.borderColor);this.ctx.fillStyle=this.fontColor;for(r=0;r<this._wrappedText.lines.length;r++){F=
this._wrappedText.lines[r];if("right"===this.horizontalAlign||"right"===this.textAlign)v=this.width-F.width-this.rightPadding;else if("left"===this.horizontalAlign||"left"===this.textAlign)v=this.leftPadding;else if("center"===this.horizontalAlign||"center"===this.textAlign)v=(this.width-(this.leftPadding+this.rightPadding))/2-F.width/2+this.leftPadding;this.ctx.fillText(F.text,v,w);w+=F.height}this.ctx.font=m;h&&this.ctx.restore()}};ka.prototype.setText=function(h){this.text=h;this._isDirty=!0;this._wrappedText=
null};ka.prototype.measureText=function(){this._lineHeight=Xa(this.fontFamily,this.fontSize,this.fontWeight);if(null===this.maxWidth)throw"Please set maxWidth and height for TextBlock";this._wrapText(this.ctx);this._isDirty=!1;return{width:this.width,height:this.height}};ka.prototype._getLineWithWidth=function(h,m,r){h=String(h);if(!h)return{text:"",width:0};var v=r=0,w=h.length-1,F=Infinity;for(this.ctx.font=this._getFontString();v<=w;){var F=Math.floor((v+w)/2),E=h.substr(0,F+1);r=this.ctx.measureText(E).width;
if(r<m)v=F+1;else if(r>m)w=F-1;else break}r>m&&1<E.length&&(E=E.substr(0,E.length-1),r=this.ctx.measureText(E).width);m=!0;if(E.length===h.length||" "===h[E.length])m=!1;m&&(h=E.split(" "),1<h.length&&h.pop(),E=h.join(" "),r=this.ctx.measureText(E).width);return{text:E,width:r}};ka.prototype._wrapText=function(){var h=new String(Ga(String(this.text))),m=[],r=this.ctx.font,v=0,w=0;this.ctx.font=this._getFontString();if(0===this.frontSize)w=v=0;else for(;0<h.length;){var F=this.maxHeight-(this.topPadding+
this.bottomPadding),E=this._getLineWithWidth(h,this.maxWidth-(this.leftPadding+this.rightPadding),!1);E.height=this._lineHeight;m.push(E);var J=w,w=Math.max(w,E.width),v=v+E.height,h=Ga(h.slice(E.text.length,h.length));F&&v>F&&(E=m.pop(),v-=E.height,w=J)}this._wrappedText={lines:m,width:w,height:v};this.width=w+(this.leftPadding+this.rightPadding);this.height=v+(this.topPadding+this.bottomPadding);this.ctx.font=r};ka.prototype._getFontString=function(){var h;h=""+(this.fontStyle?this.fontStyle+" ":
"");h+=this.fontWeight?this.fontWeight+" ":"";h+=this.fontSize?this.fontSize+"px ":"";var m=this.fontFamily?this.fontFamily+"":"";!v&&m&&(m=m.split(",")[0],"'"!==m[0]&&'"'!==m[0]&&(m="'"+m+"'"));return h+=m};pa(Ta,Y);pa(ya,Y);ya.prototype.setLayout=function(){if(this.text){var h=this.dockInsidePlotArea?this.chart.plotArea:this.chart,m=h.layoutManager.getFreeSpace(),v=m.x1,w=m.y1,F=0,J=0,E=this.chart._menuButton&&this.chart.exportEnabled&&"top"===this.verticalAlign?22:0,L,K;"top"===this.verticalAlign||
...
backgroundColor:this.backgroundColor,maxWidth:this.maxWidth,maxHeight:J,cornerRadius:this.cornerRadius,text:this.text,padding:this.padding,textBaseline:"top"});O=J.measureText();"top"===this.verticalAlign||"bottom"===this.verticalAlign?("top"===this.verticalAlign?(w=m.y1+2,K="top"):"bottom"===this.verticalAlign&&(w=m.y2-2-O.height,K="bottom"),"left"===this.horizontalAlign?v=m.x1+2:"center"===this.horizontalAlign?v=m.x1+m.width/2-O.width/2:"right"===this.horizontalAlign&&(v=m.x2-2-O.width-E),L=this.horizontalAlign,
this.width=O.width,this.height=O.height):"center"===this.verticalAlign&&("left"===this.horizontalAlign?(v=m.x1+2,w=m.y2-2-(this.maxWidth/2-O.width/2),F=-90,K="left",this.width=O.height,this.height=O.width):"right"===this.horizontalAlign?(v=m.x2-2,w=m.y1+2+(this.maxWidth/2-O.width/2),F=90,K="right",this.width=O.height,this.height=O.width):"center"===this.horizontalAlign&&(w=h.y1+(h.height/2-O.height/2),v=h.x1+(h.width/2-O.width/2),K="center",this.width=O.width,this.height=O.height),L="center");J.x=
v;J.y=w;J.angle=F;J.horizontalAlign=L;this._textBlock=J;h.layoutManager.registerSpace(K,{width:this.width+("left"===K||"right"===K?this.margin+2:0),height:this.height+("top"===K||"bottom"===K?this.margin+2:0)});this.bounds={x1:v,y1:w,x2:v+this.width,y2:w+this.height};this.ctx.textBaseline="top"}};ya.prototype.render=function(){this._textBlock&&this._textBlock.render(!0)};pa(Ia,Y);Ia.prototype.setLayout=ya.prototype.setLayout;Ia.prototype.render=ya.prototype.render;Ua.prototype.get=function(h,m){var r=
null;0<this.pool.length?(r=this.pool.pop(),Ma(r,h,m)):r=ua(h,m);return r};Ua.prototype.release=function(h){this.pool.push(h)};pa(Ja,Y);var Pa={addTheme:function(h,r){bb[h]=r},addColorSet:function(h,r){za[h]=r},addCultureInfo:function(h,r){Ka[h]=r},formatNumber:function(h,r,v){v=v||"en";if(Ka[v])return ea(h,r||"#,##0.##",new Ja(v));throw"Unknown Culture Name";},formatDate:function(h,r,v){v=v||"en";if(Ka[v])return Aa(h,r||"DD MMM YYYY",new Ja(v));throw"Unknown Culture Name";}};"undefined"!==typeof module&&
"undefined"!==typeof module.exports?module.exports=Pa:"function"===typeof define&&define.amd?define([],function(){return Pa}):(window.CanvasJS&&window.console&&window.console.log("CanvasJS namespace already exists. If you are loading both chart and stockchart scripts, just load stockchart alone as it includes all chart features."),window.CanvasJS=window.CanvasJS?window.CanvasJS:Pa);F=Pa.Chart=function(){function h(a,d){return a.x-d.x}function m(a,d,c){d=d||{};r(c)?(this.predefinedThemes=bb,this.optionsName=
...
"top",Ca(this.overlaidCanvasCtx)),this._eventManager=new W(this),this.windowResizeHandler=R(window,"resize",function(){b._updateSize()&&b.render()},this.allDOMEventHandlers),this._toolBar=document.createElement("div"),this._toolBar.setAttribute("class","canvasjs-chart-toolbar"),L(this._toolBar,{position:"absolute",right:"1px",top:"1px"}),this._canvasJSContainer.appendChild(this._toolBar),this.bounds={x1:0,y1:0,x2:this.width,y2:this.height},R(this.overlaidCanvas,"click",function(a){b._mouseEventHandler(a)},
...
2+1;var B=(a[l].x-a[f].x)/b;b=(a[l].y-a[f].y)/b;c[c.length]=a[s].x>a[f].x&&0<B||a[s].x<a[f].x&&0>B?{x:a[s].x+B/3,y:a[s].y+b/3}:{x:a[s].x,y:a[s].y+b/9};s=e;f=0===s?0:s-1;l=s===a.length-1?s:s+1;b=Math.abs((a[l].x-a[f].x)/(0===a[s].x-a[f].x?0.01:a[s].x-a[f].x))*(d-1)/2+1;B=(a[l].x-a[f].x)/b;b=(a[l].y-a[f].y)/b;c[c.length]=a[s].x>a[f].x&&0<B||a[s].x<a[f].x&&0>B?{x:a[s].x-B/3,y:a[s].y-b/3}:{x:a[s].x,y:a[s].y-b/9};c[c.length]=a[e]}return c}function F(a,d,c,b,e,f,l,s,B,k){var n=0;k?(l.color=f,s.color=f):
k=1;n=B?Math.abs(e-c):Math.abs(b-d);n=0<l.trimLength?Math.abs(n*l.trimLength/100):Math.abs(n-l.length);B?(c+=n/2,e-=n/2):(d+=n/2,b-=n/2);var n=1===Math.round(l.thickness)%2?0.5:0,p=1===Math.round(s.thickness)%2?0.5:0;a.save();a.globalAlpha=k;a.strokeStyle=s.color||f;a.lineWidth=s.thickness||2;a.setLineDash&&a.setLineDash(J(s.dashType,s.thickness));a.beginPath();B&&0<s.thickness?(a.moveTo(b-l.thickness/2,Math.round((c+e)/2)-p),a.lineTo(d+l.thickness/2,Math.round((c+e)/2)-p)):0<s.thickness&&(a.moveTo(Math.round((d+
b)/2)-p,c+l.thickness/2),a.lineTo(Math.round((d+b)/2)-p,e-l.thickness/2));a.stroke();a.strokeStyle=l.color||f;a.lineWidth=l.thickness||2;a.setLineDash&&a.setLineDash(J(l.dashType,l.thickness));a.beginPath();B&&0<l.thickness?(a.moveTo(b-n,c),a.lineTo(b-n,e),a.moveTo(d+n,c),a.lineTo(d+n,e)):0<l.thickness&&(a.moveTo(d,c+n),a.lineTo(b,c+n),a.moveTo(d,e-n),a.lineTo(b,e-n));a.stroke();a.restore()}function K(a,d){K.base.constructor.call(this,"Legend","legend",d,null,a);this.chart=a;this.canvas=a.canvas;
this.ctx=this.chart.ctx;this.ghostCtx=this.chart._eventManager.ghostCtx;this.items=[];this.optionsName="legend";this.height=this.width=0;this.orientation=null;this.dataSeries=[];this.bounds={x1:null,y1:null,x2:null,y2:null};"undefined"===typeof this.options.fontSize&&(this.fontSize=this.chart.getAutoFontSize(this.fontSize));this.lineHeight=Xa(this.fontFamily,this.fontSize,this.fontWeight);this.horizontalSpacing=this.fontSize}function Z(a,d,c,b){Z.base.constructor.call(this,"DataSeries","data",d,c,
...
++this.chart._eventManager.lastObjectId,this));this.stripLines=[];if(this.options.stripLines&&0<this.options.stripLines.length)for(a=0;a<this.options.stripLines.length;a++)this.stripLines.push(new O(this.chart,this.options.stripLines[a],a,++this.chart._eventManager.lastObjectId,this));this.options.crosshair&&(this.crosshair=new da(this.chart,this.options.crosshair,this));this._titleTextBlock=null;this.hasOptionChanged("viewportMinimum")&&null===this.viewportMinimum&&(this.options.viewportMinimum=
...
this.startValue)+(this.endValue.getTime?this.endValue.getTime():this.endValue))/2,this._thicknessType=null)}function da(a,d,c){da.base.constructor.call(this,"Crosshair","crosshair",d,null,c);this.chart=a;this.ctx=this.chart.ctx;this.axis=c;this.optionsName="crosshair";this._thicknessType="pixel"}function V(a,d){V.base.constructor.call(this,"ToolTip","toolTip",d,null,a);this.chart=a;this.canvas=a.canvas;this.ctx=this.chart.ctx;this.currentDataPointIndex=this.currentSeriesIndex=-1;this._prevY=this._prevX=
NaN;this.containerTransitionDuration=0.1;this.mozContainerTransition=this.getContainerTransition(this.containerTransitionDuration);this.optionsName="toolTip";this._initialize()}function W(a){this.chart=a;this.lastObjectId=0;this.objectMap=[];this.rectangularRegionEventSubscriptions=[];this.previousDataPointEventObject=null;this.ghostCanvas=ua(this.chart.width,this.chart.height);this.ghostCtx=this.ghostCanvas.getContext("2d");this.mouseoveredObjectMaps=[]}function ja(a){this.chart=a;this.ctx=this.chart.plotArea.ctx;
...
new Ta(this,this.options.toolbar);if(this.options.zoomEnabled||this.panEnabled){if(this._zoomButton)L(this._zoomButton,{borderRight:this.toolbar.buttonBorderThickness+"px solid "+this.toolbar.buttonBorderColor,backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor}),this._zoomButton.title=this._cultureInfo.zoomText;else{var d=!1;va(this._zoomButton=document.createElement("button"));wa(this,this._zoomButton,"pan");this._zoomButton.title=this._cultureInfo.panText;this._toolBar.appendChild(this._zoomButton);
this._zoomButton.style.borderRight=this.toolbar.buttonBorderThickness+"px solid "+this.toolbar.buttonBorderColor;R(this._zoomButton,"touchstart",function(a){d=!0},this.allDOMEventHandlers);R(this._zoomButton,"click",function(){a.zoomEnabled?(a.zoomEnabled=!1,a.panEnabled=!0,wa(a,a._zoomButton,"zoom")):(a.zoomEnabled=!0,a.panEnabled=!1,wa(a,a._zoomButton,"pan"));a.render()},this.allDOMEventHandlers);R(this._zoomButton,"mousemove",function(){d?d=!1:(L(a._zoomButton,{backgroundColor:a.toolbar.itemBackgroundColorOnHover,
color:a.toolbar.fontColorOnHover,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&L(a._zoomButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},this.allDOMEventHandlers);R(this._zoomButton,"mouseout",function(){d||(L(a._zoomButton,{backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&L(a._zoomButton.childNodes[0],{WebkitFilter:"invert(0%)",
...
null;if(a.sessionVariables.axisY2)for(b=0;b<a.sessionVariables.axisY2.length;b++)a.sessionVariables.axisY2[b].newViewportMinimum=null,a.sessionVariables.axisY2[b].newViewportMaximum=null;a.resetOverlayedCanvas();0>=navigator.userAgent.search("MSIE")&&L(a._resetButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"});va(a._zoomButton,a._resetButton);a.stockChart&&(a.stockChart._rangeEventParameter={stockChart:a.stockChart,source:"chart",index:a.stockChart.charts.indexOf(a),minimum:null,
...
R(this._resetButton,"mousemove",function(){d||(L(a._resetButton,{backgroundColor:a.toolbar.itemBackgroundColorOnHover,color:a.toolbar.fontColorOnHover,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&L(a._resetButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},this.allDOMEventHandlers),R(this._resetButton,"mouseout",function(){d||(L(a._resetButton,{backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor,transition:"0.4s",WebkitTransition:"0.4s"}),
0>=navigator.userAgent.search("MSIE")&&L(a._resetButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},this.allDOMEventHandlers),this.overlaidCanvas.style.cursor=a._defaultCursor);this.zoomEnabled||this.panEnabled||(this._zoomButton?(a._zoomButton.getAttribute("state")===a._cultureInfo.zoomText?(this.panEnabled=!0,this.zoomEnabled=!1):(this.zoomEnabled=!0,this.panEnabled=!1),La(a._zoomButton,a._resetButton)):(this.zoomEnabled=!0,this.panEnabled=!1))}else this.panEnabled=this.zoomEnabled=
...
0<=m._supportedChartTypes.indexOf(this.options.data[c].type)){var b=new Z(this,this.options.data[c],a-1,++this._eventManager.lastObjectId);"error"===b.type&&(b.linkedDataSeriesIndex=r(this.options.data[c].linkedDataSeriesIndex)?c-1:this.options.data[c].linkedDataSeriesIndex,0>b.linkedDataSeriesIndex||b.linkedDataSeriesIndex>=this.options.data.length||"number"!==typeof b.linkedDataSeriesIndex||"error"===this.options.data[b.linkedDataSeriesIndex].type)&&(b.linkedDataSeriesIndex=null);null===b.name&&
...
B=0,k=!1,n=!1,p;if("normal"===s.axisPlacement||"xySwapped"===s.axisPlacement)var q=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:a.axisX.logarithmic?0:-Infinity,g=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?
...
e>d.max&&"number"===typeof e&&(d.max=e);if(0<B){if(a.axisX.logarithmic){var u=b/s.dataPoints[B-1].x;1>u&&(u=1/u);c.minDiff>u&&1!==u&&(c.minDiff=u)}else u=b-s.dataPoints[B-1].x,0>u&&(u*=-1),c.minDiff>u&&0!==u&&(c.minDiff=u);null!==e&&null!==s.dataPoints[B-1].y&&(a.axisY.logarithmic?(u=e/s.dataPoints[B-1].y,1>u&&(u=1/u),d.minDiff>u&&1!==u&&(d.minDiff=u)):(u=e-s.dataPoints[B-1].y,0>u&&(u*=-1),d.minDiff>u&&0!==u&&(d.minDiff=u)))}if(b<q&&!k)null!==e&&(p=b);else{if(!k&&(k=!0,0<B)){B-=2;continue}if(b>g&&
!n)n=!0;else if(b>g&&n)continue;s.dataPoints[B].label&&(a.axisX.labels[b]=s.dataPoints[B].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&p<b&&(c.viewPortMin=p):(e<d.viewPortMin&&"number"===typeof e&&(d.viewPortMin=e),e>d.viewPortMax&&"number"===typeof e&&(d.viewPortMax=e))}}s.axisX.valueType=s.xValueType=f?"dateTime":"number"}};m.prototype._processStackedPlotUnit=function(a){if(a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length)){for(var d=
a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=[],s=[],B=Infinity,k=-Infinity,n=0;n<a.dataSeriesIndexes.length;n++){var p=this.data[a.dataSeriesIndexes[n]],q=0,g=!1,u=!1,h;if("normal"===p.axisPlacement||"xySwapped"===p.axisPlacement)var D=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:-Infinity,
...
b=p.dataPoints[q].x;e=r(p.dataPoints[q].y)?0:p.dataPoints[q].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<q){if(a.axisX.logarithmic){var m=b/p.dataPoints[q-1].x;1>m&&(m=1/m);c.minDiff>m&&1!==m&&(c.minDiff=m)}else m=b-p.dataPoints[q-1].x,0>m&&(m*=-1),c.minDiff>m&&0!==m&&(c.minDiff=m);null!==e&&null!==p.dataPoints[q-1].y&&(a.axisY.logarithmic?0<e&&(m=e/p.dataPoints[q-1].y,1>m&&(m=1/m),d.minDiff>m&&1!==m&&(d.minDiff=m)):(m=e-p.dataPoints[q-1].y,0>m&&(m*=-1),d.minDiff>m&&0!==m&&(d.minDiff=m)))}if(b<D&&
!g)null!==p.dataPoints[q].y&&(h=b);else{if(!g&&(g=!0,0<q)){q-=2;continue}if(b>t&&!u)u=!0;else if(b>t&&u)continue;p.dataPoints[q].label&&(a.axisX.labels[b]=p.dataPoints[q].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===p.dataPoints[q].y?c.viewPortMin===b&&h<b&&(c.viewPortMin=h):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l[b]?l[b]+=e:(l[b]=e,B=Math.min(e,B)):s[b]?s[b]+=e:(s[b]=e,k=Math.max(e,
k)))}}a.axisY.scaleBreaks&&(a.axisY.scaleBreaks.autoCalculate&&1<=a.axisY.scaleBreaks.maxNumberOfAutoBreaks)&&(d.dataPointYPositiveSums?(d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums,l),d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums,s)):(d.dataPointYPositiveSums=l,d.dataPointYNegativeSums=s));p.axisX.valueType=p.xValueType=f?"dateTime":"number"}for(q in l)l.hasOwnProperty(q)&&!isNaN(q)&&(a=l[q],a<d.min&&(d.min=Math.min(a,B)),a>d.max&&(d.max=a),q<c.viewPortMin||q>c.viewPortMax||
...
this.data[a.dataSeriesIndexes[k]],p=0,q=!1,g=!1,u;if("normal"===n.axisPlacement||"xySwapped"===n.axisPlacement)var h=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:-Infinity,m=a.axisX.sessionVariables.newViewportMaximum?a.axisX.sessionVariables.newViewportMaximum:this.options.axisX&&this.options.axisX.viewportMaximum?
this.options.axisX.viewportMaximum:this.options.axisX&&this.options.axisX.maximum?this.options.axisX.maximum:Infinity;if(n.dataPoints[p].x&&n.dataPoints[p].x.getTime||"dateTime"===n.xValueType)f=!0;for(p=0;p<n.dataPoints.length;p++){"undefined"===typeof n.dataPoints[p].x&&(n.dataPoints[p].x=p+(a.axisX.logarithmic?1:0));n.dataPoints[p].x.getTime?(f=!0,b=n.dataPoints[p].x.getTime()):b=n.dataPoints[p].x;e=r(n.dataPoints[p].y)?null:n.dataPoints[p].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<p){if(a.axisX.logarithmic){var t=
b/n.dataPoints[p-1].x;1>t&&(t=1/t);c.minDiff>t&&1!==t&&(c.minDiff=t)}else t=b-n.dataPoints[p-1].x,0>t&&(t*=-1),c.minDiff>t&&0!==t&&(c.minDiff=t);r(e)||null===n.dataPoints[p-1].y||(a.axisY.logarithmic?0<e&&(t=e/n.dataPoints[p-1].y,1>t&&(t=1/t),d.minDiff>t&&1!==t&&(d.minDiff=t)):(t=e-n.dataPoints[p-1].y,0>t&&(t*=-1),d.minDiff>t&&0!==t&&(d.minDiff=t)))}if(b<h&&!q)null!==e&&(u=b);else{if(!q&&(q=!0,0<p)){p-=2;continue}if(b>m&&!g)g=!0;else if(b>m&&g)continue;n.dataPoints[p].label&&(a.axisX.labels[b]=n.dataPoints[p].label);
b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);null===e?c.viewPortMin===b&&u<b&&(c.viewPortMin=u):(a.yTotals[b]=(a.yTotals[b]?a.yTotals[b]:0)+e,a.yAbsTotals[b]=(a.yAbsTotals[b]?a.yAbsTotals[b]:0)+Math.abs(e),0<=e?l=!0:0>e&&(s=!0),B[b]=B[b]?B[b]+Math.abs(e):Math.abs(e))}}n.axisX.valueType=n.xValueType=f?"dateTime":"number"}a.axisY.logarithmic?(d.max=r(d.viewPortMax)?99*Math.pow(a.axisY.logarithmBase,-0.05):Math.max(d.viewPortMax,99*Math.pow(a.axisY.logarithmBase,-0.05)),d.min=
...
!(1>a.dataSeriesIndexes.length))for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f,l,s=!1,B=0;B<a.dataSeriesIndexes.length;B++){var k=this.data[a.dataSeriesIndexes[B]],n=0,p=!1,q=!1,g,u,h;if("normal"===k.axisPlacement||"xySwapped"===k.axisPlacement)var m=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:
...
(s=!0,b=k.dataPoints[n].x.getTime()):b=k.dataPoints[n].x;if((e=k.dataPoints[n].y)&&e.length){f=Math.min.apply(null,e);l=Math.max.apply(null,e);u=!0;for(var r=0;r<e.length;r++)null===e.k&&(u=!1);u&&(p||(h=g),g=b)}b<c.min&&(c.min=b);b>c.max&&(c.max=b);f<d.min&&(d.min=f);l>d.max&&(d.max=l);0<n&&(a.axisX.logarithmic?(u=b/k.dataPoints[n-1].x,1>u&&(u=1/u),c.minDiff>u&&1!==u&&(c.minDiff=u)):(u=b-k.dataPoints[n-1].x,0>u&&(u*=-1),c.minDiff>u&&0!==u&&(c.minDiff=u)),e&&(null!==e[0]&&k.dataPoints[n-1].y&&null!==
k.dataPoints[n-1].y[0])&&(a.axisY.logarithmic?(u=e[0]/k.dataPoints[n-1].y[0],1>u&&(u=1/u),d.minDiff>u&&1!==u&&(d.minDiff=u)):(u=e[0]-k.dataPoints[n-1].y[0],0>u&&(u*=-1),d.minDiff>u&&0!==u&&(d.minDiff=u))));if(!(b<m)||p){if(!p&&(p=!0,0<n)){n-=2;g=h;continue}if(b>t&&!q)q=!0;else if(b>t&&q)continue;k.dataPoints[n].label&&(a.axisX.labels[b]=k.dataPoints[n].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);if(c.viewPortMin===b&&e)for(r=0;r<e.length;r++)if(null===e[r]&&g<b){c.viewPortMin=
g;break}null===e?c.viewPortMin===b&&g<b&&(c.viewPortMin=g):(f<d.viewPortMin&&(d.viewPortMin=f),l>d.viewPortMax&&(d.viewPortMax=l))}}k.axisX.valueType=k.xValueType=s?"dateTime":"number"}};m.prototype._processSpecificPlotUnit=function(a){if("waterfall"===a.type&&a.dataSeriesIndexes&&!(1>a.dataSeriesIndexes.length))for(var d=a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=0;l<a.dataSeriesIndexes.length;l++){var s=this.data[a.dataSeriesIndexes[l]],B=0,k=!1,n=!1,p=b=0;if("normal"===s.axisPlacement||"xySwapped"===
...
(p*=-1),c.minDiff>p&&0!==p&&(c.minDiff=p)),null!==e&&null!==s.dataPoints[B-1].y&&(a.axisY.logarithmic?(e=s.dataPointEOs[B].cumulativeSum/s.dataPointEOs[B-1].cumulativeSum,1>e&&(e=1/e),d.minDiff>e&&1!==e&&(d.minDiff=e)):(e=s.dataPointEOs[B].cumulativeSum-s.dataPointEOs[B-1].cumulativeSum,0>e&&(e*=-1),d.minDiff>e&&0!==e&&(d.minDiff=e)))),!(b<q)||k){if(!k&&(k=!0,0<B)){B-=2;continue}if(b>g&&!n)n=!0;else if(b>g&&n)continue;s.dataPoints[B].label&&(a.axisX.labels[b]=s.dataPoints[B].label);b<c.viewPortMin&&
...
1<=a.axisY.scaleBreaks.maxNumberOfAutoBreaks;if(b||c)for(var d=a.axisY.dataInfo,f=a.axisX.dataInfo,g,l=f.min,k=f.max,n=d.min,p=d.max,f=f._dataRanges,d=d._dataRanges,q,s=0,B=0;B<a.dataSeriesIndexes.length;B++){var h=e.data[a.dataSeriesIndexes[B]];if(!(4>h.dataPoints.length))for(s=0;s<h.dataPoints.length;s++)if(b&&(q=(k+1-l)*Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold)||10,10)/100,g=h.dataPoints[s].x.getTime?h.dataPoints[s].x.getTime():h.dataPoints[s].x,q=Math.floor((g-l)/q),g<f[q].min&&
...
this._axes[l].dataInfo.min;b=(this._axes[l].dataInfo.max+1-B)*Math.max(parseFloat(this._axes[l].scaleBreaks.collapsibleThreshold)||10,10)/100;var k=this._axes[l].dataInfo._dataRanges,n,p,f=[];if(this._axes[l].dataInfo.dataPointYPositiveSums){var q=this._axes[l].dataInfo.dataPointYPositiveSums;n=k;for(s in q)if(q.hasOwnProperty(s)&&!isNaN(s)&&(p=q[s],!r(p))){var g=Math.floor((p-B)/b);p<n[g].min&&(n[g].min=p);p>n[g].max&&(n[g].max=p)}delete this._axes[l].dataInfo.dataPointYPositiveSums}if(this._axes[l].dataInfo.dataPointYNegativeSums){q=
this._axes[l].dataInfo.dataPointYNegativeSums;n=k;for(s in q)q.hasOwnProperty(s)&&!isNaN(s)&&(p=-1*q[s],r(p)||(g=Math.floor((p-B)/b),p<n[g].min&&(n[g].min=p),p>n[g].max&&(n[g].max=p)));delete this._axes[l].dataInfo.dataPointYNegativeSums}for(s=0;s<k.length-1;s++)if(n=k[s].max,isFinite(n))for(;s<k.length-1;)if(B=k[s+1].min,isFinite(B)){p=B-n;p>b&&f.push({diff:p,start:n,end:B});break}else s++;if(this._axes[l].scaleBreaks.customBreaks)for(s=0;s<this._axes[l].scaleBreaks.customBreaks.length;s++)for(b=
...
f||"axisY"===this._axes[p].type&&l)&&k.push(this._axes[p]);for(l=0;l<k.length;l++){var p=k[l],f=!1,q=p.convertPixelToValue({x:a,y:d}),g=p.convertPixelToValue({x:c,y:b});if(q>g)var u=g,g=q,q=u;if(p.scaleBreaks)for(u=0;!f&&u<p.scaleBreaks._appliedBreaks.length;u++)f=p.scaleBreaks._appliedBreaks[u].startValue<=q&&p.scaleBreaks._appliedBreaks[u].endValue>=g;if(isFinite(p.dataInfo.minDiff))if(u=p.getApparentDifference(q,g,null,!0),!(f||!(this.panEnabled&&p.scaleBreaks&&p.scaleBreaks._appliedBreaks.length)&&
(p.logarithmic&&u<Math.pow(p.dataInfo.minDiff,3)||!p.logarithmic&&u<3*Math.abs(p.dataInfo.minDiff))||q<p.minimum||g>p.maximum))B.push(p),n.push({val1:q,val2:g}),s=!0;else if(!e){s=!1;break}}return{isValid:s,axesWithValidRange:B,axesRanges:n}};m.prototype.preparePlotArea=function(){var a=this.plotArea;!v&&(0<a.x1||0<a.y1)&&a.ctx.translate(a.x1,a.y1);if((this.axisX[0]||this.axisX2[0])&&(this.axisY[0]||this.axisY2[0])){var d=this.axisX[0]?this.axisX[0].lineCoordinates:this.axisX2[0].lineCoordinates;
...
b=0,e=0,f=0,l=f=e=0,s=0,B=b=0,k=0;for(a=0;a<this._indexLabels.length;a++){var n=this._indexLabels[a],p=n.chartType.toLowerCase(),q,g,l=ma("indexLabelFontColor",n.dataPoint,n.dataSeries),u=ma("indexLabelFontSize",n.dataPoint,n.dataSeries),s=ma("indexLabelFontFamily",n.dataPoint,n.dataSeries),B=ma("indexLabelFontStyle",n.dataPoint,n.dataSeries),k=ma("indexLabelFontWeight",n.dataPoint,n.dataSeries),h=ma("indexLabelBackgroundColor",n.dataPoint,n.dataSeries);q=ma("indexLabelMaxWidth",n.dataPoint,n.dataSeries);
g=ma("indexLabelWrap",n.dataPoint,n.dataSeries);var m=ma("indexLabelLineDashType",n.dataPoint,n.dataSeries),t=ma("indexLabelLineColor",n.dataPoint,n.dataSeries),y=r(n.dataPoint.indexLabelLineThickness)?r(n.dataSeries.options.indexLabelLineThickness)?0:n.dataSeries.options.indexLabelLineThickness:n.dataPoint.indexLabelLineThickness,b=0<y?Math.min(10,("normal"===this.plotInfo.axisPlacement?this.plotArea.height:this.plotArea.width)<<0):0,x={percent:null,total:null},A=null;if(0<=n.dataSeries.type.indexOf("stacked")||
"pie"===n.dataSeries.type||"doughnut"===n.dataSeries.type)x=this.getPercentAndTotal(n.dataSeries,n.dataPoint);if(n.dataSeries.indexLabelFormatter||n.dataPoint.indexLabelFormatter)A={chart:this,dataSeries:n.dataSeries,dataPoint:n.dataPoint,index:n.indexKeyword,total:x.total,percent:x.percent};var z=n.dataPoint.indexLabelFormatter?n.dataPoint.indexLabelFormatter(A):n.dataPoint.indexLabel?this.replaceKeywordsWithValue(n.dataPoint.indexLabel,n.dataPoint,n.dataSeries,null,n.indexKeyword):n.dataSeries.indexLabelFormatter?
n.dataSeries.indexLabelFormatter(A):n.dataSeries.indexLabel?this.replaceKeywordsWithValue(n.dataSeries.indexLabel,n.dataPoint,n.dataSeries,null,n.indexKeyword):null;if(null!==z&&""!==z){var x=ma("indexLabelPlacement",n.dataPoint,n.dataSeries),A=ma("indexLabelOrientation",n.dataPoint,n.dataSeries),C=ma("indexLabelTextAlign",n.dataPoint,n.dataSeries),w=n.direction,e=n.dataSeries.axisX,f=n.dataSeries.axisY,E=!1,h=new ka(d,{x:0,y:0,maxWidth:q?q:0.5*this.width,maxHeight:g?5*u:1.5*u,angle:"horizontal"===
A?0:-90,text:z,padding:0,backgroundColor:h,textAlign:C,fontSize:u,fontFamily:s,fontWeight:k,fontColor:l,fontStyle:B,textBaseline:"middle"});h.measureText();n.dataSeries.indexLabelMaxWidth=h.maxWidth;if("stackedarea100"===p){if(n.point.x<c.x1||n.point.x>c.x2||n.point.y<c.y1-1||n.point.y>c.y2+1)continue}else if("rangearea"===p||"rangesplinearea"===p){if(n.dataPoint.x<e.viewportMinimum||n.dataPoint.x>e.viewportMaximum||Math.max.apply(null,n.dataPoint.y)<f.viewportMinimum||Math.min.apply(null,n.dataPoint.y)>
...
p){if(n.dataPoint.x<e.viewportMinimum||n.dataPoint.x>e.viewportMaximum||n.bounds.x1>c.x2||n.bounds.x2<c.x1)continue}else if("candlestick"===p||"ohlc"===p){if(n.dataPoint.x<e.viewportMinimum||n.dataPoint.x>e.viewportMaximum||Math.max.apply(null,n.dataPoint.y)<f.viewportMinimum||Math.min.apply(null,n.dataPoint.y)>f.viewportMaximum)continue}else if(n.dataPoint.x<e.viewportMinimum||n.dataPoint.x>e.viewportMaximum)continue;l=s=2;"horizontal"===A?(B=h.width,k=h.height):(k=h.width,B=h.height);if("normal"===
this.plotInfo.axisPlacement){if(0<=p.indexOf("line")||0<=p.indexOf("area"))x="auto",s=4;else if(0<=p.indexOf("stacked"))"auto"===x&&(x="inside");else if("bubble"===p||"scatter"===p)x="inside";q=n.point.x-("horizontal"===A?B/2:B/2-u/2);"inside"!==x?(e=c.y1,f=c.y2,0<w?(g=n.point.y+("horizontal"===A?u/2:0)-k-s-b,g<e&&(g="auto"===x?Math.max(n.point.y,e)+u/2+s:e+u/2+s,E=g+k>n.point.y)):(g=n.point.y+u/2+s+b,g>f-k&&(g="auto"===x?Math.min(n.point.y,f)+u/2-k-s:f+u/2-k,E=g<n.point.y))):(e=Math.max(n.bounds.y1,
c.y1),f=Math.min(n.bounds.y2,c.y2-k+u/2),b=0<=p.indexOf("range")||"error"===p?0<w?Math.max(n.bounds.y1,c.y1)+u/2+s:Math.min(n.bounds.y2,c.y2)+u/2-k+s:(Math.max(n.bounds.y1,c.y1)+Math.min(n.bounds.y2,c.y2))/2-k/2+u/2+("horizontal"===A?s:0),0<w?(g=Math.max(n.point.y,b),g<e&&("bubble"===p||"scatter"===p)&&(g=Math.max(n.point.y-k-s,c.y1+s))):(g=Math.min(n.point.y,b),g>f-k-s&&("bubble"===p||"scatter"===p)&&(g=Math.min(n.point.y+s,c.y2-k-s))),g=Math.min(g,f))}else 0<=p.indexOf("line")||0<=p.indexOf("area")||
0<=p.indexOf("scatter")?(x="auto",l=4):0<=p.indexOf("stacked")?"auto"===x&&(x="inside"):"bubble"===p&&(x="inside"),g=n.point.y+u/2-k/2+s,"inside"!==x?(e=c.x1,f=c.x2,0>w?(q=n.point.x-("horizontal"===A?B:B-u/2)-l-b,q<e&&(q="auto"===x?Math.max(n.point.x,e)+l:e+l,E=q+B>n.point.x)):(q=n.point.x+("horizontal"===A?0:u/2)+l+b,q>f-B-l-b&&(q="auto"===x?Math.min(n.point.x,f)-("horizontal"===A?B:B/2)-l:f-B-l,E=q<n.point.x))):(e=Math.max(n.bounds.x1,c.x1),Math.min(n.bounds.x2,c.x2),b=0<=p.indexOf("range")||"error"===
p?0>w?Math.max(n.bounds.x1,c.x1)+u/2+l:Math.min(n.bounds.x2,c.x2)-B/2-l+("horizontal"===A?0:u/2):(Math.max(n.bounds.x1,c.x1)+Math.min(n.bounds.x2,c.x2))/2+("horizontal"===A?0:u/2),q=0>w?Math.max(n.point.x,b)-("horizontal"===A?B/2:0):Math.min(n.point.x,b)-B/2,q=Math.max(q,e));"vertical"===A&&(g+=k-u/2);h.x=q;h.y=g;h.render(!0);y&&("inside"!==x&&(0>p.indexOf("bar")&&("error"!==p||!n.axisSwapped)&&n.point.x>c.x1&&n.point.x<c.x2||!E)&&(0>p.indexOf("column")&&("error"!==p||n.axisSwapped)&&n.point.y>c.y1&&
n.point.y<c.y2||!E))&&(d.lineWidth=y,d.strokeStyle=t?t:"gray",d.setLineDash&&d.setLineDash(J(m,y)),d.beginPath(),d.moveTo(n.point.x,n.point.y),0<=p.indexOf("bar")||"error"===p&&n.axisSwapped?d.lineTo(q+(0<n.direction?-l:B+l)+("vertical"===A?-u/2:0),g+("vertical"===A?-k/2:k/2-u/2)-s):0<=p.indexOf("column")||"error"===p&&!n.axisSwapped?d.lineTo(q+B/2-("horizontal"===A?0:u/2),g+("vertical"===A?(g-k<n.point.y?0:-k)+s:(g-u/2<n.point.y?k:0)-u/2)):d.lineTo(q+B/2-("horizontal"===A?0:u/2),g+("vertical"===
A?g-k<n.point.y?0:-k:(g-u/2<n.point.y?k:0)-u/2)),d.stroke())}}d={source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0,startTimePercent:0.7};for(a=0;a<this._indexLabels.length;a++)n=this._indexLabels[a],h=ma("indexLabelBackgroundColor",n.dataPoint,n.dataSeries),n.dataSeries.indexLabelBackgroundColor=r(h)?v?"transparent":null:h;return d};m.prototype.renderLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=v?this._preRenderCtx:
...
dataSeriesIndex:B};u=P(u);b.strokeStyle=u;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var u=k._colorSet,h=u=k.lineColor=k.options.lineColor?k.options.lineColor:u[0];c.strokeStyle=u;var m=!0,t=0,r,x;c.beginPath();if(0<n.length){for(var A=!1,t=0;t<n.length;t++)if(r=n[t].x.getTime?n[t].x.getTime():n[t].x,!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!A)))if("number"!==typeof n[t].y)0<t&&!(k.connectNullData||A||m)&&(c.stroke(),v&&b.stroke()),A=
!0;else{r=a.axisX.convertValueToPixel(r);x=a.axisY.convertValueToPixel(n[t].y);var z=k.dataPointIds[t];this._eventManager.objectMap[z]={id:z,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:t,x1:r,y1:x};m||A?(!m&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,c.setLineDash(q)),c.lineTo(r,x),v&&b.lineTo(r,x)):(c.beginPath(),c.moveTo(r,x),v&&(b.beginPath(),
b.moveTo(r,x))),A=m=!1):(c.lineTo(r,x),v&&b.lineTo(r,x),0==t%500&&(c.stroke(),c.beginPath(),c.moveTo(r,x),v&&(b.stroke(),b.beginPath(),b.moveTo(r,x))));l={x:r,y:x};t<n.length-1&&(h!==(n[t].lineColor||u)||p!==(n[t].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(r,x),h=n[t].lineColor||u,c.strokeStyle=h,c.setLineDash&&(n[t].lineDashType?(p=n[t].lineDashType,c.setLineDash(J(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));if(0<n[t].markerSize||0<k.markerSize){var C=k.getMarkerProperties(t,
r,x,c);f.push(C);z=P(z);v&&f.push({x:r,y:x,ctx:b,type:C.type,size:C.size,color:z,borderColor:z,borderThickness:C.borderThickness})}(n[t].indexLabel||k.indexLabel||n[t].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:n[t],dataSeries:k,point:{x:r,y:x},direction:0>n[t].y===a.axisY.reversed?1:-1,color:u})}c.stroke();v&&b.stroke()}}$.drawMarkers(f);v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",
...
k.id;this._eventManager.objectMap[u]={objectType:"dataSeries",dataSeriesIndex:B};u=P(u);b.strokeStyle=u;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var u=k._colorSet,h=u=k.lineColor=k.options.lineColor?k.options.lineColor:u[0];c.strokeStyle=u;var r=!0,t=0,m,x;c.beginPath();if(0<n.length){for(var A=!1,t=0;t<n.length;t++)if(m=n[t].getTime?n[t].x.getTime():n[t].x,!(m<a.axisX.dataInfo.viewPortMin||m>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!A)))if("number"!==typeof n[t].y)0<
t&&!(k.connectNullData||A||r)&&(c.stroke(),v&&b.stroke()),A=!0;else{var z=x;m=a.axisX.convertValueToPixel(m);x=a.axisY.convertValueToPixel(n[t].y);var C=k.dataPointIds[t];this._eventManager.objectMap[C]={id:C,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:t,x1:m,y1:x};r||A?(!r&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,c.setLineDash(q)),
c.lineTo(m,z),c.lineTo(m,x),v&&(b.lineTo(m,z),b.lineTo(m,x))):(c.beginPath(),c.moveTo(m,x),v&&(b.beginPath(),b.moveTo(m,x))),A=r=!1):(c.lineTo(m,z),v&&b.lineTo(m,z),c.lineTo(m,x),v&&b.lineTo(m,x),0==t%500&&(c.stroke(),c.beginPath(),c.moveTo(m,x),v&&(b.stroke(),b.beginPath(),b.moveTo(m,x))));l={x:m,y:x};t<n.length-1&&(h!==(n[t].lineColor||u)||p!==(n[t].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(m,x),h=n[t].lineColor||u,c.strokeStyle=h,c.setLineDash&&(n[t].lineDashType?(p=n[t].lineDashType,
c.setLineDash(J(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));if(0<n[t].markerSize||0<k.markerSize)z=k.getMarkerProperties(t,m,x,c),f.push(z),C=P(C),v&&f.push({x:m,y:x,ctx:b,type:z.type,size:z.size,color:C,borderColor:C,borderThickness:z.borderThickness});(n[t].indexLabel||k.indexLabel||n[t].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:n[t],dataSeries:k,point:{x:m,y:x},direction:0>n[t].y===a.axisY.reversed?1:-1,color:u})}c.stroke();
v&&b.stroke()}}$.drawMarkers(f);v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),b.beginPath());c.restore();c.beginPath();return{source:d,dest:this.plotArea.ctx,
animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderSpline=function(a){function d(a){a=w(a,2);if(0<a.length){b.beginPath();v&&e.beginPath();b.moveTo(a[0].x,a[0].y);a[0].newStrokeStyle&&(b.strokeStyle=a[0].newStrokeStyle);a[0].newLineDashArray&&b.setLineDash(a[0].newLineDashArray);v&&e.moveTo(a[0].x,a[0].y);for(var c=0;c<a.length-3;c+=3)if(b.bezierCurveTo(a[c+1].x,a[c+1].y,a[c+2].x,a[c+2].y,a[c+3].x,a[c+3].y),v&&e.bezierCurveTo(a[c+1].x,a[c+1].y,a[c+
...
var f=this.plotArea;b.beginPath();b.rect(f.x1,f.y1,f.width,f.height);b.clip();for(var l=[],s=0;s<a.dataSeriesIndexes.length;s++){var B=a.dataSeriesIndexes[s],k=this.data[B];b.lineWidth=k.lineThickness;var n=k.dataPoints,p="solid";if(b.setLineDash){var q=J(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,g=J(p,k.lineThickness);b.setLineDash(g)}var u=k.id;this._eventManager.objectMap[u]={objectType:"dataSeries",dataSeriesIndex:B};u=P(u);e.strokeStyle=u;e.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,
4):0;var u=k._colorSet,h=u=k.lineColor=k.options.lineColor?k.options.lineColor:u[0];b.strokeStyle=u;var m=0,t,r,x=[];b.beginPath();if(0<n.length)for(r=!1,m=0;m<n.length;m++)if(t=n[m].getTime?n[m].x.getTime():n[m].x,!(t<a.axisX.dataInfo.viewPortMin||t>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!r)))if("number"!==typeof n[m].y)0<m&&!r&&(k.connectNullData?b.setLineDash&&(0<x.length&&(k.options.nullDataLineDashType||!n[m-1].lineDashType))&&(x[x.length-1].newLineDashArray=q,p=k.nullDataLineDashType):
(d(x),x=[])),r=!0;else{t=a.axisX.convertValueToPixel(t);r=a.axisY.convertValueToPixel(n[m].y);var A=k.dataPointIds[m];this._eventManager.objectMap[A]={id:A,objectType:"dataPoint",dataSeriesIndex:B,dataPointIndex:m,x1:t,y1:r};x[x.length]={x:t,y:r};m<n.length-1&&(h!==(n[m].lineColor||u)||p!==(n[m].lineDashType||k.lineDashType))&&(h=n[m].lineColor||u,x[x.length-1].newStrokeStyle=h,b.setLineDash&&(n[m].lineDashType?(p=n[m].lineDashType,x[x.length-1].newLineDashArray=J(p,k.lineThickness)):(p=k.lineDashType,
x[x.length-1].newLineDashArray=g)));if(0<n[m].markerSize||0<k.markerSize){var z=k.getMarkerProperties(m,t,r,b);l.push(z);A=P(A);v&&l.push({x:t,y:r,ctx:e,type:z.type,size:z.size,color:A,borderColor:A,borderThickness:z.borderThickness})}(n[m].indexLabel||k.indexLabel||n[m].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:n[m],dataSeries:k,point:{x:t,y:r},direction:0>n[m].y===a.axisY.reversed?1:-1,color:u});r=!1}d(x)}$.drawMarkers(l);v&&(c.drawImage(this._preRenderCanvas,
...
this.dataPointWidth:-Infinity,f));p<f&&(p=f);p>n&&(p=n);c.save();v&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();v&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(n=0;n<a.dataSeriesIndexes.length;n++){var q=a.dataSeriesIndexes[n],g=this.data[q],u=g.dataPoints;if(0<u.length)for(var h=5<p&&g.bevelEnabled?!0:!1,f=0;f<u.length;f++)if(u[f].getTime?B=u[f].x.getTime():
B=u[f].x,!(B<a.axisX.dataInfo.viewPortMin||B>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[f].y){l=a.axisX.convertValueToPixel(B);s=a.axisY.convertValueToPixel(u[f].y);l=a.axisX.reversed?l+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+n)*p<<0:l-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+n)*p<<0;var m=a.axisX.reversed?l-p<<0:l+p<<0,t;0<=u[f].y?t=k:(t=s,s=k);s>t&&(b=s,s=t,t=b);b=u[f].color?u[f].color:g._colorSet[f%g._colorSet.length];ba(c,a.axisX.reversed?m:l,s,a.axisX.reversed?
l:m,t,b,0,null,h&&(a.axisY.reversed?0>u[f].y:0<=u[f].y),(a.axisY.reversed?0<=u[f].y:0>u[f].y)&&h,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:s,x2:m,y2:t};b=P(b);v&&ba(this._eventManager.ghostCtx,a.axisX.reversed?m:l,s,a.axisX.reversed?l:m,t,b,0,null,!1,!1,!1,!1);(u[f].indexLabel||g.indexLabel||u[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",dataPoint:u[f],
dataSeries:g,point:{x:l+(m-l)/2,y:0>u[f].y===a.axisY.reversed?s:t},direction:0>u[f].y===a.axisY.reversed?1:-1,bounds:{x1:l,y1:Math.min(s,t),x2:m,y2:Math.max(s,t)},color:b})}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.yScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:k<a.axisY.bounds.y1?a.axisY.bounds.y1:k>a.axisY.bounds.y2?a.axisY.bounds.y2:k}}};m.prototype.renderStackedColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=v?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,
f=[],l=[],s=[],B=[],k=0,n,p,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),k=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;n=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.width<<0;var g=a.axisX.dataInfo.minDiff;isFinite(g)||(g=0.3*Math.abs(a.axisX.range));g=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.width*(a.axisX.logarithmic?Math.log(g)/
...
e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var u=0;u<a.dataSeriesIndexes.length;u++){var h=a.dataSeriesIndexes[u],m=this.data[h],t=m.dataPoints;if(0<t.length){var r=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<t.length;k++)if(b=t[k].x.getTime?t[k].x.getTime():t[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[k].y){n=a.axisX.convertValueToPixel(b);var x=n-a.plotType.plotUnits.length*g/2+a.index*g<<0,A=x+g<<0,z;if(a.axisY.logarithmic||
a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[k].y)s[b]=t[k].y+(s[b]?s[b]:0),0<s[b]&&(p=a.axisY.convertValueToPixel(s[b]),z="undefined"!==typeof f[b]?f[b]:q,f[b]=p);else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)B[b]=t[k].y+(B[b]?B[b]:0),z=a.axisY.convertValueToPixel(B[b]),p="undefined"!==typeof l[b]?l[b]:q,l[b]=z;else if(p=a.axisY.convertValueToPixel(t[k].y),0<=t[k].y){var C="undefined"!==typeof f[b]?f[b]:0;p-=C;z=q-C;f[b]=C+(z-p)}else C=
l[b]?l[b]:0,z=p+C,p=q+C,l[b]=C+(z-p);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];ba(c,x,a.axisY.reversed?z:p,A,a.axisY.reversed?p:z,b,0,null,r&&(a.axisY.reversed?0>t[k].y:0<=t[k].y),(a.axisY.reversed?0<=t[k].y:0>t[k].y)&&r,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:x,y1:p,x2:A,y2:z};b=P(b);v&&ba(this._eventManager.ghostCtx,x,p,A,z,b,0,null,!1,!1,!1,!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||
m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn",dataPoint:t[k],dataSeries:m,point:{x:n,y:0<=t[k].y?p:z},direction:0>t[k].y===a.axisY.reversed?1:-1,bounds:{x1:x,y1:Math.min(p,z),x2:A,y2:Math.max(p,z)},color:b})}}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),
this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.yScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};m.prototype.renderStackedColumn100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=v?this._preRenderCtx:
...
c.clip();v&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var u=0;u<a.dataSeriesIndexes.length;u++){var h=a.dataSeriesIndexes[u],m=this.data[h],t=m.dataPoints;if(0<t.length)for(var r=5<g&&m.bevelEnabled?!0:!1,k=0;k<t.length;k++)if(b=t[k].x.getTime?t[k].x.getTime():t[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[k].y){n=a.axisX.convertValueToPixel(b);p=0!==a.dataPointYSums[b]?
100*(t[k].y/a.dataPointYSums[b]):0;var x=n-a.plotType.plotUnits.length*g/2+a.index*g<<0,A=x+g<<0,z;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[k].y){s[b]=p+("undefined"!==typeof s[b]?s[b]:0);if(0>=s[b])continue;p=a.axisY.convertValueToPixel(s[b]);z=f[b]?f[b]:q;f[b]=p}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)B[b]=p+("undefined"!==typeof B[b]?B[b]:0),z=a.axisY.convertValueToPixel(B[b]),p=l[b]?l[b]:q,l[b]=z;
else if(p=a.axisY.convertValueToPixel(p),0<=t[k].y){var C="undefined"!==typeof f[b]?f[b]:0;p-=C;z=q-C;a.dataSeriesIndexes.length-1===u&&1>=Math.abs(e.y1-p)&&(p=e.y1);f[b]=C+(z-p)}else C="undefined"!==typeof l[b]?l[b]:0,z=p+C,p=q+C,a.dataSeriesIndexes.length-1===u&&1>=Math.abs(e.y2-z)&&(z=e.y2),l[b]=C+(z-p);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];ba(c,x,a.axisY.reversed?z:p,A,a.axisY.reversed?p:z,b,0,null,r&&(a.axisY.reversed?0>t[k].y:0<=t[k].y),(a.axisY.reversed?0<=t[k].y:0>t[k].y)&&
r,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:x,y1:p,x2:A,y2:z};b=P(b);v&&ba(this._eventManager.ghostCtx,x,p,A,z,b,0,null,!1,!1,!1,!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn100",dataPoint:t[k],dataSeries:m,point:{x:n,y:0<=t[k].y?p:z},direction:0>t[k].y===a.axisY.reversed?1:-1,bounds:{x1:x,y1:Math.min(p,z),x2:A,y2:Math.max(p,
z)},color:b})}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,
animationCallback:M.yScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:q<a.axisY.bounds.y1?a.axisY.bounds.y1:q>a.axisY.bounds.y2?a.axisY.bounds.y2:q}}};m.prototype.renderBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=v?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,s,B,k=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?
...
a.dataSeriesIndexes[n],g=this.data[q],u=g.dataPoints;if(0<u.length){var h=5<p&&g.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(f=0;f<u.length;f++)if(u[f].getTime?B=u[f].x.getTime():B=u[f].x,!(B<a.axisX.dataInfo.viewPortMin||B>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[f].y){s=a.axisX.convertValueToPixel(B);l=a.axisY.convertValueToPixel(u[f].y);s=a.axisX.reversed?s+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+n)*p<<0:s-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+
n)*p<<0;var m=a.axisX.reversed?s-p<<0:s+p<<0,t;0<=u[f].y?t=k:(t=l,l=k);b=u[f].color?u[f].color:g._colorSet[f%g._colorSet.length];ba(c,a.axisY.reversed?l:t,a.axisX.reversed?m:s,a.axisY.reversed?t:l,a.axisX.reversed?s:m,b,0,null,h,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:t,y1:s,x2:l,y2:m};b=P(b);v&&ba(this._eventManager.ghostCtx,t,a.axisX.reversed?m:s,l,a.axisX.reversed?s:m,b,0,null,!1,!1,!1,!1);(u[f].indexLabel||
g.indexLabel||u[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"bar",dataPoint:u[f],dataSeries:g,point:{x:0<=u[f].y?l:t,y:s+(m-s)/2},direction:0>u[f].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(t,l),y1:s,x2:Math.max(t,l),y2:m},color:b})}}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,
...
c.rect(e.x1,e.y1,e.width,e.height);c.clip();v&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var u=0;u<a.dataSeriesIndexes.length;u++){var h=a.dataSeriesIndexes[u],m=this.data[h],t=m.dataPoints;if(0<t.length){var r=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<t.length;k++)if(b=t[k].x.getTime?t[k].x.getTime():t[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===
typeof t[k].y){p=a.axisX.convertValueToPixel(b);var x=p-a.plotType.plotUnits.length*g/2+a.index*g<<0,A=x+g<<0,z;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[k].y)s[b]=t[k].y+(s[b]?s[b]:0),0<s[b]&&(z=f[b]?f[b]:q,f[b]=n=a.axisY.convertValueToPixel(s[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)B[b]=t[k].y+(B[b]?B[b]:0),n=l[b]?l[b]:q,l[b]=z=a.axisY.convertValueToPixel(B[b]);else if(n=a.axisY.convertValueToPixel(t[k].y),
0<=t[k].y){var C=f[b]?f[b]:0;z=q+C;n+=C;f[b]=C+(n-z)}else C=l[b]?l[b]:0,z=n-C,n=q-C,l[b]=C+(n-z);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];ba(c,a.axisY.reversed?n:z,x,a.axisY.reversed?z:n,A,b,0,null,r,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:z,y1:x,x2:n,y2:A};b=P(b);v&&ba(this._eventManager.ghostCtx,z,x,n,A,b,0,null,!1,!1,!1,!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||
m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar",dataPoint:t[k],dataSeries:m,point:{x:0<=t[k].y?n:z,y:p},direction:0>t[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(z,n),y1:x,x2:Math.max(z,n),y2:A},color:b})}}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&
this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};m.prototype.renderStackedBar100=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=v?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=
null,e=this.plotArea,f=[],l=[],s=[],B=[],k=0,n,p,q=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),k=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;p=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:0.15*this.height<<0;var g=a.axisX.dataInfo.minDiff;isFinite(g)||(g=0.3*Math.abs(a.axisX.range));g=this.options.dataPointWidth?this.dataPointWidth:0.9*(e.height*(a.axisX.logarithmic?
...
this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var u=0;u<a.dataSeriesIndexes.length;u++){var h=a.dataSeriesIndexes[u],m=this.data[h],t=m.dataPoints;if(0<t.length){var r=5<g&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<t.length;k++)if(b=t[k].x.getTime?t[k].x.getTime():t[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof t[k].y){p=a.axisX.convertValueToPixel(b);var x;x=0!==a.dataPointYSums[b]?100*
(t[k].y/a.dataPointYSums[b]):0;var A=p-a.plotType.plotUnits.length*g/2+a.index*g<<0,z=A+g<<0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<t[k].y){s[b]=x+(s[b]?s[b]:0);if(0>=s[b])continue;x=f[b]?f[b]:q;f[b]=n=a.axisY.convertValueToPixel(s[b])}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=t[k].y)B[b]=x+(B[b]?B[b]:0),n=l[b]?l[b]:q,l[b]=x=a.axisY.convertValueToPixel(B[b]);else if(n=a.axisY.convertValueToPixel(x),0<=t[k].y){var C=
f[b]?f[b]:0;x=q+C;n+=C;a.dataSeriesIndexes.length-1===u&&1>=Math.abs(e.x2-n)&&(n=e.x2);f[b]=C+(n-x)}else C=l[b]?l[b]:0,x=n-C,n=q-C,a.dataSeriesIndexes.length-1===u&&1>=Math.abs(e.x1-x)&&(x=e.x1),l[b]=C+(n-x);b=t[k].color?t[k].color:m._colorSet[k%m._colorSet.length];ba(c,a.axisY.reversed?n:x,A,a.axisY.reversed?x:n,z,b,0,null,r,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:x,y1:A,x2:n,y2:z};b=P(b);v&&ba(this._eventManager.ghostCtx,
x,A,n,z,b,0,null,!1,!1,!1,!1);(t[k].indexLabel||m.indexLabel||t[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar100",dataPoint:t[k],dataSeries:m,point:{x:0<=t[k].y?n:x,y:p},direction:0>t[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(x,n),y1:A,x2:Math.max(x,n),y2:z},color:b})}}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),
a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.xScaleAnimation,easingFunction:M.easing.easeOutQuart,animationBase:q<a.axisY.bounds.x1?a.axisY.bounds.x1:q>a.axisY.bounds.x2?a.axisY.bounds.x2:q}}};m.prototype.renderArea=
function(a){var d,c;function b(){z&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?A=x:0>a.axisY.viewportMaximum?A=s.y1:0<a.axisY.viewportMinimum&&(A=x),f.lineTo(m,A),f.lineTo(z.x,A),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,v&&(l.lineTo(m,A),l.lineTo(z.x,A),l.closePath(),l.fill()),f.beginPath(),f.moveTo(m,t),l.beginPath(),l.moveTo(m,t),z={x:m,y:t})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=v?this._preRenderCtx:
e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,s=a.axisY.lineCoordinates,B=[],k=this.plotArea,n;f.save();v&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();v&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],u=g.dataPoints,B=g.id;this._eventManager.objectMap[B]={objectType:"dataSeries",dataSeriesIndex:q};B=P(B);l.fillStyle=B;B=[];d=!0;var h=0,m,t,r,x=a.axisY.convertValueToPixel(a.axisY.logarithmic?
a.axisY.viewportMinimum:0),A,z=null;if(0<u.length){var C=g._colorSet[h%g._colorSet.length],w=g.lineColor=g.options.lineColor||C,E=w;f.fillStyle=C;f.strokeStyle=w;f.lineWidth=g.lineThickness;c="solid";if(f.setLineDash){var U=J(g.nullDataLineDashType,g.lineThickness);c=g.lineDashType;var S=J(c,g.lineThickness);f.setLineDash(S)}for(var ga=!0;h<u.length;h++)if(r=u[h].x.getTime?u[h].x.getTime():u[h].x,!(r<a.axisX.dataInfo.viewPortMin||r>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!ga)))if("number"!==
typeof u[h].y)g.connectNullData||(ga||d)||b(),ga=!0;else{m=a.axisX.convertValueToPixel(r);t=a.axisY.convertValueToPixel(u[h].y);d||ga?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||c===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=t,m=n.x,t=n.y,b(),f.moveTo(n.x,n.y),m=d,t=c,z=n,c=g.nullDataLineDashType,f.setLineDash(U)),f.lineTo(m,t),v&&l.lineTo(m,t)):(f.beginPath(),f.moveTo(m,t),v&&(l.beginPath(),l.moveTo(m,t)),z={x:m,y:t}),ga=d=!1):(f.lineTo(m,t),v&&l.lineTo(m,
t),0==h%250&&b());n={x:m,y:t};h<u.length-1&&(E!==(u[h].lineColor||w)||c!==(u[h].lineDashType||g.lineDashType))&&(b(),E=u[h].lineColor||w,f.strokeStyle=E,f.setLineDash&&(u[h].lineDashType?(c=u[h].lineDashType,f.setLineDash(J(c,g.lineThickness))):(c=g.lineDashType,f.setLineDash(S))));var aa=g.dataPointIds[h];this._eventManager.objectMap[aa]={id:aa,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:h,x1:m,y1:t};0!==u[h].markerSize&&(0<u[h].markerSize||0<g.markerSize)&&(r=g.getMarkerProperties(h,
m,t,f),B.push(r),aa=P(aa),v&&B.push({x:m,y:t,ctx:l,type:r.type,size:r.size,color:aa,borderColor:aa,borderThickness:r.borderThickness}));(u[h].indexLabel||g.indexLabel||u[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:u[h],dataSeries:g,point:{x:m,y:t},direction:0>u[h].y===a.axisY.reversed?1:-1,color:C})}b();$.drawMarkers(B)}}v&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&
...
c[d+3].newStrokeStyle),c[d+3].newLineDashArray&&b.setLineDash(c[d+3].newLineDashArray);b.stroke()}b.beginPath();b.moveTo(c[0].x,c[0].y);v&&(e.beginPath(),e.moveTo(c[0].x,c[0].y));for(d=0;d<c.length-3;d+=3)b.bezierCurveTo(c[d+1].x,c[d+1].y,c[d+2].x,c[d+2].y,c[d+3].x,c[d+3].y),v&&e.bezierCurveTo(c[d+1].x,c[d+1].y,c[d+2].x,c[d+2].y,c[d+3].x,c[d+3].y);a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?r=m:0>a.axisY.viewportMaximum?r=f.y1:0<a.axisY.viewportMinimum&&(r=m);t={x:c[0].x,
y:c[0].y};b.lineTo(c[c.length-1].x,r);b.lineTo(t.x,r);b.closePath();b.globalAlpha=n.fillOpacity;b.fill();b.globalAlpha=1;v&&(e.lineTo(c[c.length-1].x,r),e.lineTo(t.x,r),e.closePath(),e.fill())}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=v?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=a.axisY.lineCoordinates,l=[],s=this.plotArea;b.save();v&&e.save();b.beginPath();b.rect(s.x1,s.y1,s.width,s.height);b.clip();v&&(e.beginPath(),e.rect(s.x1,s.y1,s.width,
s.height),e.clip());for(var h=0;h<a.dataSeriesIndexes.length;h++){var k=a.dataSeriesIndexes[h],n=this.data[k],p=n.dataPoints,l=n.id;this._eventManager.objectMap[l]={objectType:"dataSeries",dataSeriesIndex:k};l=P(l);e.fillStyle=l;var l=[],q=0,g,u,m=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),r,t=null,y=[];if(0<p.length){var x=n._colorSet[q%n._colorSet.length],A=n.lineColor=n.options.lineColor||x,z=A;b.fillStyle=x;b.strokeStyle=A;b.lineWidth=n.lineThickness;var C="solid";
if(b.setLineDash){var E=J(n.nullDataLineDashType,n.lineThickness),C=n.lineDashType,F=J(C,n.lineThickness);b.setLineDash(F)}for(u=!1;q<p.length;q++)if(g=p[q].x.getTime?p[q].x.getTime():p[q].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!u)))if("number"!==typeof p[q].y)0<q&&!u&&(n.connectNullData?b.setLineDash&&(0<y.length&&(n.options.nullDataLineDashType||!p[q-1].lineDashType))&&(y[y.length-1].newLineDashArray=E,C=n.nullDataLineDashType):(d(),y=[])),u=!0;
else{g=a.axisX.convertValueToPixel(g);u=a.axisY.convertValueToPixel(p[q].y);var U=n.dataPointIds[q];this._eventManager.objectMap[U]={id:U,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:q,x1:g,y1:u};y[y.length]={x:g,y:u};q<p.length-1&&(z!==(p[q].lineColor||A)||C!==(p[q].lineDashType||n.lineDashType))&&(z=p[q].lineColor||A,y[y.length-1].newStrokeStyle=z,b.setLineDash&&(p[q].lineDashType?(C=p[q].lineDashType,y[y.length-1].newLineDashArray=J(C,n.lineThickness)):(C=n.lineDashType,y[y.length-1].newLineDashArray=
F)));if(0!==p[q].markerSize&&(0<p[q].markerSize||0<n.markerSize)){var S=n.getMarkerProperties(q,g,u,b);l.push(S);U=P(U);v&&l.push({x:g,y:u,ctx:e,type:S.type,size:S.size,color:U,borderColor:U,borderThickness:S.borderThickness})}(p[q].indexLabel||n.indexLabel||p[q].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[q],dataSeries:n,point:{x:g,y:u},direction:0>p[q].y===a.axisY.reversed?1:-1,color:x});u=!1}d();$.drawMarkers(l)}}v&&(c.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(s.x1,s.y1,s.width,s.height),this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,
animationBase:0}}};m.prototype.renderStepArea=function(a){var d,c;function b(){z&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?A=x:0>a.axisY.viewportMaximum?A=s.y1:0<a.axisY.viewportMinimum&&(A=x),f.lineTo(r,A),f.lineTo(z.x,A),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,v&&(l.lineTo(r,A),l.lineTo(z.x,A),l.closePath(),l.fill()),f.beginPath(),f.moveTo(r,t),l.beginPath(),l.moveTo(r,t),z={x:r,y:t})}var e=a.targetCanvasCtx||
this.plotArea.ctx,f=v?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,s=a.axisY.lineCoordinates,h=[],k=this.plotArea,n;f.save();v&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();v&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],u=g.dataPoints,h=g.id;this._eventManager.objectMap[h]={objectType:"dataSeries",dataSeriesIndex:q};h=P(h);l.fillStyle=
h;h=[];d=!0;var m=0,r,t,y,x=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),A,z=null;c=!1;if(0<u.length){var C=g._colorSet[m%g._colorSet.length],w=g.lineColor=g.options.lineColor||C,E=w;f.fillStyle=C;f.strokeStyle=w;f.lineWidth=g.lineThickness;var U="solid";if(f.setLineDash){var S=J(g.nullDataLineDashType,g.lineThickness),U=g.lineDashType,ga=J(U,g.lineThickness);f.setLineDash(ga)}for(;m<u.length;m++)if(y=u[m].x.getTime?u[m].x.getTime():u[m].x,!(y<a.axisX.dataInfo.viewPortMin||
y>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!c))){var aa=t;"number"!==typeof u[m].y?(g.connectNullData||(c||d)||b(),c=!0):(r=a.axisX.convertValueToPixel(y),t=a.axisY.convertValueToPixel(u[m].y),d||c?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||U===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=r,c=t,r=n.x,t=n.y,b(),f.moveTo(n.x,n.y),r=d,t=c,z=n,U=g.nullDataLineDashType,f.setLineDash(S)),f.lineTo(r,aa),f.lineTo(r,t),v&&(l.lineTo(r,aa),l.lineTo(r,t))):
(f.beginPath(),f.moveTo(r,t),v&&(l.beginPath(),l.moveTo(r,t)),z={x:r,y:t}),c=d=!1):(f.lineTo(r,aa),v&&l.lineTo(r,aa),f.lineTo(r,t),v&&l.lineTo(r,t),0==m%250&&b()),n={x:r,y:t},m<u.length-1&&(E!==(u[m].lineColor||w)||U!==(u[m].lineDashType||g.lineDashType))&&(b(),E=u[m].lineColor||w,f.strokeStyle=E,f.setLineDash&&(u[m].lineDashType?(U=u[m].lineDashType,f.setLineDash(J(U,g.lineThickness))):(U=g.lineDashType,f.setLineDash(ga)))),y=g.dataPointIds[m],this._eventManager.objectMap[y]={id:y,objectType:"dataPoint",
dataSeriesIndex:q,dataPointIndex:m,x1:r,y1:t},0!==u[m].markerSize&&(0<u[m].markerSize||0<g.markerSize)&&(aa=g.getMarkerProperties(m,r,t,f),h.push(aa),y=P(y),v&&h.push({x:r,y:t,ctx:l,type:aa.type,size:aa.size,color:y,borderColor:y,borderThickness:aa.borderThickness})),(u[m].indexLabel||g.indexLabel||u[m].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepArea",dataPoint:u[m],dataSeries:g,point:{x:r,y:t},direction:0>u[m].y===a.axisY.reversed?1:-1,color:C}))}b();$.drawMarkers(h)}}v&&
...
easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderStackedArea=function(a){function d(){if(!(1>k.length)){for(0<C.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);v&&r.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=C.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();v&&(r.closePath(),r.fill(),r.beginPath());k=[]}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=v?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=[],s=this.plotArea,h=[],
k=[],n=[],p=[],q=0,g,u,m=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),r=this._eventManager.ghostCtx,t,y,x;v&&r.beginPath();b.save();v&&r.save();b.beginPath();b.rect(s.x1,s.y1,s.width,s.height);b.clip();v&&(r.beginPath(),r.rect(s.x1,s.y1,s.width,s.height),r.clip());for(var e=[],A=0;A<a.dataSeriesIndexes.length;A++){var z=a.dataSeriesIndexes[A],C=this.data[z],w=C.dataPoints;C.dataPointIndexes=[];for(q=0;q<w.length;q++)z=w[q].x.getTime?w[q].x.getTime():w[q].x,C.dataPointIndexes[z]=
q,e[z]||(n.push(z),e[z]=!0);n.sort(Qa)}for(A=0;A<a.dataSeriesIndexes.length;A++){z=a.dataSeriesIndexes[A];C=this.data[z];w=C.dataPoints;y=!0;k=[];q=C.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:z};q=P(q);r.fillStyle=q;if(0<n.length){var e=C._colorSet[0],E=C.lineColor=C.options.lineColor||e,U=E;b.fillStyle=e;b.strokeStyle=E;b.lineWidth=C.lineThickness;x="solid";if(b.setLineDash){var S=J(C.nullDataLineDashType,C.lineThickness);x=C.lineDashType;var ga=J(x,C.lineThickness);
b.setLineDash(ga)}for(var aa=!0,q=0;q<n.length;q++){var f=n[q],ha=null,ha=0<=C.dataPointIndexes[f]?w[C.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!C.connectNullData||!aa)))if("number"!==typeof ha.y)C.connectNullData||(aa||y)||d(),aa=!0;else{g=a.axisX.convertValueToPixel(f);var oa=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=ha.y+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;
u=a.axisY.convertValueToPixel(p[f])}else u=a.axisY.convertValueToPixel(ha.y),u-=oa;k.push({x:g,y:m-oa});h[f]=m-u;y||aa?(!y&&C.connectNullData?(b.setLineDash&&(C.options.nullDataLineDashType||x===C.lineDashType&&C.lineDashType!==C.nullDataLineDashType)&&(y=k.pop(),x=k[k.length-1],d(),b.moveTo(t.x,t.y),k.push(x),k.push(y),x=C.nullDataLineDashType,b.setLineDash(S)),b.lineTo(g,u),v&&r.lineTo(g,u)):(b.beginPath(),b.moveTo(g,u),v&&(r.beginPath(),r.moveTo(g,u))),aa=y=!1):(b.lineTo(g,u),v&&r.lineTo(g,u),
0==q%250&&(d(),b.moveTo(g,u),v&&r.moveTo(g,u),k.push({x:g,y:m-oa})));t={x:g,y:u};q<w.length-1&&(U!==(w[q].lineColor||E)||x!==(w[q].lineDashType||C.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,u),k.push({x:g,y:m-oa}),U=w[q].lineColor||E,b.strokeStyle=U,b.setLineDash&&(w[q].lineDashType?(x=w[q].lineDashType,b.setLineDash(J(x,C.lineThickness))):(x=C.lineDashType,b.setLineDash(ga))));if(0<=C.dataPointIndexes[f]){var F=C.dataPointIds[C.dataPointIndexes[f]];this._eventManager.objectMap[F]={id:F,objectType:"dataPoint",
dataSeriesIndex:z,dataPointIndex:C.dataPointIndexes[f],x1:g,y1:u}}0<=C.dataPointIndexes[f]&&0!==ha.markerSize&&(0<ha.markerSize||0<C.markerSize)&&(oa=C.getMarkerProperties(C.dataPointIndexes[f],g,u,b),l.push(oa),f=P(F),v&&l.push({x:g,y:u,ctx:r,type:oa.type,size:oa.size,color:f,borderColor:f,borderThickness:oa.borderThickness}));(ha.indexLabel||C.indexLabel||ha.indexLabelFormatter||C.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:ha,dataSeries:C,point:{x:g,y:u},direction:0>
w[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,u);v&&r.moveTo(g,u)}delete C.dataPointIndexes}$.drawMarkers(l);v&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(s.x1,
s.y1,s.width,s.height),r.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderStackedArea100=function(a){function d(){for(0<C.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);v&&x.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=C.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();v&&(x.closePath(),x.fill(),x.beginPath());k=[]}var c=a.targetCanvasCtx||this.plotArea.ctx,
b=v?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=this.plotArea,s=[],h=[],k=[],n=[],p=[],q=0,g,u,m,r,t,y=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),x=this._eventManager.ghostCtx;b.save();v&&x.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();v&&(x.beginPath(),x.rect(l.x1,l.y1,l.width,l.height),x.clip());for(var e=[],A=0;A<a.dataSeriesIndexes.length;A++){var z=a.dataSeriesIndexes[A],C=this.data[z],w=C.dataPoints;C.dataPointIndexes=
[];for(q=0;q<w.length;q++)z=w[q].x.getTime?w[q].x.getTime():w[q].x,C.dataPointIndexes[z]=q,e[z]||(n.push(z),e[z]=!0);n.sort(Qa)}for(A=0;A<a.dataSeriesIndexes.length;A++){z=a.dataSeriesIndexes[A];C=this.data[z];w=C.dataPoints;r=!0;e=C.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:z};e=P(e);x.fillStyle=e;k=[];if(0<n.length){var e=C._colorSet[q%C._colorSet.length],E=C.lineColor=C.options.lineColor||e,U=E;b.fillStyle=e;b.strokeStyle=E;b.lineWidth=C.lineThickness;t="solid";
if(b.setLineDash){var S=J(C.nullDataLineDashType,C.lineThickness);t=C.lineDashType;var F=J(t,C.lineThickness);b.setLineDash(F)}for(var aa=!0,q=0;q<n.length;q++){var f=n[q],ha=null,ha=0<=C.dataPointIndexes[f]?w[C.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!C.connectNullData||!aa)))if("number"!==typeof ha.y)C.connectNullData||(aa||r)||d(),aa=!0;else{var oa;oa=0!==a.dataPointYSums[f]?100*(ha.y/a.dataPointYSums[f]):0;g=a.axisX.convertValueToPixel(f);
var na=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=oa+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;u=a.axisY.convertValueToPixel(p[f])}else u=a.axisY.convertValueToPixel(oa),u-=na;k.push({x:g,y:y-na});h[f]=y-u;r||aa?(!r&&C.connectNullData?(b.setLineDash&&(C.options.nullDataLineDashType||t===C.lineDashType&&C.lineDashType!==C.nullDataLineDashType)&&(r=k.pop(),t=k[k.length-1],d(),b.moveTo(m.x,m.y),k.push(t),k.push(r),t=C.nullDataLineDashType,
b.setLineDash(S)),b.lineTo(g,u),v&&x.lineTo(g,u)):(b.beginPath(),b.moveTo(g,u),v&&(x.beginPath(),x.moveTo(g,u))),aa=r=!1):(b.lineTo(g,u),v&&x.lineTo(g,u),0==q%250&&(d(),b.moveTo(g,u),v&&x.moveTo(g,u),k.push({x:g,y:y-na})));m={x:g,y:u};q<w.length-1&&(U!==(w[q].lineColor||E)||t!==(w[q].lineDashType||C.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,u),k.push({x:g,y:y-na}),U=w[q].lineColor||E,b.strokeStyle=U,b.setLineDash&&(w[q].lineDashType?(t=w[q].lineDashType,b.setLineDash(J(t,C.lineThickness))):(t=
C.lineDashType,b.setLineDash(F))));if(0<=C.dataPointIndexes[f]){var H=C.dataPointIds[C.dataPointIndexes[f]];this._eventManager.objectMap[H]={id:H,objectType:"dataPoint",dataSeriesIndex:z,dataPointIndex:C.dataPointIndexes[f],x1:g,y1:u}}0<=C.dataPointIndexes[f]&&0!==ha.markerSize&&(0<ha.markerSize||0<C.markerSize)&&(na=C.getMarkerProperties(q,g,u,b),s.push(na),f=P(H),v&&s.push({x:g,y:u,ctx:x,type:na.type,size:na.size,color:f,borderColor:f,borderThickness:na.borderThickness}));(ha.indexLabel||C.indexLabel||
ha.indexLabelFormatter||C.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:ha,dataSeries:C,point:{x:g,y:u},direction:0>w[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,u);v&&x.moveTo(g,u)}delete C.dataPointIndexes}$.drawMarkers(s);v&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,
0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),x.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderBubble=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=v?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this.plotArea,e=0,f,l;c.save();
...
typeof q[e].z||(g=q[e].z,g>s&&(s=g),g<h&&(h=g));for(var u=25*Math.PI,m=Math.max(Math.pow(0.25*Math.min(b.height,b.width)/2,2)*Math.PI,u),k=0;k<a.dataSeriesIndexes.length;k++)if(n=a.dataSeriesIndexes[k],p=this.data[n],q=p.dataPoints,0<q.length)for(c.strokeStyle="#4572A7 ",e=0;e<q.length;e++)if(f=q[e].getTime?f=q[e].x.getTime():f=q[e].x,!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof q[e].y){f=a.axisX.convertValueToPixel(f);l=a.axisY.convertValueToPixel(q[e].y);
var g=q[e].z,r=2*Math.max(Math.sqrt((s===h?m/2:u+(m-u)/(s-h)*(g-h))/Math.PI)<<0,1),g=p.getMarkerProperties(e,c);g.size=r;c.globalAlpha=p.fillOpacity;$.drawMarker(f,l,c,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;var t=p.dataPointIds[e];this._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataSeriesIndex:n,dataPointIndex:e,x1:f,y1:l,size:r};r=P(t);v&&$.drawMarker(f,l,this._eventManager.ghostCtx,g.type,g.size,r,r,g.borderThickness);(q[e].indexLabel||p.indexLabel||
...
this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(b.x1,b.y1,b.width,b.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};m.prototype.renderScatter=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=v?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this.plotArea,e=0,f,l;c.save();v&&this._eventManager.ghostCtx.save();
...
f>a.axisX.dataInfo.viewPortMax)&&"number"===typeof n[e].y){f=a.axisX.convertValueToPixel(f);l=a.axisY.convertValueToPixel(n[e].y);var g=k.getMarkerProperties(e,f,l,c);c.globalAlpha=k.fillOpacity;$.drawMarker(g.x,g.y,g.ctx,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;Math.sqrt((p-f)*(p-f)+(q-l)*(q-l))<Math.min(g.size,5)&&n.length>Math.min(this.plotArea.width,this.plotArea.height)||(p=k.dataPointIds[e],this._eventManager.objectMap[p]={id:p,objectType:"dataPoint",dataSeriesIndex:h,
dataPointIndex:e,x1:f,y1:l},p=P(p),v&&$.drawMarker(g.x,g.y,this._eventManager.ghostCtx,g.type,g.size,p,p,g.borderThickness),(n[e].indexLabel||k.indexLabel||n[e].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"scatter",dataPoint:n[e],dataSeries:k,point:{x:f,y:l},direction:1,bounds:{x1:f-g.size/2,y1:l-g.size/2,x2:f+g.size/2,y2:l+g.size/2},color:null}),p=f,q=l)}}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",
...
l.height),b.clip());for(var m=0;m<a.dataSeriesIndexes.length;m++){var D=a.dataSeriesIndexes[m],t=this.data[D],y=t.dataPoints;if(0<y.length)for(var x=5<u&&t.bevelEnabled?!0:!1,s=0;s<y.length;s++)if(y[s].getTime?g=y[s].x.getTime():g=y[s].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!r(y[s].y)&&y[s].y.length&&"number"===typeof y[s].y[0]&&"number"===typeof y[s].y[1]&&"number"===typeof y[s].y[2]&&"number"===typeof y[s].y[3]){h=a.axisX.convertValueToPixel(g);k=a.axisY.convertValueToPixel(y[s].y[0]);
n=a.axisY.convertValueToPixel(y[s].y[1]);p=a.axisY.convertValueToPixel(y[s].y[2]);q=a.axisY.convertValueToPixel(y[s].y[3]);var A=h-u/2<<0,z=A+u<<0,f=t.options.fallingColor?t.fallingColor:t._colorSet[0],e=y[s].color?y[s].color:t._colorSet[0],C=Math.round(Math.max(1,0.15*u)),w=0===C%2?0:0.5,E=t.dataPointIds[s];this._eventManager.objectMap[E]={id:E,objectType:"dataPoint",dataSeriesIndex:D,dataPointIndex:s,x1:A,y1:k,x2:z,y2:n,x3:h,y3:p,x4:h,y4:q,borderThickness:C,color:e};c.strokeStyle=e;c.beginPath();
c.lineWidth=C;b.lineWidth=Math.max(C,4);"candlestick"===t.type?(c.moveTo(h-w,n),c.lineTo(h-w,Math.min(k,q)),c.stroke(),c.moveTo(h-w,Math.max(k,q)),c.lineTo(h-w,p),c.stroke(),ba(c,A,Math.min(k,q),z,Math.max(k,q),y[s].y[0]<=y[s].y[3]?t.risingColor:f,C,e,x,x,!1,!1,t.fillOpacity),v&&(e=P(E),b.strokeStyle=e,b.moveTo(h-w,n),b.lineTo(h-w,Math.min(k,q)),b.stroke(),b.moveTo(h-w,Math.max(k,q)),b.lineTo(h-w,p),b.stroke(),ba(b,A,Math.min(k,q),z,Math.max(k,q),e,0,null,!1,!1,!1,!1))):"ohlc"===t.type&&(c.moveTo(h-
w,n),c.lineTo(h-w,p),c.stroke(),c.beginPath(),c.moveTo(h,k),c.lineTo(A,k),c.stroke(),c.beginPath(),c.moveTo(h,q),c.lineTo(z,q),c.stroke(),v&&(e=P(E),b.strokeStyle=e,b.moveTo(h-w,n),b.lineTo(h-w,p),b.stroke(),b.beginPath(),b.moveTo(h,k),b.lineTo(A,k),b.stroke(),b.beginPath(),b.moveTo(h,q),b.lineTo(z,q),b.stroke()));(y[s].indexLabel||t.indexLabel||y[s].indexLabelFormatter||t.indexLabelFormatter)&&this._indexLabels.push({chartType:t.type,dataPoint:y[s],dataSeries:t,point:{x:A+(z-A)/2,y:a.axisY.reversed?
p:n},direction:1,bounds:{x1:A,y1:Math.min(n,p),x2:z,y2:Math.max(n,p)},color:e})}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(l.x1,l.y1,l.width,l.height),b.restore());
c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};m.prototype.renderBoxAndWhisker=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=v?this._preRenderCtx:d,b=this._eventManager.ghostCtx;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=this.plotArea,l=0,s,h,k,n,p,q,g,e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1,l=this.options.dataPointMaxWidth?
...
this.dataPointWidth:-Infinity,e));u<e&&(u=e);u>l&&(u=l);c.save();v&&b.save();c.beginPath();c.rect(f.x1,f.y1,f.width,f.height);c.clip();v&&(b.beginPath(),b.rect(f.x1,f.y1,f.width,f.height),b.clip());for(var m=!1,m=!!a.axisY.reversed,D=0;D<a.dataSeriesIndexes.length;D++){var t=a.dataSeriesIndexes[D],y=this.data[t],x=y.dataPoints;if(0<x.length)for(var A=5<u&&y.bevelEnabled?!0:!1,l=0;l<x.length;l++)if(x[l].getTime?g=x[l].x.getTime():g=x[l].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&
!r(x[l].y)&&x[l].y.length&&"number"===typeof x[l].y[0]&&"number"===typeof x[l].y[1]&&"number"===typeof x[l].y[2]&&"number"===typeof x[l].y[3]&&"number"===typeof x[l].y[4]&&5===x[l].y.length){s=a.axisX.convertValueToPixel(g);h=a.axisY.convertValueToPixel(x[l].y[0]);k=a.axisY.convertValueToPixel(x[l].y[1]);n=a.axisY.convertValueToPixel(x[l].y[2]);p=a.axisY.convertValueToPixel(x[l].y[3]);q=a.axisY.convertValueToPixel(x[l].y[4]);var z=s-u/2<<0,C=s+u/2<<0,e=x[l].color?x[l].color:y._colorSet[0],w=Math.round(Math.max(1,
0.15*u)),E=0===w%2?0:0.5,U=x[l].whiskerColor?x[l].whiskerColor:x[l].color?y.whiskerColor?y.whiskerColor:x[l].color:y.whiskerColor?y.whiskerColor:e,S="number"===typeof x[l].whiskerThickness?x[l].whiskerThickness:"number"===typeof y.options.whiskerThickness?y.whiskerThickness:w,F=x[l].whiskerDashType?x[l].whiskerDashType:y.whiskerDashType,aa=r(x[l].whiskerLength)?r(y.options.whiskerLength)?u:y.whiskerLength:x[l].whiskerLength,aa="number"===typeof aa?0>=aa?0:aa>=u?u:aa:"string"===typeof aa?parseInt(aa)*
u/100>u?u:parseInt(aa)*u/100:u,ha=1===Math.round(S)%2?0.5:0,oa=x[l].stemColor?x[l].stemColor:x[l].color?y.stemColor?y.stemColor:x[l].color:y.stemColor?y.stemColor:e,na="number"===typeof x[l].stemThickness?x[l].stemThickness:"number"===typeof y.options.stemThickness?y.stemThickness:w,H=1===Math.round(na)%2?0.5:0,G=x[l].stemDashType?x[l].stemDashType:y.stemDashType,K=x[l].lineColor?x[l].lineColor:x[l].color?y.lineColor?y.lineColor:x[l].color:y.lineColor?y.lineColor:e,L="number"===typeof x[l].lineThickness?
x[l].lineThickness:"number"===typeof y.options.lineThickness?y.lineThickness:w,O=x[l].lineDashType?x[l].lineDashType:y.lineDashType,N=1===Math.round(L)%2?0.5:0,T=y.upperBoxColor,R=y.lowerBoxColor,ta=r(y.options.fillOpacity)?1:y.fillOpacity,Q=y.dataPointIds[l];this._eventManager.objectMap[Q]={id:Q,objectType:"dataPoint",dataSeriesIndex:t,dataPointIndex:l,x1:z,y1:h,x2:C,y2:k,x3:s,y3:n,x4:s,y4:p,y5:q,borderThickness:w,color:e,stemThickness:na,stemColor:oa,whiskerThickness:S,whiskerLength:aa,whiskerColor:U,
lineThickness:L,lineColor:K};c.save();0<na&&(c.beginPath(),c.strokeStyle=oa,c.lineWidth=na,c.setLineDash&&c.setLineDash(J(G,na)),c.moveTo(s-H,k),c.lineTo(s-H,h),c.stroke(),c.moveTo(s-H,p),c.lineTo(s-H,n),c.stroke());c.restore();b.lineWidth=Math.max(w,4);c.beginPath();ba(c,z,Math.min(q,k),C,Math.max(k,q),R,0,e,m?A:!1,m?!1:A,!1,!1,ta);c.beginPath();ba(c,z,Math.min(n,q),C,Math.max(q,n),T,0,e,m?!1:A,m?A:!1,!1,!1,ta);c.beginPath();c.lineWidth=w;c.strokeStyle=e;c.rect(z-E,Math.min(k,n)-E,C-z+2*E,Math.max(k,
n)-Math.min(k,n)+2*E);c.stroke();c.save();0<L&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(J(O,L)),c.strokeStyle=K,c.lineWidth=L,c.moveTo(z,q-N),c.lineTo(C,q-N),c.stroke());c.restore();c.save();0<S&&(c.beginPath(),c.setLineDash&&c.setLineDash(J(F,S)),c.strokeStyle=U,c.lineWidth=S,c.moveTo(s-aa/2<<0,p-ha),c.lineTo(s+aa/2<<0,p-ha),c.stroke(),c.moveTo(s-aa/2<<0,h+ha),c.lineTo(s+aa/2<<0,h+ha),c.stroke());c.restore();v&&(e=P(Q),b.strokeStyle=e,b.lineWidth=na,0<na&&(b.moveTo(s-E-H,k),b.lineTo(s-
E-H,Math.max(h,p)),b.stroke(),b.moveTo(s-E-H,Math.min(h,p)),b.lineTo(s-E-H,n),b.stroke()),ba(b,z,Math.max(k,n),C,Math.min(k,n),e,0,null,!1,!1,!1,!1),0<S&&(b.beginPath(),b.lineWidth=S,b.moveTo(s+aa/2,p-ha),b.lineTo(s-aa/2,p-ha),b.stroke(),b.moveTo(s+aa/2,h+ha),b.lineTo(s-aa/2,h+ha),b.stroke()));(x[l].indexLabel||y.indexLabel||x[l].indexLabelFormatter||y.indexLabelFormatter)&&this._indexLabels.push({chartType:y.type,dataPoint:x[l],dataSeries:y,point:{x:z+(C-z)/2,y:a.axisY.reversed?h:p},direction:1,
bounds:{x1:z,y1:Math.min(h,p),x2:C,y2:Math.max(h,p)},color:e})}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(f.x1,f.y1,f.width,f.height),b.restore());c.restore();return{source:d,
dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};m.prototype.renderRangeColumn=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=v?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=null,e=this.plotArea,f=0,l,s,h,f=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;l=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:
...
f));k<f&&(k=f);k>l&&(k=l);c.save();v&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();v&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var n=0;n<a.dataSeriesIndexes.length;n++){var p=a.dataSeriesIndexes[n],q=this.data[p],g=q.dataPoints;if(0<g.length)for(var u=5<k&&q.bevelEnabled?!0:!1,f=0;f<g.length;f++)if(g[f].getTime?h=g[f].x.getTime():h=g[f].x,!(h<a.axisX.dataInfo.viewPortMin||
h>a.axisX.dataInfo.viewPortMax)&&!r(g[f].y)&&g[f].y.length&&"number"===typeof g[f].y[0]&&"number"===typeof g[f].y[1]){b=a.axisX.convertValueToPixel(h);l=a.axisY.convertValueToPixel(g[f].y[0]);s=a.axisY.convertValueToPixel(g[f].y[1]);var m=a.axisX.reversed?b+a.plotType.totalDataSeries*k/2-(a.previousDataSeriesCount+n)*k<<0:b-a.plotType.totalDataSeries*k/2+(a.previousDataSeriesCount+n)*k<<0,D=a.axisX.reversed?m-k<<0:m+k<<0,b=g[f].color?g[f].color:q._colorSet[f%q._colorSet.length];if(l>s){var t=l;l=
s;s=t}t=q.dataPointIds[f];this._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:f,x1:m,y1:l,x2:D,y2:s};ba(c,a.axisX.reversed?D:m,l,a.axisX.reversed?m:D,s,b,0,b,u,u,!1,!1,q.fillOpacity);b=P(t);v&&ba(this._eventManager.ghostCtx,a.axisX.reversed?D:m,l,a.axisX.reversed?m:D,s,b,0,null,!1,!1,!1,!1);if(g[f].indexLabel||q.indexLabel||g[f].indexLabelFormatter||q.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:0,
point:{x:m+(D-m)/2,y:g[f].y[1]>=g[f].y[0]?s:l},direction:g[f].y[1]>=g[f].y[0]?-1:1,bounds:{x1:m,y1:Math.min(l,s),x2:D,y2:Math.max(l,s)},color:b}),this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:1,point:{x:m+(D-m)/2,y:g[f].y[1]>=g[f].y[0]?l:s},direction:g[f].y[1]>=g[f].y[0]?1:-1,bounds:{x1:m,y1:Math.min(l,s),x2:D,y2:Math.max(l,s)},color:b})}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&
...
a.targetCanvasCtx||this.plotArea.ctx,c=v?this._preRenderCtx:d,b=a.axisY._position?"left"===a.axisY._position||"right"===a.axisY._position?!1:!0:!1;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=!1,l=this.plotArea,s=0,h,k,n,p,q,g,u,m=a.axisX.dataInfo.minDiff;isFinite(m)||(m=0.3*Math.abs(a.axisX.range));c.save();v&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(l.x1,l.y1,l.width,l.height);c.clip();v&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(l.x1,l.y1,l.width,
l.height),this._eventManager.ghostCtx.clip());for(var D=0,t=0;t<this.data.length;t++)!this.data[t].type.match(/(bar|column)/ig)||!this.data[t].visible||this.data[t].type.match(/(stacked)/ig)&&D||D++;for(var y=0;y<a.dataSeriesIndexes.length;y++){var x=a.dataSeriesIndexes[y],A=this.data[x],z=A.dataPoints,C=r(A._linkedSeries)?!1:A._linkedSeries.type.match(/(bar|column)/ig)&&A._linkedSeries.visible?!0:!1,w=0;if(C)for(e=A._linkedSeries.id,t=0;t<e;t++)!this.data[t].type.match(/(bar|column)/ig)||!this.data[t].visible||
this.data[t].type.match(/(stacked)/ig)&&w||(this.data[t].type.match(/(range)/ig)&&(f=!0),w++);e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:1;s=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(C?D:1)))<<0:0.3*this.width;f&&(s=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*
this.height,0.9*(this.plotArea.height/(C?D:1)))<<0:0.03*this.width);t=this.options.dataPointWidth?this.dataPointWidth:0.9*((b?l.height:l.width)*(a.axisX.logarithmic?Math.log(m)/Math.log(a.axisX.range):Math.abs(m)/Math.abs(a.axisX.range))/(C?D:1))<<0;this.dataPointMaxWidth&&e>s&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,s));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&s<e)&&(s=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));t<e&&(t=e);t>s&&(t=
s);if(0<z.length)for(var E=A._colorSet,s=0;s<z.length;s++){var e=A.lineColor=A.options.color?A.options.color:E[0],U={color:z[s].whiskerColor?z[s].whiskerColor:z[s].color?A.whiskerColor?A.whiskerColor:z[s].color:A.whiskerColor?A.whiskerColor:e,thickness:r(z[s].whiskerThickness)?A.whiskerThickness:z[s].whiskerThickness,dashType:z[s].whiskerDashType?z[s].whiskerDashType:A.whiskerDashType,length:r(z[s].whiskerLength)?r(A.options.whiskerLength)?t:A.options.whiskerLength:z[s].whiskerLength,trimLength:r(z[s].whiskerLength)?
r(A.options.whiskerLength)?50:0:0};U.length="number"===typeof U.length?0>=U.length?0:U.length>=t?t:U.length:"string"===typeof U.length?parseInt(U.length)*t/100>t?t:parseInt(U.length)*t/100>t:t;U.thickness="number"===typeof U.thickness?0>U.thickness?0:Math.round(U.thickness):2;var S={color:z[s].stemColor?z[s].stemColor:z[s].color?A.stemColor?A.stemColor:z[s].color:A.stemColor?A.stemColor:e,thickness:z[s].stemThickness?z[s].stemThickness:A.stemThickness,dashType:z[s].stemDashType?z[s].stemDashType:
A.stemDashType};S.thickness="number"===typeof S.thickness?0>S.thickness?0:Math.round(S.thickness):2;z[s].getTime?u=z[s].x.getTime():u=z[s].x;if(!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax)&&!r(z[s].y)&&z[s].y.length&&"number"===typeof z[s].y[0]&&"number"===typeof z[s].y[1]){var ga=a.axisX.convertValueToPixel(u);b?k=ga:h=ga;ga=a.axisY.convertValueToPixel(z[s].y[0]);b?n=ga:q=ga;ga=a.axisY.convertValueToPixel(z[s].y[1]);b?p=ga:g=ga;b?(q=a.axisX.reversed?k+(C?D:1)*t/2-(C?w-1:0)*t<<
0:k-(C?D:1)*t/2+(C?w-1:0)*t<<0,g=a.axisX.reversed?q-t<<0:q+t<<0):(n=a.axisX.reversed?h+(C?D:1)*t/2-(C?w-1:0)*t<<0:h-(C?D:1)*t/2+(C?w-1:0)*t<<0,p=a.axisX.reversed?n-t<<0:n+t<<0);!b&&q>g&&(ga=q,q=g,g=ga);b&&n>p&&(ga=n,n=p,p=ga);ga=A.dataPointIds[s];this._eventManager.objectMap[ga]={id:ga,objectType:"dataPoint",dataSeriesIndex:x,dataPointIndex:s,x1:Math.min(n,p),y1:Math.min(q,g),x2:Math.max(p,n),y2:Math.max(g,q),isXYSwapped:b,stemProperties:S,whiskerProperties:U};F(c,Math.min(n,p),Math.min(q,g),Math.max(p,
n),Math.max(g,q),e,U,S,b);v&&F(this._eventManager.ghostCtx,n,q,p,g,e,U,S,b);if(z[s].indexLabel||A.indexLabel||z[s].indexLabelFormatter||A.indexLabelFormatter)this._indexLabels.push({chartType:"error",dataPoint:z[s],dataSeries:A,indexKeyword:0,point:{x:b?z[s].y[1]>=z[s].y[0]?n:p:n+(p-n)/2,y:b?q+(g-q)/2:z[s].y[1]>=z[s].y[0]?g:q},direction:z[s].y[1]>=z[s].y[0]?-1:1,bounds:{x1:b?Math.min(n,p):n,y1:b?q:Math.min(q,g),x2:b?Math.max(n,p):p,y2:b?g:Math.max(q,g)},color:e,axisSwapped:b}),this._indexLabels.push({chartType:"error",
dataPoint:z[s],dataSeries:A,indexKeyword:1,point:{x:b?z[s].y[1]>=z[s].y[0]?p:n:n+(p-n)/2,y:b?q+(g-q)/2:z[s].y[1]>=z[s].y[0]?q:g},direction:z[s].y[1]>=z[s].y[0]?1:-1,bounds:{x1:b?Math.min(n,p):n,y1:b?q:Math.min(q,g),x2:b?Math.max(n,p):p,y2:b?g:Math.max(q,g)},color:e,axisSwapped:b})}}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,
0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};m.prototype.renderRangeBar=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=v?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=
...
e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],u=g.dataPoints;if(0<u.length){var m=5<n&&g.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(f=0;f<u.length;f++)if(u[f].getTime?k=u[f].x.getTime():k=u[f].x,!(k<a.axisX.dataInfo.viewPortMin||k>a.axisX.dataInfo.viewPortMax)&&!r(u[f].y)&&u[f].y.length&&"number"===typeof u[f].y[0]&&"number"===typeof u[f].y[1]){l=a.axisY.convertValueToPixel(u[f].y[0]);s=a.axisY.convertValueToPixel(u[f].y[1]);
h=a.axisX.convertValueToPixel(k);h=a.axisX.reversed?h+a.plotType.totalDataSeries*n/2-(a.previousDataSeriesCount+p)*n<<0:h-a.plotType.totalDataSeries*n/2+(a.previousDataSeriesCount+p)*n<<0;var D=a.axisX.reversed?h-n<<0:h+n<<0;l>s&&(b=l,l=s,s=b);b=u[f].color?u[f].color:g._colorSet[f%g._colorSet.length];ba(c,l,a.axisX.reversed?D:h,s,a.axisX.reversed?h:D,b,0,null,m,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,
x1:l,y1:h,x2:s,y2:D};b=P(b);v&&ba(this._eventManager.ghostCtx,l,a.axisX.reversed?D:h,s,a.axisX.reversed?h:D,b,0,null,!1,!1,!1,!1);if(u[f].indexLabel||g.indexLabel||u[f].indexLabelFormatter||g.indexLabelFormatter)this._indexLabels.push({chartType:"rangeBar",dataPoint:u[f],dataSeries:g,indexKeyword:0,point:{x:u[f].y[1]>=u[f].y[0]?l:s,y:h+(D-h)/2},direction:u[f].y[1]>=u[f].y[0]?-1:1,bounds:{x1:Math.min(l,s),y1:h,x2:Math.max(l,s),y2:D},color:b}),this._indexLabels.push({chartType:"rangeBar",dataPoint:u[f],
dataSeries:g,indexKeyword:1,point:{x:u[f].y[1]>=u[f].y[0]?s:l,y:h+(D-h)/2},direction:u[f].y[1]>=u[f].y[0]?1:-1,bounds:{x1:Math.min(l,s),y1:h,x2:Math.max(l,s),y2:D},color:b})}}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
0,0,this.width,this.height),c.clearRect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};m.prototype.renderRangeArea=function(a){function d(){if(y){for(var a=null,c=h.length-1;0<=c;c--)a=h[c],b.lineTo(a.x,a.y2),e.lineTo(a.x,a.y2);b.closePath();b.globalAlpha=n.fillOpacity;b.fill();b.globalAlpha=1;e.fill();if(0<n.lineThickness){b.beginPath();
b.moveTo(a.x,a.y2);for(c=0;c<h.length;c++)a=h[c],b.lineTo(a.x,a.y2);b.moveTo(h[0].x,h[0].y1);for(c=0;c<h.length;c++)a=h[c],b.lineTo(a.x,a.y1);b.stroke()}b.beginPath();b.moveTo(m,r);e.beginPath();e.moveTo(m,r);y={x:m,y:r};h=[];h.push({x:m,y1:r,y2:D})}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=v?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();v&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();v&&(e.beginPath(),
e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var s=0;s<a.dataSeriesIndexes.length;s++){var h=[],k=a.dataSeriesIndexes[s],n=this.data[k],p=n.dataPoints,f=n.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:k};f=P(f);e.fillStyle=f;var f=[],q=!0,g=0,m,r,D,t,y=null;if(0<p.length){var x=n._colorSet[g%n._colorSet.length],A=n.lineColor=n.options.lineColor||x,z=A;b.fillStyle=x;b.strokeStyle=A;b.lineWidth=n.lineThickness;var C="solid";if(b.setLineDash){var w=J(n.nullDataLineDashType,
n.lineThickness),C=n.lineDashType,E=J(C,n.lineThickness);b.setLineDash(E)}for(var U=!0;g<p.length;g++)if(t=p[g].x.getTime?p[g].x.getTime():p[g].x,!(t<a.axisX.dataInfo.viewPortMin||t>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!U)))if(null!==p[g].y&&p[g].y.length&&"number"===typeof p[g].y[0]&&"number"===typeof p[g].y[1]){m=a.axisX.convertValueToPixel(t);r=a.axisY.convertValueToPixel(p[g].y[0]);D=a.axisY.convertValueToPixel(p[g].y[1]);q||U?(n.connectNullData&&!q?(b.setLineDash&&(n.options.nullDataLineDashType||
C===n.lineDashType&&n.lineDashType!==n.nullDataLineDashType)&&(h[h.length-1].newLineDashArray=E,C=n.nullDataLineDashType,b.setLineDash(w)),b.lineTo(m,r),v&&e.lineTo(m,r),h.push({x:m,y1:r,y2:D})):(b.beginPath(),b.moveTo(m,r),y={x:m,y:r},h=[],h.push({x:m,y1:r,y2:D}),v&&(e.beginPath(),e.moveTo(m,r))),U=q=!1):(b.lineTo(m,r),h.push({x:m,y1:r,y2:D}),v&&e.lineTo(m,r),0==g%250&&d());t=n.dataPointIds[g];this._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:g,x1:m,y1:r,
y2:D};g<p.length-1&&(z!==(p[g].lineColor||A)||C!==(p[g].lineDashType||n.lineDashType))&&(d(),z=p[g].lineColor||A,h[h.length-1].newStrokeStyle=z,b.strokeStyle=z,b.setLineDash&&(p[g].lineDashType?(C=p[g].lineDashType,h[h.length-1].newLineDashArray=J(C,n.lineThickness),b.setLineDash(h[h.length-1].newLineDashArray)):(C=n.lineDashType,h[h.length-1].newLineDashArray=E,b.setLineDash(E))));if(0!==p[g].markerSize&&(0<p[g].markerSize||0<n.markerSize)){var S=n.getMarkerProperties(g,m,D,b);f.push(S);var F=P(t);
v&&f.push({x:m,y:D,ctx:e,type:S.type,size:S.size,color:F,borderColor:F,borderThickness:S.borderThickness});S=n.getMarkerProperties(g,m,r,b);f.push(S);F=P(t);v&&f.push({x:m,y:r,ctx:e,type:S.type,size:S.size,color:F,borderColor:F,borderThickness:S.borderThickness})}if(p[g].indexLabel||n.indexLabel||p[g].indexLabelFormatter||n.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,indexKeyword:0,point:{x:m,y:r},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?-1:
1,color:x}),this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,indexKeyword:1,point:{x:m,y:D},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?1:-1,color:x})}else U||q||d(),U=!0;d();$.drawMarkers(f)}}v&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&
...
1].x,d[f+1].y,d[f+2].x,d[f+2].y,d[f+3].x,d[f+3].y);d=w(D,2);b.lineTo(D[D.length-1].x,D[D.length-1].y);for(f=d.length-1;2<f;f-=3)b.bezierCurveTo(d[f-1].x,d[f-1].y,d[f-2].x,d[f-2].y,d[f-3].x,d[f-3].y),v&&e.bezierCurveTo(d[f-1].x,d[f-1].y,d[f-2].x,d[f-2].y,d[f-3].x,d[f-3].y);b.closePath();b.globalAlpha=k.fillOpacity;b.fill();v&&(e.closePath(),e.fill());b.globalAlpha=1;if(0<k.lineThickness){b.strokeStyle=c;b.setLineDash&&b.setLineDash(a);b.beginPath();b.moveTo(d[0].x,d[0].y);for(var g=f=0;f<d.length-
...
a.dataSeriesIndexes[s],k=this.data[h],n=k.dataPoints,f=k.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:h};f=P(f);e.fillStyle=f;var f=[],p=0,q,g,m,r=[],D=[];if(0<n.length){var t=k._colorSet[p%k._colorSet.length],y=k.lineColor=k.options.lineColor||t,x=y;b.fillStyle=t;b.lineWidth=k.lineThickness;var A="solid",z;if(b.setLineDash){var C=J(k.nullDataLineDashType,k.lineThickness),A=k.lineDashType;z=J(A,k.lineThickness)}for(g=!1;p<n.length;p++)if(q=n[p].x.getTime?n[p].x.getTime():
n[p].x,!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!g)))if(null!==n[p].y&&n[p].y.length&&"number"===typeof n[p].y[0]&&"number"===typeof n[p].y[1]){q=a.axisX.convertValueToPixel(q);g=a.axisY.convertValueToPixel(n[p].y[0]);m=a.axisY.convertValueToPixel(n[p].y[1]);var E=k.dataPointIds[p];this._eventManager.objectMap[E]={id:E,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:p,x1:q,y1:g,y2:m};r[r.length]={x:q,y:g};D[D.length]={x:q,y:m};p<n.length-1&&(x!==
(n[p].lineColor||y)||A!==(n[p].lineDashType||k.lineDashType))&&(x=n[p].lineColor||y,r[r.length-1].newStrokeStyle=x,b.setLineDash&&(n[p].lineDashType?(A=n[p].lineDashType,r[r.length-1].newLineDashArray=J(A,k.lineThickness)):(A=k.lineDashType,r[r.length-1].newLineDashArray=z)));if(0!==n[p].markerSize&&(0<n[p].markerSize||0<k.markerSize)){var F=k.getMarkerProperties(p,q,g,b);f.push(F);var U=P(E);v&&f.push({x:q,y:g,ctx:e,type:F.type,size:F.size,color:U,borderColor:U,borderThickness:F.borderThickness});
F=k.getMarkerProperties(p,q,m,b);f.push(F);U=P(E);v&&f.push({x:q,y:m,ctx:e,type:F.type,size:F.size,color:U,borderColor:U,borderThickness:F.borderThickness})}if(n[p].indexLabel||k.indexLabel||n[p].indexLabelFormatter||k.indexLabelFormatter)this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:n[p],dataSeries:k,indexKeyword:0,point:{x:q,y:g},direction:n[p].y[0]<=n[p].y[1]?-1:1,color:t}),this._indexLabels.push({chartType:"rangeSplineArea",dataPoint:n[p],dataSeries:k,indexKeyword:1,point:{x:q,
y:m},direction:n[p].y[0]<=n[p].y[1]?1:-1,color:t});g=!1}else 0<p&&!g&&(k.connectNullData?b.setLineDash&&(0<r.length&&(k.options.nullDataLineDashType||!n[p-1].lineDashType))&&(r[r.length-1].newLineDashArray=C,A=k.nullDataLineDashType):(d(z,y),r=[],D=[])),g=!0;d(z,y);$.drawMarkers(f)}}v&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,
0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.restore());b.restore();return{source:c,dest:this.plotArea.ctx,animationCallback:M.xClipAnimation,easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderWaterfall=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=v?this._preRenderCtx:d;if(!(0>=a.dataSeriesIndexes.length)){var b=this._eventManager.ghostCtx,
...
c.clip();v&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(f.x1,f.y1,f.width,f.height),this._eventManager.ghostCtx.clip());for(var g=0;g<a.dataSeriesIndexes.length;g++){var m=a.dataSeriesIndexes[g],r=this.data[m],D=r.dataPoints,e=r._colorSet[0];r.risingColor=r.options.risingColor?r.options.risingColor:e;r.fallingColor=r.options.fallingColor?r.options.fallingColor:"#e40a0a";var t="number"===typeof r.options.lineThickness?Math.round(r.lineThickness):1,y=1===Math.round(t)%
2?-0.5:0;if(0<D.length)for(var x=5<q&&r.bevelEnabled?!0:!1,A=!1,z=null,C=null,l=0;l<D.length;l++)if(D[l].getTime?n=D[l].x.getTime():n=D[l].x,"number"!==typeof D[l].y){if(0<l&&!A&&r.connectNullData)var w=r.options.nullDataLineDashType||!D[l-1].lineDashType?r.nullDataLineDashType:D[l-1].lineDashType;A=!0}else{s=a.axisX.convertValueToPixel(n);h=0===r.dataPointEOs[l].cumulativeSum?p:a.axisY.convertValueToPixel(r.dataPointEOs[l].cumulativeSum);k=0===r.dataPointEOs[l].cumulativeSumYStartValue?p:a.axisY.convertValueToPixel(r.dataPointEOs[l].cumulativeSumYStartValue);
s=a.axisX.reversed?s+a.plotType.totalDataSeries*q/2-(a.previousDataSeriesCount+g)*q<<0:s-a.plotType.totalDataSeries*q/2+(a.previousDataSeriesCount+g)*q<<0;var E=a.axisX.reversed?s-q<<0:s+q<<0;h>k&&(e=h,h=k,k=e);a.axisY.reversed&&(e=h,h=k,k=e);e=r.dataPointIds[l];this._eventManager.objectMap[e]={id:e,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:l,x1:s,y1:h,x2:E,y2:k};var U=D[l].color?D[l].color:0<D[l].y?r.risingColor:r.fallingColor;ba(c,a.axisX.reversed?E:s,a.axisY.reversed?k:h,a.axisX.reversed?
s:E,a.axisY.reversed?h:k,U,0,U,x,x,!1,!1,r.fillOpacity);e=P(e);v&&ba(this._eventManager.ghostCtx,a.axisX.reversed?E:s,h,a.axisX.reversed?s:E,k,e,0,null,!1,!1,!1,!1);var S,U=s;S="undefined"!==typeof D[l].isIntermediateSum&&!0===D[l].isIntermediateSum||"undefined"!==typeof D[l].isCumulativeSum&&!0===D[l].isCumulativeSum?0<D[l].y?h:k:0<D[l].y?k:h;0<l&&z&&(!A||r.connectNullData)&&(A&&c.setLineDash&&c.setLineDash(J(w,t)),c.beginPath(),c.moveTo(z,C-y),c.lineTo(U,S-y),0<t&&c.stroke(),v&&(b.beginPath(),b.moveTo(z,
C-y),b.lineTo(U,S-y),0<t&&b.stroke()));A=!1;z=E;C=0<D[l].y?h:k;U=D[l].lineDashType?D[l].lineDashType:r.options.lineDashType?r.options.lineDashType:"shortDash";c.strokeStyle=D[l].lineColor?D[l].lineColor:r.options.lineColor?r.options.lineColor:"#9e9e9e";c.lineWidth=t;c.setLineDash&&(U=J(U,t),c.setLineDash(U));(D[l].indexLabel||r.indexLabel||D[l].indexLabelFormatter||r.indexLabelFormatter)&&this._indexLabels.push({chartType:"waterfall",dataPoint:D[l],dataSeries:r,point:{x:s+(E-s)/2,y:0<=D[l].y?h:k},
direction:0>D[l].y===a.axisY.reversed?1:-1,bounds:{x1:s,y1:Math.min(h,k),x2:E,y2:Math.max(h,k)},color:e})}}v&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.clearRect(f.x1,f.y1,f.width,
f.height),this._eventManager.ghostCtx.restore());c.restore();return{source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0}}};var qa=function(a,d,c,b,e,f,l,h,m){if(!(0>c)){"undefined"===typeof h&&(h=1);if(!v){var k=Number((l%(2*Math.PI)).toFixed(8));Number((f%(2*Math.PI)).toFixed(8))===k&&(l-=1E-4)}a.save();a.globalAlpha=h;"pie"===e?(a.beginPath(),a.moveTo(d.x,d.y),a.arc(d.x,d.y,c,f,l,!1),a.fillStyle=b,a.strokeStyle="white",a.lineWidth=
...
f.indexLabelMaxWidth?f.indexLabelMaxWidth:k.indexLabelMaxWidth?k.indexLabelMaxWidth:0.33*q.width;h.indexLabelWrap="undefined"!==typeof f.indexLabelWrap?f.indexLabelWrap:k.indexLabelWrap;h.indexLabelTextAlign=f.indexLabelTextAlign?f.indexLabelTextAlign:k.indexLabelTextAlign?k.indexLabelTextAlign:"left";h.startAngle=0===e?k.startAngle?k.startAngle/180*Math.PI:0:g[e-1].endAngle;h.startAngle=(h.startAngle+2*Math.PI)%(2*Math.PI);h.endAngle=h.startAngle+2*Math.PI/A*Math.abs(f.y);f=(h.endAngle+h.startAngle)/
2;f=(f+2*Math.PI)%(2*Math.PI);h.midAngle=f;if(h.midAngle>Math.PI/2-t&&h.midAngle<Math.PI/2+t){if(0===a||g[c].midAngle>h.midAngle)c=e;a++}else if(h.midAngle>3*Math.PI/2-t&&h.midAngle<3*Math.PI/2+t){if(0===b||g[d].midAngle>h.midAngle)d=e;b++}h.hemisphere=f>Math.PI/2&&f<=3*Math.PI/2?"left":"right";h.indexLabelTextBlock=new ka(m.plotArea.ctx,{fontSize:h.indexLabelFontSize,fontFamily:h.indexLabelFontFamily,fontColor:h.indexLabelFontColor,fontStyle:h.indexLabelFontStyle,fontWeight:h.indexLabelFontWeight,
...
2<k&&p.indexLabelTextBlock.y+p.indexLabelTextBlock.height/2+c>h&&(c=p.indexLabelTextBlock.y+p.indexLabelTextBlock.height/2+c-h);c=p.indexLabelTextBlock.y+c;k=0;k="right"===p.hemisphere?x.x+Math.sqrt(Math.pow(v,2)-Math.pow(c-x.y,2)):x.x-Math.sqrt(Math.pow(v,2)-Math.pow(c-x.y,2));s=x.x+C*Math.cos(p.midAngle);q=x.y+C*Math.sin(p.midAngle);q=Math.sqrt(Math.pow(k-s,2)+Math.pow(c-q,2));s=Math.acos(C/v);q=Math.acos((v*v+C*C-q*q)/(2*C*v));c=q<s?c-p.indexLabelTextBlock.y:0;k=null;for(h=1;h<n.length;h++)if(k=
...
2),c-s<u&&(k=-s,h=f(h,k,d+1),+h.toFixed(y)>+k.toFixed(y)&&(l=c>u?-(c-u):-(s-(h-k)))))):0<c&&(h="right"===p.hemisphere?q:s,l=c,null!==h&&(s=c,c=g[h].indexLabelTextBlock.y-g[h].indexLabelTextBlock.height/2-(p.indexLabelTextBlock.y+p.indexLabelTextBlock.height/2),c-s<u&&(k=s,h=f(h,k,d+1),+h.toFixed(y)<+k.toFixed(y)&&(l=c>u?c-u:s-(k-h)))));l&&(d=p.indexLabelTextBlock.y+l,c=0,c="right"===p.hemisphere?x.x+Math.sqrt(Math.pow(v,2)-Math.pow(d-x.y,2)):x.x-Math.sqrt(Math.pow(v,2)-Math.pow(d-x.y,2)),p.midAngle>
...
C-d<=w)l=!1;l&&(C-=d);d=0;if("inside"!==k.indexLabelPlacement){v=C*D;for(a=0;a<n.length;a++){var h=g[a];h.indexLabelTextBlock.x=x.x+v*Math.cos(h.midAngle);h.indexLabelTextBlock.y=x.y+v*Math.sin(h.midAngle);h.indexLabelAngle=h.midAngle;h.radius=C;h.percentInnerRadius=E}for(var s,r,a=0;a<n.length;a++){var h=g[a],t=e(a);if(null!==t){s=g[a];r=g[t];var A=0,A=b(s,r)-u;if(0>A){for(var z=r=0,F=0;F<n.length;F++)F!==a&&g[F].hemisphere===h.hemisphere&&(g[F].indexLabelTextBlock.y<h.indexLabelTextBlock.y?r++:
z++);r=A/(r+z||1)*z;var z=-1*(A-r),G=F=0;"right"===h.hemisphere?(F=f(a,r),z=-1*(A-F),G=f(t,z),+G.toFixed(y)<+z.toFixed(y)&&+F.toFixed(y)<=+r.toFixed(y)&&f(a,-(z-G))):(F=f(t,r),z=-1*(A-F),G=f(a,z),+G.toFixed(y)<+z.toFixed(y)&&+F.toFixed(y)<=+r.toFixed(y)&&f(t,-(z-G)))}}}}else for(a=0;a<n.length;a++)h=g[a],v="pie"===k.type?0.7*C:0.8*C,t=x.x+v*Math.cos(h.midAngle),r=x.y+v*Math.sin(h.midAngle),h.indexLabelTextBlock.x=t,h.indexLabelTextBlock.y=r;for(a=0;a<n.length;a++)if(h=g[a],t=h.indexLabelTextBlock.measureText(),
0!==t.height&&0!==t.width)t=t=0,"right"===h.hemisphere?(t=q.x2-(h.indexLabelTextBlock.x+h.indexLabelTextBlock.width+p),t*=-1):t=q.x1-(h.indexLabelTextBlock.x-h.indexLabelTextBlock.width-p),0<t&&(!l&&h.indexLabelText&&(r="right"===h.hemisphere?q.x2-h.indexLabelTextBlock.x:h.indexLabelTextBlock.x-q.x1,0.3*h.indexLabelTextBlock.maxWidth>r?h.indexLabelText="":h.indexLabelTextBlock.maxWidth=0.85*r,0.3*h.indexLabelTextBlock.maxWidth<r&&(h.indexLabelTextBlock.x-="right"===h.hemisphere?2:-2)),Math.abs(h.indexLabelTextBlock.y-
h.indexLabelTextBlock.height/2-x.y)<C||Math.abs(h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2-x.y)<C)&&(t/=Math.abs(Math.cos(h.indexLabelAngle)),9<t&&(t*=0.3),t>d&&(d=t)),t=t=0,0<h.indexLabelAngle&&h.indexLabelAngle<Math.PI?(t=q.y2-(h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2+5),t*=-1):t=q.y1-(h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2-5),0<t&&(!l&&h.indexLabelText&&(r=0<h.indexLabelAngle&&h.indexLabelAngle<Math.PI?-1:1,0===f(a,t*r)&&f(a,2*r)),Math.abs(h.indexLabelTextBlock.x-
x.x)<C&&(t/=Math.abs(Math.sin(h.indexLabelAngle)),9<t&&(t*=0.3),t>d&&(d=t)));var J=function(a,b,c){for(var d=[],e=0;d.push(g[b]),b!==c;b=(b+1+n.length)%n.length);d.sort(function(a,b){return a.y-b.y});for(b=0;b<d.length;b++)if(c=d[b],e<0.7*a)e+=c.indexLabelTextBlock.height,c.indexLabelTextBlock.text="",c.indexLabelText="",c.indexLabelTextBlock.measureText();else break};(function(){for(var a=-1,c=-1,d=0,f=!1,k=0;k<n.length;k++)if(f=!1,s=g[k],s.indexLabelText){var l=e(k);if(null!==l){var h=g[l];A=0;
A=b(s,h);var q;if(q=0>A){q=s.indexLabelTextBlock.x;var m=s.indexLabelTextBlock.y-s.indexLabelTextBlock.height/2,r=s.indexLabelTextBlock.y+s.indexLabelTextBlock.height/2,u=h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2,t=h.indexLabelTextBlock.x+h.indexLabelTextBlock.width,B=h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2;q=s.indexLabelTextBlock.x+s.indexLabelTextBlock.width<h.indexLabelTextBlock.x-p||q>t+p||m>B+p||r<u-p?!1:!0}q?(0>a&&(a=k),l!==a&&(c=l,d+=-A),0===k%Math.max(n.length/
10,3)&&(f=!0)):f=!0;f&&(0<d&&0<=a&&0<=c)&&(J(d,a,c),c=a=-1,d=0)}}0<d&&J(d,a,c)})()}}function h(){m.plotArea.layoutManager.reset();m.title&&(m.title.dockInsidePlotArea||"center"===m.title.horizontalAlign&&"center"===m.title.verticalAlign)&&m.title.render();if(m.subtitles)for(var a=0;a<m.subtitles.length;a++){var b=m.subtitles[a];(b.dockInsidePlotArea||"center"===b.horizontalAlign&&"center"===b.verticalAlign)&&b.render()}m.legend&&(m.legend.dockInsidePlotArea||"center"===m.legend.horizontalAlign&&"center"===
m.legend.verticalAlign)&&(m.legend.setLayout(),m.legend.render())}var m=this;if(!(0>=a.dataSeriesIndexes.length)){var k=this.data[a.dataSeriesIndexes[0]],n=k.dataPoints,p=10,q=this.plotArea,g=k.dataPointEOs,u=2,v,D=1.3,t=20/180*Math.PI,y=6,x={x:(q.x2+q.x1)/2,y:(q.y2+q.y1)/2},A=0;a=!1;for(var z=0;z<n.length;z++)A+=Math.abs(n[z].y),!a&&("undefined"!==typeof n[z].indexLabel&&null!==n[z].indexLabel&&0<n[z].indexLabel.toString().length)&&(a=!0),!a&&("undefined"!==typeof n[z].label&&null!==n[z].label&&
0<n[z].label.toString().length)&&(a=!0);if(0!==A){a=a||"undefined"!==typeof k.indexLabel&&null!==k.indexLabel&&0<k.indexLabel.toString().length;var C="inside"!==k.indexLabelPlacement&&a?0.75*Math.min(q.width,q.height)/2:0.92*Math.min(q.width,q.height)/2;k.radius&&(C=Sa(k.radius,C));var w="undefined"!==typeof k.innerRadius&&null!==k.innerRadius?Sa(k.innerRadius,C):0.7*C;k.radius=C;"doughnut"===k.type&&(k.innerRadius=w);var E=Math.min(w/C,(C-1)/C);this.pieDoughnutClickHandler=function(a){m.isAnimating||
...
q.y1,q.width,q.height);for(var b=g[0].startAngle+2*Math.PI*a,c=0;c<n.length;c++){var d=0===c?g[c].startAngle:e,e=d+(g[c].endAngle-g[c].startAngle),f=!1;e>b&&(e=b,f=!0);var l=n[c].color?n[c].color:k._colorSet[c%k._colorSet.length];e>d&&qa(m.plotArea.ctx,g[c].center,g[c].radius,l,k.type,d,e,k.fillOpacity,g[c].percentInnerRadius);if(f)break}h();m.dispatchEvent("dataAnimationIterationEnd",{chart:m});1<=a&&m.dispatchEvent("dataAnimationEnd",{chart:m})},function(){m.disableToolTip=!1;m._animator.animate(0,
...
b=p)),d.push(n);return d}function b(){if(t&&y){for(var a,b,c,d,e,f,k,l,h,n,p,q,s,m,u,B=[],x=[],A={percent:null,total:null},C=null,z=0;z<y.length;z++)u=Q[z],u="undefined"!==typeof u.x5?(u.y2+u.y4)/2:(u.y2+u.y3)/2,u=g(u).x2+1,B[z]=L-u-X;u=0.5*X;for(var z=0,w=y.length-1;z<y.length||0<=w;z++,w--){b=t.reversed?y[w]:y[z];a=b.color?b.color:t.reversed?t._colorSet[(y.length-1-z)%t._colorSet.length]:t._colorSet[z%t._colorSet.length];c=b.indexLabelPlacement||t.indexLabelPlacement||"outside";m=b.indexLabelTextAlign||
t.indexLabelTextAlign||"left";d=b.indexLabelBackgroundColor||t.indexLabelBackgroundColor||(v?"transparent":null);e=b.indexLabelFontColor||t.indexLabelFontColor||"#979797";f=r(b.indexLabelFontSize)?t.indexLabelFontSize:b.indexLabelFontSize;k=b.indexLabelFontStyle||t.indexLabelFontStyle||"normal";l=b.indexLabelFontFamily||t.indexLabelFontFamily||"arial";h=b.indexLabelFontWeight||t.indexLabelFontWeight||"normal";a=b.indexLabelLineColor||t.options.indexLabelLineColor||a;n="number"===typeof b.indexLabelLineThickness?
b.indexLabelLineThickness:"number"===typeof t.indexLabelLineThickness?t.indexLabelLineThickness:2;p=b.indexLabelLineDashType||t.indexLabelLineDashType||"solid";q="undefined"!==typeof b.indexLabelWrap?b.indexLabelWrap:"undefined"!==typeof t.indexLabelWrap?t.indexLabelWrap:!0;s=t.dataPointIds[z];D._eventManager.objectMap[s]={id:s,objectType:"dataPoint",dataPointIndex:z,dataSeriesIndex:0,funnelSection:Q[t.reversed?y.length-1-z:z]};"inside"===t.indexLabelPlacement&&(B[z]=z!==da?t.reversed?Q[z].x2-Q[z].x1:
Q[z].x3-Q[z].x4:Q[z].x3-Q[z].x6,20>B[z]&&(B[z]=z!==da?t.reversed?Q[z].x3-Q[z].x4:Q[z].x2-Q[z].x1:Q[z].x2-Q[z].x1,B[z]/=2));s=b.indexLabelMaxWidth?b.indexLabelMaxWidth:t.options.indexLabelMaxWidth?t.indexLabelMaxWidth:B[z];if(s>B[z]||0>s)s=B[z];x[z]="inside"===t.indexLabelPlacement?Q[z].height:!1;A=D.getPercentAndTotal(t,b);if(t.indexLabelFormatter||b.indexLabelFormatter)C={chart:D.options,dataSeries:t,dataPoint:b,total:A.total,percent:A.percent};b=b.indexLabelFormatter?b.indexLabelFormatter(C):b.indexLabel?
D.replaceKeywordsWithValue(b.indexLabel,b,t,z):t.indexLabelFormatter?t.indexLabelFormatter(C):t.indexLabel?D.replaceKeywordsWithValue(t.indexLabel,b,t,z):b.label?b.label:"";0>=n&&(n=0);1E3>s&&1E3-s<u&&(s+=1E3-s);R.roundRect||Ca(R);c=new ka(R,{fontSize:f,fontFamily:l,fontColor:e,fontStyle:k,fontWeight:h,horizontalAlign:c,textAlign:m,backgroundColor:d,maxWidth:s,maxHeight:!1===x[z]?q?4.28571429*f:1.5*f:x[z],text:b,padding:ea});c.measureText();I.push({textBlock:c,id:t.reversed?w:z,isDirty:!1,lineColor:a,
lineThickness:n,lineDashType:p,height:c.height<c.maxHeight?c.height:c.maxHeight,width:c.width<c.maxWidth?c.width:c.maxWidth})}}}function e(){var a,b,c,d,e,f=[];e=!1;c=0;for(var g,k=L-Y-X/2,k=t.options.indexLabelMaxWidth?t.indexLabelMaxWidth>k?k:t.indexLabelMaxWidth:k,l=I.length-1;0<=l;l--){g=y[I[l].id];c=I[l];d=c.textBlock;b=(a=q(l)<Q.length?I[q(l)]:null)?a.textBlock:null;c=c.height;a&&d.y+c+ea>b.y&&(e=!0);c=g.indexLabelMaxWidth||k;if(c>k||0>c)c=k;f.push(c)}if(e)for(l=I.length-1;0<=l;l--)a=Q[l],I[l].textBlock.maxWidth=
f[f.length-(l+1)],I[l].textBlock.measureText(),I[l].textBlock.x=L-k,c=I[l].textBlock.height<I[l].textBlock.maxHeight?I[l].textBlock.height:I[l].textBlock.maxHeight,e=I[l].textBlock.width<I[l].textBlock.maxWidth?I[l].textBlock.width:I[l].textBlock.maxWidth,I[l].height=c,I[l].width=e,c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,I[l].textBlock.y=c-I[l].height/2,t.reversed?(I[l].textBlock.y+I[l].height>V+A&&(I[l].textBlock.y=V+A-I[l].height),I[l].textBlock.y<ta-A&&(I[l].textBlock.y=ta-A)):
(I[l].textBlock.y<V-A&&(I[l].textBlock.y=V-A),I[l].textBlock.y+I[l].height>ta+A&&(I[l].textBlock.y=ta+A-I[l].height))}function f(){var a,b,c,d;if("inside"!==t.indexLabelPlacement)for(var e=0;e<Q.length;e++)0==I[e].textBlock.text.length?I[e].isDirty=!0:(a=Q[e],c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,b=t.reversed?"undefined"!==typeof a.x5?c>Ba?g(c).x2+1:(a.x2+a.x3)/2+1:(a.x2+a.x3)/2+1:"undefined"!==typeof a.x5?c<Ba?g(c).x2+1:(a.x4+a.x3)/2+1:(a.x2+a.x3)/2+1,I[e].textBlock.x=b+X,I[e].textBlock.y=
c-I[e].height/2,t.reversed?(I[e].textBlock.y+I[e].height>V+A&&(I[e].textBlock.y=V+A-I[e].height),I[e].textBlock.y<ta-A&&(I[e].textBlock.y=ta-A)):(I[e].textBlock.y<V-A&&(I[e].textBlock.y=V-A),I[e].textBlock.y+I[e].height>ta+A&&(I[e].textBlock.y=ta+A-I[e].height)));else for(e=0;e<Q.length;e++)0==I[e].textBlock.text.length?I[e].isDirty=!0:(a=Q[e],b=a.height,c=I[e].height,d=I[e].width,b>=c?(b=e!=da?(a.x4+a.x3)/2-d/2:(a.x5+a.x4)/2-d/2,c=e!=da?(a.y1+a.y3)/2-c/2:(a.y1+a.y4)/2-c/2,I[e].textBlock.x=b,I[e].textBlock.y=
c):I[e].isDirty=!0)}function l(){function a(b,c){var d;if(0>b||b>=I.length)return 0;var e,f=I[b].textBlock;if(0>c){c*=-1;e=p(b);d=h(e,b);if(d>=c)return f.y-=c,c;if(0==b)return 0<d&&(f.y-=d),d;d+=a(e,-(c-d));0<d&&(f.y-=d);return d}e=q(b);d=h(b,e);if(d>=c)return f.y+=c,c;if(b==Q.length-1)return 0<d&&(f.y+=d),d;d+=a(e,c-d);0<d&&(f.y+=d);return d}function b(){var a,d,e,f,g=0,l;f=(O-K+2*A)/n;l=n;for(var k,h=1;h<l;h++){e=h*f;for(var s=I.length-1;0<=s;s--)!I[s].isDirty&&(I[s].textBlock.y<e&&I[s].textBlock.y+
I[s].height>e)&&(k=q(s),!(k>=I.length-1)&&I[s].textBlock.y+I[s].height+ea>I[k].textBlock.y&&(I[s].textBlock.y=I[s].textBlock.y+I[s].height-e>e-I[s].textBlock.y?e+1:e-I[s].height-1))}for(k=Q.length-1;0<k;k--)if(!I[k].isDirty){e=p(k);if(0>e&&(e=0,I[e].isDirty))break;if(I[k].textBlock.y<I[e].textBlock.y+I[e].height){d=d||k;f=k;for(l=0;I[f].textBlock.y<I[e].textBlock.y+I[e].height+ea;){a=a||I[f].textBlock.y+I[f].height;l+=I[f].height;l+=ea;f=e;if(0>=f){f=0;l+=I[f].height;break}e=p(f);if(0>e){f=0;l+=I[f].height;
break}}if(f!=k){g=I[f].textBlock.y;a-=g;a=l-a;g=c(a,d,f);break}}}return g}function c(a,b,d){var e=[],f=0,g=0;for(a=Math.abs(a);d<=b;d++)e.push(Q[d]);e.sort(function(a,b){return a.height-b.height});for(d=0;d<e.length;d++)if(b=e[d],f<a)g++,f+=I[b.id].height+ea,I[b.id].textBlock.text="",I[b.id].indexLabelText="",I[b.id].isDirty=!0,I[b.id].textBlock.measureText();else break;return g}for(var d,e,f,g,l,k,n=1,m=0;m<2*n;m++){for(var r=I.length-1;0<=r&&!(0<=p(r)&&p(r),f=I[r],g=f.textBlock,k=(l=q(r)<Q.length?
I[q(r)]:null)?l.textBlock:null,d=+f.height.toFixed(6),e=+g.y.toFixed(6),!f.isDirty&&(l&&e+d+ea>+k.y.toFixed(6))&&(d=g.y+d+ea-k.y,e=a(r,-d),e<d&&(0<e&&(d-=e),e=a(q(r),d),e!=d)));r--);b()}}function h(a,b){return(b<Q.length?I[b].textBlock.y:t.reversed?V+A:ta+A)-(0>a?t.reversed?ta-A:V-A:I[a].textBlock.y+I[a].height+ea)}function m(a,b,c){var d,e,g,l=[],h=A,p=[];-1!==b&&(0<=W.indexOf(b)?(e=W.indexOf(b),W.splice(e,1)):(W.push(b),W=W.sort(function(a,b){return a-b})));if(0===W.length)l=ja;else{e=A*(1!=W.length||
0!=W[0]&&W[0]!=Q.length-1?2:1)/k();for(var s=0;s<Q.length;s++){if(1==W.length&&0==W[0]){if(0===s){l.push(ja[s]);d=h;continue}}else 0===s&&(d=-1*h);l.push(ja[s]+d);if(0<=W.indexOf(s)||s<Q.length&&0<=W.indexOf(s+1))d+=e}}g=function(){for(var a=[],b=0;b<Q.length;b++)a.push(l[b]-Q[b].y1);return a}();var q={startTime:(new Date).getTime(),duration:c||500,easingFunction:function(a,b,c,d){return M.easing.easeOutQuart(a,b,c,d)},changeSection:function(a){for(var b,c,d=0;d<Q.length;d++)b=g[d],c=Q[d],b*=a,"undefined"===
typeof p[d]&&(p[d]=0),0>p&&(p*=-1),c.y1+=b-p[d],c.y2+=b-p[d],c.y3+=b-p[d],c.y4+=b-p[d],c.y5&&(c.y5+=b-p[d],c.y6+=b-p[d]),p[d]=b}};a._animator.animate(0,c,function(c){var d=a.plotArea.ctx||a.ctx;ia=!0;d.clearRect(x.x1,x.y1,x.x2-x.x1,x.y2-x.y1);d.fillStyle=a.backgroundColor;d.fillRect(x.x1,x.y1,x.width,x.height);q.changeSection(c,b);var e={};e.dataSeries=t;e.dataPoint=t.reversed?t.dataPoints[y.length-1-b]:t.dataPoints[b];e.index=t.reversed?y.length-1-b:b;a.toolTip.highlightObjects([e]);for(e=0;e<Q.length;e++)sa(d,
Q[e],t.fillOpacity);w(d);G&&("inside"!==t.indexLabelPlacement?n(d):f(),u(d));1<=c&&(ia=!1)},null,M.easing.easeOutQuart)}function k(){for(var a=0,b=0;b<Q.length-1;b++)(0<=W.indexOf(b)||0<=W.indexOf(b+1))&&a++;return a}function n(a){for(var b,c,d,e,f=0;f<Q.length;f++)e=1===I[f].lineThickness%2?0.5:0,c=((Q[f].y2+Q[f].y4)/2<<0)+e,b=g(c).x2-1,d=I[f].textBlock.x,e=(I[f].textBlock.y+I[f].height/2<<0)+e,I[f].isDirty||0==I[f].lineThickness||(a.strokeStyle=I[f].lineColor,a.lineWidth=I[f].lineThickness,a.setLineDash&&
a.setLineDash(J(I[f].lineDashType,I[f].lineThickness)),a.beginPath(),a.moveTo(b,c),a.lineTo(d,e),a.stroke())}function p(a){for(a-=1;-1<=a&&-1!=a&&I[a].isDirty;a--);return a}function q(a){for(a+=1;a<=Q.length&&a!=Q.length&&I[a].isDirty;a++);return a}function g(a){for(var b,c=0;c<y.length;c++)if(Q[c].y1<a&&Q[c].y4>a){b=Q[c];break}return b?(a=b.y6?a>b.y6?b.x3+(b.x4-b.x3)/(b.y4-b.y3)*(a-b.y3):b.x2+(b.x3-b.x2)/(b.y3-b.y2)*(a-b.y2):b.x2+(b.x3-b.x2)/(b.y3-b.y2)*(a-b.y2),{x1:a,x2:a}):-1}function u(a){for(var b=
0;b<Q.length;b++)I[b].isDirty||(a&&(I[b].textBlock.ctx=a),I[b].textBlock.render(!0))}function w(a){D.plotArea.layoutManager.reset();a.roundRect||Ca(a);D.title&&(D.title.dockInsidePlotArea||"center"===D.title.horizontalAlign&&"center"===D.title.verticalAlign)&&(D.title.ctx=a,D.title.render());if(D.subtitles)for(var b=0;b<D.subtitles.length;b++){var c=D.subtitles[b];if(c.dockInsidePlotArea||"center"===c.horizontalAlign&&"center"===c.verticalAlign)D.subtitles.ctx=a,c.render()}D.legend&&(D.legend.dockInsidePlotArea||
"center"===D.legend.horizontalAlign&&"center"===D.legend.verticalAlign)&&(D.legend.ctx=a,D.legend.setLayout(),D.legend.render());T.fNg&&T.fNg(D)}var D=this;if(!(0>=a.dataSeriesIndexes.length)){for(var t=this.data[a.dataSeriesIndexes[0]],y=t.dataPoints,x=this.plotArea,A=0.025*x.width,z=0.01*x.width,C=0,E=x.height-2*A,F=Math.min(x.width-2*z,2.8*x.height),G=!1,S=0;S<y.length;S++)if(!G&&("undefined"!==typeof y[S].indexLabel&&null!==y[S].indexLabel&&0<y[S].indexLabel.toString().length)&&(G=!0),!G&&("undefined"!==
typeof y[S].label&&null!==y[S].label&&0<y[S].label.toString().length)&&(G=!0),!G&&"function"===typeof t.indexLabelFormatter||"function"===typeof y[S].indexLabelFormatter)G=!0;G=G||"undefined"!==typeof t.indexLabel&&null!==t.indexLabel&&0<t.indexLabel.toString().length;"inside"!==t.indexLabelPlacement&&G||(z=(x.width-0.75*F)/2);var S=x.x1+z,L=x.x2-z,K=x.y1+A,O=x.y2-A,R=a.targetCanvasCtx||this.plotArea.ctx||this.ctx;if(0!=t.length&&(t.dataPoints&&t.visible)&&0!==y.length){var P,H;a=75*F/100;var X=30*
(L-a)/100;"funnel"===t.type?(P=r(t.options.neckHeight)?0.35*E:t.neckHeight,H=r(t.options.neckWidth)?0.25*a:t.neckWidth,"string"===typeof P&&P.match(/%$/)?(P=parseInt(P),P=P*E/100):P=parseInt(P),"string"===typeof H&&H.match(/%$/)?(H=parseInt(H),H=H*a/100):H=parseInt(H),P>E?P=E:0>=P&&(P=0),H>a?H=a-0.5:0>=H&&(H=0)):"pyramid"===t.type&&(H=P=0,t.reversed=t.reversed?!1:!0);var z=S+a/2,Z=S,Y=S+a,V=t.reversed?O:K,N=z-H/2,$=z+H/2,Ba=t.reversed?K+P:O-P,ta=t.reversed?K:O;a=[];var z=[],Q=[],F=[],ba=K,da,ca=(Ba-
V)/(N-Z),fa=-ca,S="area"===(t.valueRepresents?t.valueRepresents:"height")?c():d();if(-1!==S){if(t.reversed)for(F.push(ba),H=S.length-1;0<H;H--)ba+=S[H],F.push(ba);else for(H=0;H<S.length;H++)ba+=S[H],F.push(ba);if(t.reversed)for(H=0;H<S.length;H++)F[H]<Ba?(a.push(N),z.push($),da=H):(a.push((F[H]-V+ca*Z)/ca),z.push((F[H]-V+fa*Y)/fa));else for(H=0;H<S.length;H++)F[H]<Ba?(a.push((F[H]-V+ca*Z)/ca),z.push((F[H]-V+fa*Y)/fa),da=H):(a.push(N),z.push($));for(H=0;H<S.length-1;H++)ba=t.reversed?y[y.length-1-
H].color?y[y.length-1-H].color:t._colorSet[(y.length-1-H)%t._colorSet.length]:y[H].color?y[H].color:t._colorSet[H%t._colorSet.length],H===da?Q.push({x1:a[H],y1:F[H],x2:z[H],y2:F[H],x3:$,y3:Ba,x4:z[H+1],y4:F[H+1],x5:a[H+1],y5:F[H+1],x6:N,y6:Ba,id:H,height:F[H+1]-F[H],color:ba}):Q.push({x1:a[H],y1:F[H],x2:z[H],y2:F[H],x3:z[H+1],y3:F[H+1],x4:a[H+1],y4:F[H+1],id:H,height:F[H+1]-F[H],color:ba});var ea=2,I=[],ia=!1,W=[],ja=[],S=!1;a=a=0;Da(W);for(H=0;H<y.length;H++)y[H].exploded&&(S=!0,t.reversed?W.push(y.length-
1-H):W.push(H));R.clearRect(x.x1,x.y1,x.width,x.height);R.fillStyle=D.backgroundColor;R.fillRect(x.x1,x.y1,x.width,x.height);if(G&&t.visible&&(b(),f(),e(),"inside"!==t.indexLabelPlacement)){l();for(H=0;H<y.length;H++)I[H].isDirty||(a=I[H].textBlock.x+I[H].width,a=(L-a)/2,0==H&&(C=a),C>a&&(C=a));for(H=0;H<Q.length;H++)Q[H].x1+=C,Q[H].x2+=C,Q[H].x3+=C,Q[H].x4+=C,Q[H].x5&&(Q[H].x5+=C,Q[H].x6+=C),I[H].textBlock.x+=C}for(H=0;H<Q.length;H++)C=Q[H],sa(R,C,t.fillOpacity),ja.push(C.y1);w(R);G&&t.visible&&
("inside"===t.indexLabelPlacement||D.animationEnabled||n(R),D.animationEnabled||u());if(!G)for(H=0;H<y.length;H++)C=t.dataPointIds[H],a={id:C,objectType:"dataPoint",dataPointIndex:H,dataSeriesIndex:0,funnelSection:Q[t.reversed?y.length-1-H:H]},D._eventManager.objectMap[C]=a;!D.animationEnabled&&S?m(D,-1,0):D.animationEnabled&&!D.animatedRender&&m(D,-1,0);this.funnelPyramidClickHandler=function(a){var b=-1;if(!ia&&!D.isAnimating&&(r(a.dataSeries.explodeOnClick)||a.dataSeries.explodeOnClick)&&(b=t.reversed?
y.length-1-a.dataPointIndex:a.dataPointIndex,0<=b)){a=b;if("funnel"===t.type||"pyramid"===t.type)t.reversed?y[y.length-1-a].exploded=y[y.length-1-a].exploded?!1:!0:y[a].exploded=y[a].exploded?!1:!0;m(D,b,500)}};return{source:R,dest:this.plotArea.ctx,animationCallback:function(a,b){M.fadeInAnimation(a,b);1<=a&&(m(D,-1,500),w(D.plotArea.ctx||D.ctx))},easingFunction:M.easing.easeInQuad,animationBase:0}}}}};m.prototype.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||
...
d.document.close()}}};m.prototype.print=function(){var a=this.exportChart({toDataURL:!0}),d=document.createElement("iframe");d.setAttribute("class","canvasjs-chart-print-frame");L(d,{position:"absolute",width:"100%",border:"0px",margin:"0px 0px 0px 0px",padding:"0px 0px 0px 0px"});d.style.height=this.height+"px";this._canvasJSContainer.appendChild(d);var c=this,b=d.contentWindow||d.contentDocument.document||d.contentDocument;b.document.open();b.document.write('<!DOCTYPE HTML>\n<html><body><img src="'+
...
p.type&&"pyramid"!==p.type){var q=p.legendMarkerType=p.legendMarkerType?p.legendMarkerType:"line"!==p.type&&"stepLine"!==p.type&&"spline"!==p.type&&"scatter"!==p.type&&"bubble"!==p.type||!p.markerType?"error"===p.type&&p._linkedSeries?p._linkedSeries.legendMarkerType?p._linkedSeries.legendMarkerType:Z.getDefaultLegendMarker(p._linkedSeries.type):Z.getDefaultLegendMarker(p.type):p.markerType,g=p.legendText?p.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,
dataSeries:p,dataPoint:null}):p.name,u=p.legendMarkerColor=p.legendMarkerColor?p.legendMarkerColor:p.markerColor?p.markerColor:"error"===p.type?r(p.whiskerColor)?p._colorSet[0]:p.whiskerColor:p._colorSet[0],v=p.markerSize||"line"!==p.type&&"stepLine"!==p.type&&"spline"!==p.type?0.75*this.lineHeight:0,D=p.legendMarkerBorderColor?p.legendMarkerBorderColor:p.markerBorderColor,t=p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:p.markerBorderThickness?Math.max(1,Math.round(0.2*v)):0;"error"===
p.type&&this.errorMarkerColor.push(u);g=this.chart.replaceKeywordsWithValue(g,p.dataPoints[0],p,n);q={markerType:q,markerColor:u,text:g,textBlock:null,chartType:p.type,markerSize:v,lineColor:p._colorSet[0],dataSeriesIndex:p.index,dataPointIndex:null,markerBorderColor:D,markerBorderThickness:t};m.push(q)}else for(var y=0;y<p.dataPoints.length;y++){var x=p.dataPoints[y],q=x.legendMarkerType?x.legendMarkerType:p.legendMarkerType?p.legendMarkerType:Z.getDefaultLegendMarker(p.type),g=x.legendText?x.legendText:
p.legendText?p.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:p,dataPoint:x}):x.name?x.name:"DataPoint: "+(y+1),u=x.legendMarkerColor?x.legendMarkerColor:p.legendMarkerColor?p.legendMarkerColor:x.color?x.color:p.color?p.color:p._colorSet[y%p._colorSet.length],v=0.75*this.lineHeight,D=x.legendMarkerBorderColor?x.legendMarkerBorderColor:p.legendMarkerBorderColor?p.legendMarkerBorderColor:x.markerBorderColor?x.markerBorderColor:p.markerBorderColor,
t=x.legendMarkerBorderThickness?x.legendMarkerBorderThickness:p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:x.markerBorderThickness||p.markerBorderThickness?Math.max(1,Math.round(0.2*v)):0,g=this.chart.replaceKeywordsWithValue(g,x,p,y),q={markerType:q,markerColor:u,text:g,textBlock:null,chartType:p.type,markerSize:v,dataSeriesIndex:n,dataPointIndex:y,markerBorderColor:D,markerBorderThickness:t};(x.showInLegend||p.showInLegend&&!1!==x.showInLegend)&&m.push(q)}}!0===this.reversed&&m.reverse();
if(0<m.length){p=null;u=g=x=y=0;x=null!==this.itemWidth?null!==this.itemMaxWidth?Math.min(this.itemWidth,this.itemMaxWidth,f):this.itemMaxWidth=Math.min(this.itemWidth,f):null!==this.itemMaxWidth?Math.min(this.itemMaxWidth,f):this.itemMaxWidth=f;v=0===v?0.75*this.lineHeight:v;x-=v+h;for(n=0;n<m.length;n++){q=m[n];D=x;if("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType)D-=2*0.1*this.lineHeight;if(!(0>=l||"undefined"===typeof l||0>=D||"undefined"===typeof D)){if("horizontal"===
this.orientation){q.textBlock=new ka(this.ctx,{x:0,y:0,maxWidth:D,maxHeight:this.itemWrap?l:this.lineHeight,angle:0,text:q.text,horizontalAlign:"left",fontSize:this.fontSize,fontFamily:this.fontFamily,fontWeight:this.fontWeight,fontColor:this.fontColor,fontStyle:this.fontStyle,textBaseline:"middle"});q.textBlock.measureText();null!==this.itemWidth&&(q.textBlock.width=this.itemWidth-(v+h+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0)));if(!p||p.width+
...
q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0));p.items.push(q);this.width=Math.max(p.width,this.width);u=q.textBlock.width+(v+h+("line"===q.chartType||"spline"===q.chartType||"stepLine"===q.chartType?2*0.1*this.lineHeight:0))}}this.itemWidth=u;this.height=!1===this.itemWrap?k.length*this.lineHeight:this.height+g;this.height=Math.min(l,this.height);this.width=Math.min(f,this.width)}"top"===this.verticalAlign?(e="left"===this.horizontalAlign?d.x1:"right"===this.horizontalAlign?d.x2-
...
this.ctx.roundRect(a,d,this.width,this.height,this.cornerRadius,this.borderThickness,this.backgroundColor,this.borderColor);for(var h=0,m=0;m<l.length;m++){for(var k=l[m],n=0,p=0;p<k.items.length;p++){var q=k.items[p],g=q.textBlock.x+a+(0===p?0.2*f:this.horizontalSpacing),r=d+h,v=g;this.chart.data[q.dataSeriesIndex].visible||(this.ctx.globalAlpha=0.5);this.ctx.save();this.ctx.beginPath();this.ctx.rect(a,d,b,Math.max(e-e%this.lineHeight,0));this.ctx.clip();if("line"===q.chartType||"stepLine"===q.chartType||
"spline"===q.chartType)this.ctx.strokeStyle=q.lineColor,this.ctx.lineWidth=Math.ceil(this.lineHeight/8),this.ctx.beginPath(),this.ctx.moveTo(g-0.1*this.lineHeight,r+this.lineHeight/2),this.ctx.lineTo(g+0.85*this.lineHeight,r+this.lineHeight/2),this.ctx.stroke(),v-=0.1*this.lineHeight;if("error"===q.chartType){this.ctx.strokeStyle=this.errorMarkerColor[0];this.ctx.lineWidth=f/8;this.ctx.beginPath();var D=g-0.08*this.lineHeight+0.1*this.lineHeight,t=r+0.15*this.lineHeight,y=0.7*this.lineHeight,x=y+
0.02*this.lineHeight;this.ctx.moveTo(D,t);this.ctx.lineTo(D+y,t);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(D+y/2,t);this.ctx.lineTo(D+y/2,t+x);this.ctx.stroke();this.ctx.beginPath();this.ctx.moveTo(D,t+x);this.ctx.lineTo(D+y,t+x);this.ctx.stroke();this.errorMarkerColor.shift()}$.drawMarker(g+f/2,r+this.lineHeight/2,this.ctx,q.markerType,"error"===q.chartType||"line"===q.chartType||"spline"===q.chartType?q.markerSize/2:q.markerSize,q.markerColor,q.markerBorderColor,q.markerBorderThickness);
q.textBlock.x=g+c+f;if("line"===q.chartType||"stepLine"===q.chartType||"spline"===q.chartType)q.textBlock.x+=0.1*this.lineHeight;q.textBlock.y=Math.round(r+this.lineHeight/2);q.textBlock.render(!0);this.ctx.restore();n=0<p?Math.max(n,q.textBlock.height):q.textBlock.height;this.chart.data[q.dataSeriesIndex].visible||(this.ctx.globalAlpha=1);g=P(q.id);this.ghostCtx.fillStyle=g;this.ghostCtx.beginPath();this.ghostCtx.fillRect(v,q.textBlock.y-this.lineHeight/2,q.textBlock.x+q.textBlock.width-v,q.textBlock.height);
q.x1=this.chart._eventManager.objectMap[q.id].x1=v;q.y1=this.chart._eventManager.objectMap[q.id].y1=q.textBlock.y-this.lineHeight/2;q.x2=this.chart._eventManager.objectMap[q.id].x2=q.textBlock.x+q.textBlock.width;q.y2=this.chart._eventManager.objectMap[q.id].y2=q.textBlock.y+q.textBlock.height-this.lineHeight/2}h+=n}};pa(Z,Y);Z.prototype.getDefaultAxisPlacement=function(){var a=this.type;if("column"===a||"line"===a||"stepLine"===a||"spline"===a||"area"===a||"stepArea"===a||"splineArea"===a||"stackedColumn"===
a||"stackedLine"===a||"bubble"===a||"scatter"===a||"stackedArea"===a||"stackedColumn100"===a||"stackedLine100"===a||"stackedArea100"===a||"candlestick"===a||"ohlc"===a||"rangeColumn"===a||"rangeArea"===a||"rangeSplineArea"===a||"boxAndWhisker"===a||"waterfall"===a)return"normal";if("bar"===a||"stackedBar"===a||"stackedBar100"===a||"rangeBar"===a)return"xySwapped";if("pie"===a||"doughnut"===a||"funnel"===a||"pyramid"===a)return"none";"error"!==a&&window.console.log("Unknown Chart Type: "+a);return null};
Z.getDefaultLegendMarker=function(a){if("column"===a||"stackedColumn"===a||"stackedLine"===a||"bar"===a||"stackedBar"===a||"stackedBar100"===a||"bubble"===a||"scatter"===a||"stackedColumn100"===a||"stackedLine100"===a||"stepArea"===a||"candlestick"===a||"ohlc"===a||"rangeColumn"===a||"rangeBar"===a||"rangeArea"===a||"rangeSplineArea"===a||"boxAndWhisker"===a||"waterfall"===a)return"square";if("line"===a||"stepLine"===a||"spline"===a||"pie"===a||"doughnut"===a)return"circle";if("area"===a||"splineArea"===
a||"stackedArea"===a||"stackedArea100"===a||"funnel"===a||"pyramid"===a)return"triangle";if("error"===a)return"none";window.console.log("Unknown Chart Type: "+a);return null};Z.prototype.getDataPointAtX=function(a,d){if(!this.dataPoints||0===this.dataPoints.length)return null;var c={dataPoint:null,distance:Infinity,index:NaN},b=null,e=0,f=0,l=1,h=Infinity,m=0,k=0,n=0;"none"!==this.chart.plotInfo.axisPlacement&&(this.axisX.logarithmic?(n=Math.log(this.dataPoints[this.dataPoints.length-1].x/this.dataPoints[0].x),
...
h=b:0<l?m++:k++;if(1E3<m&&1E3<k)break}else if(0>n-e&&n+e>=this.dataPoints.length)break;-1===l?(e++,l=1):l=-1}return d||(c.dataPoint.x.getTime?c.dataPoint.x.getTime():c.dataPoint.x)!==(a.getTime?a.getTime():a)?d&&null!==c.dataPoint?c:null:c};Z.prototype.getDataPointAtXY=function(a,d,c){if(!this.dataPoints||0===this.dataPoints.length||a<this.chart.plotArea.x1||a>this.chart.plotArea.x2||d<this.chart.plotArea.y1||d>this.chart.plotArea.y2)return null;c=c||!1;var b=[],e=0,f=0,l=1,h=!1,m=Infinity,k=0,n=
...
a),Math.abs(q.x2-a),Math.abs(q.y1-d),Math.abs(q.y2-d))}),h=!0);break;case "line":case "stepLine":case "spline":case "area":case "stepArea":case "stackedArea":case "stackedArea100":case "splineArea":case "scatter":var v=ma("markerSize",g,this)||4,D=c?20:v,r=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));r<=D&&b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:r});q=Math.abs(q.x1-a);q<=m?m=q:0<l?k++:n++;r<=v/2&&(h=!0);break;case "rangeArea":case "rangeSplineArea":v=ma("markerSize",g,this)||
4;D=c?20:v;r=Math.min(Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2)),Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y2-d,2)));r<=D&&b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:r});q=Math.abs(q.x1-a);q<=m?m=q:0<l?k++:n++;r<=v/2&&(h=!0);break;case "bubble":v=q.size;r=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));r<=v/2&&(b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:r}),h=!0);break;case "pie":case "doughnut":v=q.center;D="doughnut"===this.type?q.percentInnerRadius*q.radius:
0;r=Math.sqrt(Math.pow(v.x-a,2)+Math.pow(v.y-d,2));r<q.radius&&r>D&&(r=Math.atan2(d-v.y,a-v.x),0>r&&(r+=2*Math.PI),r=Number(((180*(r/Math.PI)%360+360)%360).toFixed(12)),v=Number(((180*(q.startAngle/Math.PI)%360+360)%360).toFixed(12)),D=Number(((180*(q.endAngle/Math.PI)%360+360)%360).toFixed(12)),0===D&&1<q.endAngle&&(D=360),v>=D&&0!==g.y&&(D+=360,r<v&&(r+=360)),r>v&&r<D&&(b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:0}),h=!0));break;case "funnel":case "pyramid":r=q.funnelSection;
...
X[this.intervalType+"Duration"]*this.interval,f="undefined"===typeof this.options.labelMaxWidth?0.5*this.chart.width>>0:this.options.labelMaxWidth,this.chart.panEnabled||(l="undefined"===typeof this.options.labelWrap||this.labelWrap?0.8*this.chart.height>>0:1.5*this.labelFontSize);else if("left"===this._position||"right"===this._position)h=this.logarithmic&&!this.equidistantInterval&&2<=this._labels.length?this.lineCoordinates.height*Math.log(Math.min(this._labels[this._labels.length-1].position/
this._labels[this._labels.length-2].position,this._labels[1].position/this._labels[0].position))/Math.log(this.range):this.lineCoordinates.height/(this.logarithmic&&this.equidistantInterval?Math.log(this.range)/Math.log(this.logarithmBase):Math.abs(this.range))*X[this.intervalType+"Duration"]*this.interval,this.chart.panEnabled||(f="undefined"===typeof this.options.labelMaxWidth?0.3*this.chart.width>>0:this.options.labelMaxWidth),l="undefined"===typeof this.options.labelWrap||this.labelWrap?0.3*this.chart.height>>
0:1.5*this.labelFontSize;for(b=0;b<this._labels.length;b++){a=this._labels[b].textBlock;a.maxWidth=f;a.maxHeight=l;var u=a.measureText();m=u.height}e=[];q=p=0;if(this.labelAutoFit||this.options.labelAutoFit)if(r(this.labelAngle)||(this.labelAngle=(this.labelAngle%360+360)%360,90<this.labelAngle&&270>this.labelAngle?this.labelAngle-=180:270<=this.labelAngle&&360>=this.labelAngle&&(this.labelAngle-=360)),"bottom"===this._position||"top"===this._position)if(f=0.9*h>>0,q=0,!this.chart.panEnabled&&1<=
...
(this.sessionVariables.labelMaxWidth=Math.min(Math.max(f,q),n),this.sessionVariables.labelWrap=this.labelWrap,d&&u.width+d.width>>0>2*f&&(this.sessionVariables.labelAngle=-25)):(this.sessionVariables.labelWrap=this.labelWrap,this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth,this.sessionVariables.labelAngle=this.sessionVariables.labelMaxWidth>f?-25:this.sessionVariables.labelAngle):r(this.options.labelMaxWidth)?(this.sessionVariables.labelWrap=this.labelWrap,this.sessionVariables.labelMaxHeight=
l,this.sessionVariables.labelMaxWidth=f,d&&u.width+d.width>>0>2*f&&(this.sessionVariables.labelAngle=-25,this.sessionVariables.labelMaxWidth=n)):(this.sessionVariables.labelAngle=this.sessionVariables.labelMaxWidth>f?-25:this.sessionVariables.labelAngle,this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth,this.sessionVariables.labelMaxHeight=l,this.sessionVariables.labelWrap=this.labelWrap);else{if(r(this.options.labelWrap))if(!r(this.options.labelMaxWidth))this.options.labelMaxWidth<f?
(this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth,this.sessionVariables.labelMaxHeight=b):(this.sessionVariables.labelAngle=-25,this.sessionVariables.labelMaxWidth=this.options.labelMaxWidth,this.sessionVariables.labelMaxHeight=l);else if(!r(d))if(b=u.width+d.width>>0,g=this.labelFontSize,q<f)b-2*f>p&&(p=b-2*f,b>=2*f&&b<2.2*f?(this.sessionVariables.labelMaxWidth=f,r(this.options.labelFontSize)&&12<g&&(g=Math.floor(12/13*g),a.measureText()),this.sessionVariables.labelFontSize=r(this.options.labelFontSize)?
...
!0,b=0;b<this._labels.length;b++)a=this._labels[b].textBlock,a.maxWidth=this.sessionVariables.labelMaxWidth=Math.min(Math.max(f,q),n),u=a.measureText(),b<this._labels.length-1&&(g=b+1,d=this._labels[g].textBlock,d.maxWidth=this.sessionVariables.labelMaxWidth=Math.min(Math.max(f,q),n),d=d.measureText(),u.width+d.width>>0>2*f&&(this.sessionVariables.labelAngle=-25))}else(this.sessionVariables.labelAngle=this.labelAngle,this.sessionVariables.labelMaxHeight=0===this.labelAngle?l:Math.min((b-f*Math.cos(Math.PI/
...
Math.cos(Math.PI/180*Math.abs(this.labelAngle));Math.sin(Math.PI/180*Math.abs(this.labelAngle));r(this.options.labelAngle)&&isNaN(this.options.labelAngle)&&0!==this.options.labelAngle?r(this.options.labelWrap)?r(this.options.labelWrap)&&(r(this.options.labelMaxWidth)?r(d)||(h=u.height+d.height>>0,h-2*l>q&&(q=h-2*l,h>=2*l&&h<2.4*l?(r(this.options.labelFontSize)&&12<this.labelFontSize&&(this.labelFontSize=Math.floor(12/13*this.labelFontSize),a.measureText()),this.sessionVariables.labelMaxHeight=l,this.sessionVariables.labelFontSize=
...
q[g].scaleBreaks._appliedBreaks.length)for(var u=q[g].scaleBreaks._appliedBreaks,v=0;v<u.length&&!(u[v].startValue>q[g].viewportMaximum);v++)u[v].endValue<q[g].viewportMinimum||(r(q[g].scaleBreaks.firstBreakIndex)&&(q[g].scaleBreaks.firstBreakIndex=v),u[v].startValue>=q[g].viewPortMinimum&&(q[g].scaleBreaks.lastBreakIndex=v));for(var w=v=0,t=0,y=0,x=0,A=0,z=0,C,E,F=h=0,G,J,K,u=G=J=K=!1,g=0;g<q.length;g++)q[g]&&q[g].title&&(q[g]._titleTextBlock=new ka(q[g].ctx,{text:q[g].title,horizontalAlign:"center",
fontSize:q[g].titleFontSize,fontFamily:q[g].titleFontFamily,fontWeight:q[g].titleFontWeight,fontColor:q[g].titleFontColor,fontStyle:q[g].titleFontStyle,borderColor:q[g].titleBorderColor,borderThickness:q[g].titleBorderThickness,backgroundColor:q[g].titleBackgroundColor,cornerRadius:q[g].titleCornerRadius,textBaseline:"top"}));for(g=0;g<q.length;g++)if(q[g].title)switch(q[g]._position){case "left":q[g]._titleTextBlock.maxWidth=q[g].titleMaxWidth||f.height;q[g]._titleTextBlock.maxHeight=q[g].titleWrap?
0.8*f.width:1.5*q[g].titleFontSize;q[g]._titleTextBlock.angle=-90;break;case "right":q[g]._titleTextBlock.maxWidth=q[g].titleMaxWidth||f.height;q[g]._titleTextBlock.maxHeight=q[g].titleWrap?0.8*f.width:1.5*q[g].titleFontSize;q[g]._titleTextBlock.angle=90;break;default:q[g]._titleTextBlock.maxWidth=q[g].titleMaxWidth||f.width,q[g]._titleTextBlock.maxHeight=q[g].titleWrap?0.8*f.height:1.5*q[g].titleFontSize,q[g]._titleTextBlock.angle=0}if("normal"===e){for(var y=[],x=[],A=[],z=[],L=[],M=[],O=[],P=[];4>
v;){var H=0,R=0,T=0,V=0,X=e=0,N=0,Z=0,W=0,Y=0,Q=0,$=0;if(c&&0<c.length)for(A=[],g=Q=0;g<c.length;g++)A.push(Math.ceil(c[g]?c[g].createLabelsAndCalculateWidth():0)),Q+=A[g],N+=c[g]&&!n.isNavigator?c[g].margin:0;else A.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateWidth():0));O.push(A);if(b&&0<b.length)for(z=[],g=$=0;g<b.length;g++)z.push(Math.ceil(b[g]?b[g].createLabelsAndCalculateWidth():0)),$+=z[g],Z+=b[g]?b[g].margin:0;else z.push(Math.ceil(b[0]?b[0].createLabelsAndCalculateWidth():0));P.push(z);
l=Math.round(f.x1+Q+N);m=Math.round(f.x2-$-Z>n.width-p?n.width-p:f.x2-$-Z);if(a&&0<a.length)for(y=[],g=W=0;g<a.length;g++)a[g]&&(a[g].lineCoordinates={}),a[g].lineCoordinates.width=Math.abs(m-l),a[g].title&&(a[g]._titleTextBlock.maxWidth=0<a[g].titleMaxWidth&&a[g].titleMaxWidth<a[g].lineCoordinates.width?a[g].titleMaxWidth:a[g].lineCoordinates.width),y.push(Math.ceil(a[g]?a[g].createLabelsAndCalculateHeight():0)),W+=y[g],e+=a[g]&&!n.isNavigator?a[g].margin:0;else y.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateHeight():
0));L.push(y);if(d&&0<d.length)for(x=[],g=Y=0;g<d.length;g++)d[g]&&(d[g].lineCoordinates={}),d[g].lineCoordinates.width=Math.abs(m-l),d[g].title&&(d[g]._titleTextBlock.maxWidth=0<d[g].titleMaxWidth&&d[g].titleMaxWidth<d[g].lineCoordinates.width?d[g].titleMaxWidth:d[g].lineCoordinates.width),x.push(Math.ceil(d[g]?d[g].createLabelsAndCalculateHeight():0)),Y+=x[g],X+=d[g]&&!n.isNavigator?d[g].margin:0;else x.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateHeight():0));M.push(x);if(a&&0<a.length)for(g=
...
h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle))),!a[g]||(!a[g].labelAutoFit||r(C)||r(E)||n.isNavigator||n.stockChart)||(h=0,0<a[g].labelAngle?E+t>m&&(h+=0<a[g].labelAngle?E+t-m-$:0):0>a[g].labelAngle?C-w<l&&C-w<a[g].viewportMinimum&&(F=l-(N+a[g].tickLength+A+C-w+a[g].labelFontSize/2)):0===a[g].labelAngle&&(E+t>m&&(h=E+t/2-m-$),C-w<l&&C-w<a[g].viewportMinimum&&(F=l-N-a[g].tickLength-A-C+w/2)),a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0<a[g].labelAngle&&
0<h?m-=h:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0>a[g].labelAngle&&0<F?l+=F:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0===a[g].labelAngle&&(0<F&&(l+=F),0<h&&(m-=h))),n.panEnabled?W=r(n.sessionVariables.axisX.height)?n.sessionVariables.axisX.height=W:n.sessionVariables.axisX.height:n.sessionVariables.axisX.height=W,h=Math.round(f.y2-W-e+H),k=Math.round(f.y2),a[g].lineCoordinates.x2=m,a[g].lineCoordinates.width=m-l,a[g].lineCoordinates.y1=
h,a[g].lineCoordinates.y2=h+a[g].lineThickness/2,"inside"===a[g].labelPlacement&&0<g&&(a[g].lineCoordinates.y1=a[g].lineCoordinates.y1+y[g]-(a[g]._titleTextBlock?a[g]._titleTextBlock.height:0)-("inside"===a[g].tickPlacement?a[g].tickLength:0),a[g].lineCoordinates.y2=a[g].lineCoordinates.y1+a[g].lineThickness/2),a[g].bounds={x1:l,y1:h,x2:m,y2:k-(W+e-y[g]-H),width:m-l,height:k-h}),H+=y[g]+a[g].margin;if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].lineCoordinates.x1=Math.round(f.x1+Q+N),d[g].lineCoordinates.x2=
...
h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle))),n.panEnabled?Y=r(n.sessionVariables.axisX2.height)?n.sessionVariables.axisX2.height=Y:n.sessionVariables.axisX2.height:n.sessionVariables.axisX2.height=Y,h=Math.round(f.y1),k=Math.round(f.y2+d[g].margin),d[g].lineCoordinates.y1=h+Y+X-R,d[g].lineCoordinates.y2=h,"inside"===d[g].labelPlacement&&0<g&&(d[g].lineCoordinates.y1=d[g-1].bounds.y1-x[g]+(d[g]._titleTextBlock?d[g]._titleTextBlock.height:0)),d[g].bounds={x1:l,y1:h+(Y+
X-x[g]-R),x2:m,y2:k,width:m-l,height:k-h},R+=x[g]+d[g].margin;if(c&&0<c.length)for(g=0;g<c.length;g++)N=n.isNavigator?0:10,c[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),N=c[g]._labels&&0<c[g]._labels.length?c[g]._labels[c[g]._labels.length-1].textBlock.height/2:p,h=Math.round(f.y1+Y+X<Math.max(N,p)?Math.max(N,p):f.y1+Y+X),m=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),N=0<a.length?0:c[g]._labels&&0<c[g]._labels.length?c[g]._labels[0].textBlock.height/
2:p,k=Math.round(f.y2-W-e-N),c[g].lineCoordinates={x1:l-T,y1:h,x2:m-T,y2:k,height:Math.abs(k-h)},"inside"===c[g].labelPlacement&&0<g&&(c[g].lineCoordinates.x1=c[g].lineCoordinates.x1-(A[g]-(c[g]._titleTextBlock?c[g]._titleTextBlock.height:0))+("outside"===c[g].tickPlacement?c[g].tickLength:0),c[g].lineCoordinates.x2=c[g].lineCoordinates.x1+c[g].lineThickness/2),c[g].bounds={x1:l-(A[g]+T),y1:h,x2:m,y2:k,width:m-l,height:k-h},c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.height?c[g].titleMaxWidth:c[g].lineCoordinates.height),T+=A[g]+c[g].margin);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x2:d[0].lineCoordinates.x2),m=Math.round(l),N=b[g]._labels&&0<b[g]._labels.length?b[g]._labels[b[g]._labels.length-1].textBlock.height/2:0,h=Math.round(f.y1+Y+X<Math.max(N,p)?Math.max(N,p):f.y1+Y+X),N=0<a.length?0:b[g]._labels&&0<b[g]._labels.length?b[g]._labels[0].textBlock.height/2:0,k=Math.round(f.y2-(W+e+N)),b[g].lineCoordinates=
{x1:l+V,y1:h,x2:l+V,y2:k,height:Math.abs(k-h)},"inside"===b[g].labelPlacement&&0<g&&(b[g].lineCoordinates.x1=b[g].lineCoordinates.x1+(z[g]-(b[g]._titleTextBlock?b[g]._titleTextBlock.height:0))-("outside"===b[g].tickPlacement?b[g].tickLength:0)-2,b[g].lineCoordinates.x2=b[g].lineCoordinates.x1+b[g].lineThickness/2),b[g].bounds={x1:l,y1:h,x2:m+(z[g]+V),y2:k,width:m-l,height:k-h},b[g].title&&(b[g]._titleTextBlock.maxWidth=0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.height?b[g].titleMaxWidth:
b[g].lineCoordinates.height),V+=z[g]+b[g].margin);if(a&&0<a.length)for(g=0;g<a.length;g++)a[g]&&(a[g].calculateValueToPixelConversionParameters(),a[g].calculateBreaksSizeInValues(),a[g]._labels&&1<a[g]._labels.length&&(C=(a[g].logarithmic?Math.log(a[g]._labels[1].position/a[g].viewportMinimum)/a[g].conversionParameters.lnLogarithmBase:a[g]._labels[1].position-a[g].viewportMinimum)*Math.abs(a[g].conversionParameters.pixelPerUnit)+a[g].lineCoordinates.x1,l=a[g]._labels[a[g]._labels.length-("dateTime"===
a[g].valueType?2:1)].position,l=a[g].getApparentDifference(a[g].viewportMinimum,l),E=a[g].logarithmic?(1<l?Math.log(l)/a[g].conversionParameters.lnLogarithmBase*Math.abs(a[g].conversionParameters.pixelPerUnit):0)+a[g].lineCoordinates.x1:(0<l?l*Math.abs(a[g].conversionParameters.pixelPerUnit):0)+a[g].lineCoordinates.x1));if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].calculateValueToPixelConversionParameters(),d[g].calculateBreaksSizeInValues(),d[g]._labels&&1<d[g]._labels.length&&(C=(d[g].logarithmic?
...
(0<l?l*Math.abs(d[g].conversionParameters.pixelPerUnit):0)+d[g].lineCoordinates.x1);for(g=0;g<q.length;g++)"axisY"===q[g].type&&(q[g].calculateValueToPixelConversionParameters(),q[g].calculateBreaksSizeInValues());if(0<v){if(a&&0<a.length)for(g=0;g<a.length;g++)u=L[v-1][g]===L[v][g]?!0:!1;else u=!0;if(d&&0<d.length)for(g=0;g<d.length;g++)G=M[v-1][g]===M[v][g]?!0:!1;else G=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)J=O[v-1][g]===O[v][g]?!0:!1;else J=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)K=P[v-
1][g]===P[v][g]?!0:!1;else K=!0}if(u&&G&&J&&K)break;v++}if(a&&0<a.length)for(g=0;g<a.length;g++)a[g].calculateStripLinesThicknessInValues(),a[g].calculateBreaksInPixels();if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].calculateStripLinesThicknessInValues(),d[g].calculateBreaksInPixels();if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].calculateStripLinesThicknessInValues(),c[g].calculateBreaksInPixels();if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].calculateStripLinesThicknessInValues(),b[g].calculateBreaksInPixels()}else{p=
[];C=[];F=[];w=[];E=[];t=[];L=[];for(M=[];4>v;){W=V=R=T=Z=N=X=e=P=O=H=Y=0;if(a&&0<a.length)for(F=[],g=V=0;g<a.length;g++)F.push(Math.ceil(a[g]?a[g].createLabelsAndCalculateWidth():0)),V+=F[g],e+=a[g]&&!n.isNavigator?a[g].margin:0;else F.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateWidth():0));L.push(F);if(d&&0<d.length)for(w=[],g=W=0;g<d.length;g++)w.push(Math.ceil(d[g]?d[g].createLabelsAndCalculateWidth():0)),W+=w[g],X+=d[g]?d[g].margin:0;else w.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateWidth():
0));M.push(w);if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].lineCoordinates={},l=Math.round(f.x1+V+e),m=Math.round(f.x2-W-X>n.width-10?n.width-10:f.x2-W-X),c[g].labelAutoFit&&!r(y)&&(0<!a.length&&(l=0>c[g].labelAngle?Math.max(l,y):0===c[g].labelAngle?Math.max(l,y/2):l),0<!d.length&&(m=0<c[g].labelAngle?m-x/2:0===c[g].labelAngle?m-x/2:m)),c[g].lineCoordinates.x1=l,c[g].lineCoordinates.x2=m,c[g].lineCoordinates.width=Math.abs(m-l),c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].lineCoordinates={},l=Math.round(f.x1+V+e),m=Math.round(f.x2-W-X>b[g].chart.width-10?b[g].chart.width-10:f.x2-W-X),b[g]&&b[g].labelAutoFit&&!r(A)&&(0<!a.length&&(l=0<b[g].labelAngle?Math.max(l,A):0===b[g].labelAngle?Math.max(l,A/2):l),0<!d.length&&(m-=z/2)),b[g].lineCoordinates.x1=l,b[g].lineCoordinates.x2=m,b[g].lineCoordinates.width=Math.abs(m-l),b[g].title&&(b[g]._titleTextBlock.maxWidth=
0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.width?b[g].titleMaxWidth:b[g].lineCoordinates.width);if(c&&0<c.length)for(p=[],g=T=0;g<c.length;g++)p.push(Math.ceil(c[g]?c[g].createLabelsAndCalculateHeight():0)),T+=p[g]+c[g].margin,N+=c[g].margin;else p.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateHeight():0));E.push(p);if(b&&0<b.length)for(C=[],g=R=0;g<b.length;g++)C.push(Math.ceil(b[g]?b[g].createLabelsAndCalculateHeight():0)),R+=C[g],Z+=b[g].margin;else C.push(Math.ceil(b[0]?
b[0].createLabelsAndCalculateHeight():0));t.push(C);if(c&&0<c.length)for(g=0;g<c.length;g++)0<c[g]._labels.length&&(k=c[g]._labels[0],h=c[g]._labels[c[g]._labels.length-1],y=k.textBlock.width*Math.cos(Math.PI/180*Math.abs(k.textBlock.angle))+(k.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle)),x=h.textBlock.width*Math.cos(Math.PI/180*Math.abs(h.textBlock.angle))+(h.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle)));
...
c[g].tickPlacement?c[g].tickLength:0),c[g].lineCoordinates.y2=c[g].lineCoordinates.y1+c[g].lineThickness/2),c[g].bounds={x1:l,y1:h-(p[g]+Y+c[g].margin),x2:m,y2:k-(Y+c[g].margin),width:m-l,height:p[g]},c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width),Y+=p[g]+c[g].margin;if(b&&0<b.length)for(g=b.length-1;0<=g;g--)b[g]&&(h=Math.round(f.y1),k=Math.round(f.y1+(C[g]+b[g].margin+H)),b[g].lineCoordinates.y1=
k,b[g].lineCoordinates.y2=k,"inside"===b[g].labelPlacement&&0<g&&(b[g].lineCoordinates.y1=k-C[g]+(b[g]._titleTextBlock?b[g]._titleTextBlock.height:0)),b[g].bounds={x1:l,y1:h+(b[g].margin+H),x2:m,y2:k,width:m-l,height:R},b[g].title&&(b[g]._titleTextBlock.maxWidth=0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.width?b[g].titleMaxWidth:b[g].lineCoordinates.width),H+=C[g]+b[g].margin);if(a&&0<a.length)for(g=0;g<a.length;g++){N=a[g]._labels&&0<a[g]._labels.length?a[g]._labels[0].textBlock.fontSize/
2:0;l=Math.round(f.x1+e);h=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:f.y1<Math.max(N,10)?Math.max(N,10):f.y1):f.y1<Math.max(N,10)?Math.max(N,10):f.y1;m=Math.round(f.x1+V+e);k=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:f.y2-T>n.height-Math.max(N,10)?n.height-Math.max(N,10):f.y2-T):f.y2>n.height-Math.max(N,10)?n.height-Math.max(N,10):f.y2;if(c&&0<c.length)for(N=0;N<c.length;N++)c[N]&&c[N].labelAutoFit&&(m=0>c[N].labelAngle?Math.max(m,y):0===c[N].labelAngle?Math.max(m,y/2):m,l=
0>c[N].labelAngle||0===c[N].labelAngle?m-V:l);if(b&&0<b.length)for(N=0;N<b.length;N++)b[N]&&b[N].labelAutoFit&&(m=b[N].lineCoordinates.x1,l=m-V);a[g].lineCoordinates={x1:m-O,y1:h,x2:m-O,y2:k,height:Math.abs(k-h)};"inside"===a[g].labelPlacement&&0<g&&(a[g].lineCoordinates.x1=a[g].lineCoordinates.x1-(F[g]-(a[g]._titleTextBlock?a[g]._titleTextBlock.height:0))+("outside"===a[g].tickPlacement?a[g].tickLength:0),a[g].lineCoordinates.x2=a[g].lineCoordinates.x1+a[g].lineThickness/2);a[g].bounds={x1:m-(F[g]+
O),y1:h,x2:m,y2:k,width:m-l,height:k-h};a[g].title&&(a[g]._titleTextBlock.maxWidth=0<a[g].titleMaxWidth&&a[g].titleMaxWidth<a[g].lineCoordinates.height?a[g].titleMaxWidth:a[g].lineCoordinates.height);a[g].calculateValueToPixelConversionParameters();a[g].calculateBreaksSizeInValues();O+=F[g]+a[g].margin}if(d&&0<d.length)for(g=0;g<d.length;g++){N=d[g]._labels&&0<d[g]._labels.length?d[g]._labels[0].textBlock.fontSize/2:0;l=Math.round(f.x1-e);h=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:f.y1<
Math.max(N,10)?Math.max(N,10):f.y1):f.y1<Math.max(N,10)?Math.max(N,10):f.y1;m=Math.round(f.x2-W-X);k=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:f.y2-T>n.height-Math.max(N,10)?n.height-Math.max(N,10):f.y2-T):f.y2>n.height-Math.max(N,10)?n.height-Math.max(N,10):f.y2;if(c&&0<c.length)for(N=0;N<c.length;N++)c[N]&&c[N].labelAutoFit&&(m=0>c[N].labelAngle?Math.max(m,y):0===c[N].labelAngle?Math.max(m,y/2):m,l=0>c[N].labelAngle||0===c[N].labelAngle?m-W:l);if(b&&0<b.length)for(N=0;N<b.length;N++)b[N]&&
b[N].labelAutoFit&&(m=b[N].lineCoordinates.x2,l=m-W);d[g].lineCoordinates={x1:m+P,y1:h,x2:m+P,y2:k,height:Math.abs(k-h)};"inside"===d[g].labelPlacement&&0<g&&(d[g].lineCoordinates.x1=d[g].lineCoordinates.x1+(w[g]-(d[g]._titleTextBlock?d[g]._titleTextBlock.height:0)-2)-("outside"===d[g].tickPlacement?d[g].tickLength:0),d[g].lineCoordinates.x2=d[g].lineCoordinates.x1+d[g].lineThickness/2);d[g].bounds={x1:d[g].lineCoordinates.x1,y1:h,x2:m+w[g]+P,y2:k,width:m-l,height:k-h};d[g].title&&(d[g]._titleTextBlock.maxWidth=
0<d[g].titleMaxWidth&&d[g].titleMaxWidth<d[g].lineCoordinates.height?d[g].titleMaxWidth:d[g].lineCoordinates.height);d[g].calculateValueToPixelConversionParameters();d[g].calculateBreaksSizeInValues();P+=w[g]+d[g].margin}for(g=0;g<q.length;g++)"axisY"===q[g].type&&(q[g].calculateValueToPixelConversionParameters(),q[g].calculateBreaksSizeInValues());if(0<v){if(a&&0<a.length)for(g=0;g<a.length;g++)u=L[v-1][g]===L[v][g]?!0:!1;else u=!0;if(d&&0<d.length)for(g=0;g<d.length;g++)G=M[v-1][g]===M[v][g]?!0:
!1;else G=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)J=E[v-1][g]===E[v][g]?!0:!1;else J=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)K=t[v-1][g]===t[v][g]?!0:!1;else K=!0}if(u&&G&&J&&K)break;v++}if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].calculateStripLinesThicknessInValues(),c[g].calculateBreaksInPixels();if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].calculateStripLinesThicknessInValues(),b[g].calculateBreaksInPixels();if(a&&0<a.length)for(g=0;g<a.length;g++)a[g].calculateStripLinesThicknessInValues(),
...
b/250<=a?(this.interval=250,this.intervalType="millisecond"):b/300<=a?(this.interval=300,this.intervalType="millisecond"):b/400<=a?(this.interval=400,this.intervalType="millisecond"):b/500<=a?(this.interval=500,this.intervalType="millisecond"):b/(1*X.secondDuration)<=a?(this.interval=1,this.intervalType="second"):b/(2*X.secondDuration)<=a?(this.interval=2,this.intervalType="second"):b/(5*X.secondDuration)<=a?(this.interval=5,this.intervalType="second"):b/(10*X.secondDuration)<=a?(this.interval=10,
this.intervalType="second"):b/(15*X.secondDuration)<=a?(this.interval=15,this.intervalType="second"):b/(20*X.secondDuration)<=a?(this.interval=20,this.intervalType="second"):b/(30*X.secondDuration)<=a?(this.interval=30,this.intervalType="second"):b/(1*X.minuteDuration)<=a?(this.interval=1,this.intervalType="minute"):b/(2*X.minuteDuration)<=a?(this.interval=2,this.intervalType="minute"):b/(5*X.minuteDuration)<=a?(this.interval=5,this.intervalType="minute"):b/(10*X.minuteDuration)<=a?(this.interval=
10,this.intervalType="minute"):b/(15*X.minuteDuration)<=a?(this.interval=15,this.intervalType="minute"):b/(20*X.minuteDuration)<=a?(this.interval=20,this.intervalType="minute"):b/(30*X.minuteDuration)<=a?(this.interval=30,this.intervalType="minute"):b/(1*X.hourDuration)<=a?(this.interval=1,this.intervalType="hour"):b/(2*X.hourDuration)<=a?(this.interval=2,this.intervalType="hour"):b/(3*X.hourDuration)<=a?(this.interval=3,this.intervalType="hour"):b/(6*X.hourDuration)<=a?(this.interval=6,this.intervalType=
"hour"):b/(1*X.dayDuration)<=a?(this.interval=1,this.intervalType="day"):b/(2*X.dayDuration)<=a?(this.interval=2,this.intervalType="day"):b/(4*X.dayDuration)<=a?(this.interval=4,this.intervalType="day"):b/(1*X.weekDuration)<=a?(this.interval=1,this.intervalType="week"):b/(2*X.weekDuration)<=a?(this.interval=2,this.intervalType="week"):b/(3*X.weekDuration)<=a?(this.interval=3,this.intervalType="week"):b/(1*X.monthDuration)<=a?(this.interval=1,this.intervalType="month"):b/(2*X.monthDuration)<=a?(this.interval=
2,this.intervalType="month"):b/(3*X.monthDuration)<=a?(this.interval=3,this.intervalType="month"):b/(6*X.monthDuration)<=a?(this.interval=6,this.intervalType="month"):(this.interval=b/(1*X.yearDuration)<=a?1:b/(2*X.yearDuration)<=a?2:b/(4*X.yearDuration)<=a?4:Math.floor(E.getNiceNumber(b/(a-1),!0)/X.yearDuration),this.intervalType="year"));if(null===this.viewportMinimum||isNaN(this.viewportMinimum))this.viewportMinimum=e-l/2;if(null===this.viewportMaximum||isNaN(this.viewportMaximum))this.viewportMaximum=
...
E.prototype.getLabelStartPoint=function(){var a=X[this.intervalType+"Duration"]*this.interval,a=new Date(Math.floor(this.viewportMinimum/a)*a);if("millisecond"!==this.intervalType)if("second"===this.intervalType)0<a.getMilliseconds()&&(a.setSeconds(a.getSeconds()+1),a.setMilliseconds(0));else if("minute"===this.intervalType){if(0<a.getSeconds()||0<a.getMilliseconds())a.setMinutes(a.getMinutes()+1),a.setSeconds(0),a.setMilliseconds(0)}else if("hour"===this.intervalType){if(0<a.getMinutes()||0<a.getSeconds()||
...
0,n=[];if("xySwapped"===this.chart.plotInfo.axisPlacement){var w=null;if("bottom"===this.parent._position||"top"===this.parent._position)u=this.parent.dataSeries[0].axisX.convertPixelToValue({y:d});else if("left"===this.parent._position||"right"===this.parent._position)u=this.parent.convertPixelToValue({y:d});for(var D=0;D<this.parent.dataSeries.length;D++)(w=this.parent.dataSeries[D].getDataPointAtX(u,!0))&&0<=w.index&&(w.dataSeries=this.parent.dataSeries[D],null!==w.dataPoint.y&&w.dataSeries.visible&&
n.push(w));w=null;if(0===n.length)return;n.sort(function(a,b){return a.distance-b.distance});w=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));D=0;if("rangeBar"===n[0].dataSeries.type||"error"===n[0].dataSeries.type)for(var w=Math.abs(a-this.parent.convertValueToPixel(n[D].dataPoint.y[0])),t=0,u=0;u<n.length;u++)if(n[u].dataPoint.y&&n[u].dataPoint.y.length)for(var y=0;y<n[u].dataPoint.y.length;y++)t=Math.abs(a-this.parent.convertValueToPixel(n[u].dataPoint.y[y])),t<w&&(w=t,D=u);else t=
Math.abs(a-this.parent.convertValueToPixel(n[u].dataPoint.y)),t<w&&(w=t,D=u);else if("stackedBar"===n[0].dataSeries.type)for(var w=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),x=t=0,u=D=0;u<n.length;u++)if(n[u].dataPoint.y&&n[u].dataPoint.y.length)for(y=0;y<n[u].dataPoint.y.length;y++)t=Math.abs(a-this.parent.convertValueToPixel(n[u].dataPoint.y[y])),t<w&&(w=t,D=u);else x+=n[u].dataPoint.y,t=Math.abs(a-this.parent.convertValueToPixel(x)),t<w&&(w=t,D=u);else if("stackedBar100"===n[0].dataSeries.type)for(var w=
Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),A=x=t=0,u=0;u<n.length;u++)if(n[u].dataPoint.y&&n[u].dataPoint.y.length)for(y=0;y<n[u].dataPoint.y.length;y++)t=Math.abs(a-this.parent.convertValueToPixel(n[u].dataPoint.y[y])),t<w&&(w=t,D=u);else x+=n[u].dataPoint.y,A=n[u].dataPoint.x.getTime?n[u].dataPoint.x.getTime():n[u].dataPoint.x,A=100*(x/n[u].dataSeries.plotUnit.dataPointYSums[A]),t=Math.abs(a-this.parent.convertValueToPixel(A)),t<w&&(w=t,D=u);else for(w=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),
u=D=t=0;u<n.length;u++)if(n[u].dataPoint.y&&n[u].dataPoint.y.length)for(y=0;y<n[u].dataPoint.y.length;y++)t=Math.abs(a-this.parent.convertValueToPixel(n[u].dataPoint.y[y])),t<w&&(w=t,D=u);else t=Math.abs(a-this.parent.convertValueToPixel(n[u].dataPoint.y)),t<w&&(w=t,D=u);y=n[D];if("bottom"===this.parent._position||"top"===this.parent._position){b=0;if("rangeBar"===this.parent.dataSeries[D].type||"error"===this.parent.dataSeries[D].type){w=Math.abs(a-this.parent.convertValueToPixel(y.dataPoint.y[0]));
for(u=t=0;u<y.dataPoint.y.length;u++)t=Math.abs(a-this.parent.convertValueToPixel(y.dataPoint.y[u])),t<w&&(w=t,b=u);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataPoint.y[b])<<0)+0.5:this.parent.convertValueToPixel(y.dataPoint.y[b])<<0;this.value=y.dataPoint.y[b];k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.y[b]}):r(this.options.label)?ea(r(c)?y.dataPoint.y[b]:c,this.valueFormatString,this.chart._cultureInfo):
this.label}else if("stackedBar"===this.parent.dataSeries[D].type){w=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));x=t=0;for(u=D;0<=u;u--)x+=n[u].dataPoint.y,t=Math.abs(a-this.parent.convertValueToPixel(x)),t<w&&(w=t,b=u);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(x)<<0)+0.5:this.parent.convertValueToPixel(x)<<0;this.value=x;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.y}):r(this.options.label)?
ea(r(c)?y.dataPoint.y:c,this.valueFormatString,this.chart._cultureInfo):this.label}else if("stackedBar100"===this.parent.dataSeries[D].type){w=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));A=x=t=0;for(u=D;0<=u;u--)x+=n[u].dataPoint.y,A=n[u].dataPoint.x.getTime?n[u].dataPoint.x.getTime():n[u].dataPoint.x,A=100*(x/n[u].dataSeries.plotUnit.dataPointYSums[A]),t=Math.abs(a-this.parent.convertValueToPixel(A)),t<w&&(w=t,b=u);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(A)<<0)+0.5:
this.parent.convertValueToPixel(A)<<0;this.value=A;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:A}):r(this.options.label)?ea(r(c)?A:c,this.valueFormatString,this.chart._cultureInfo):this.label}else m=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataPoint.y)<<0)+0.5:this.parent.convertValueToPixel(y.dataPoint.y)<<0,this.value=y.dataPoint.y,k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,
...
2)+2;k.y+k.height>this.chart.bounds.y2?k.y=this.chart.bounds.y2-k.height:k.y<this.chart.bounds.y1&&(k.y=this.chart.bounds.y1)}else if("left"===this.parent._position||"right"===this.parent._position){f=h=v=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(y.dataPoint.x)<<0;b=this.chart.plotArea.x1;e=this.chart.plotArea.x2;this.bounds={x1:b,y1:f-p/2,x2:e,y2:h+p/2};A=!1;if(this.parent.labels)for(n=Math.ceil(this.parent.interval),u=0;u<this.parent.viewportMaximum;u+=
n)if(this.parent.labels[u])A=!0;else{A=!1;break}if(A){if("axisX"===this.parent.type)for(u=this.parent.convertPixelToValue({y:d}),w=null,D=0;D<this.parent.dataSeries.length;D++)(w=this.parent.dataSeries[D].getDataPointAtX(u,!0))&&0<=w.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):r(this.options.label)?w.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,
axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):r(this.options.label)?Aa(y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):r(this.options.label)?ea(y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);this.value=y.dataPoint.x;k.y=h+k.fontSize/2-k.measureText().height/
2+2;k.y-k.fontSize/2<this.chart.bounds.y1?k.y=this.chart.bounds.y1+k.fontSize/2+2:k.y+k.measureText().height-k.fontSize/2>this.chart.bounds.y2&&(k.y=this.chart.bounds.y2-k.measureText().height+k.fontSize/2);"left"===this.parent._position?k.x=this.parent.lineCoordinates.x2-k.measureText().width:"right"===this.parent._position&&(k.x=this.parent.lineCoordinates.x2)}}else if("bottom"===this.parent._position||"top"===this.parent._position){u=this.parent.convertPixelToValue({x:a});for(D=0;D<this.parent.dataSeries.length;D++)(w=
this.parent.dataSeries[D].getDataPointAtX(u,!0))&&0<=w.index&&(w.dataSeries=this.parent.dataSeries[D],null!==w.dataPoint.y&&w.dataSeries.visible&&n.push(w));if(0===n.length)return;n.sort(function(a,b){return a.distance-b.distance});y=n[0];b=e=m=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(y.dataPoint.x)<<0;f=this.chart.plotArea.y1;h=this.chart.plotArea.y2;this.bounds={x1:b-p/2,y1:f,x2:e+p/2,y2:h};A=!1;if(this.parent.labels)for(n=Math.ceil(this.parent.interval),
u=0;u<this.parent.viewportMaximum;u+=n)if(this.parent.labels[u])A=!0;else{A=!1;break}if(A){if("axisX"===this.parent.type)for(u=this.parent.convertPixelToValue({x:a}),w=null,D=0;D<this.parent.dataSeries.length;D++)(w=this.parent.dataSeries[D].getDataPointAtX(u,!0))&&0<=w.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):r(this.options.label)?w.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?
k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):r(this.options.label)?Aa(y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):r(this.options.label)?ea(y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);
this.value=y.dataPoint.x;k.x=b-k.measureText().width/2;k.x+k.width>this.chart.bounds.x2&&(k.x=this.chart.bounds.x2-k.width);k.x<this.chart.bounds.x1&&(k.x=this.chart.bounds.x1);"bottom"===this.parent._position?k.y=this.parent.lineCoordinates.y2+k.fontSize/2+2:"top"===this.parent._position&&(k.y=this.parent.lineCoordinates.y1-k.height+k.fontSize/2+2)}else if("left"===this.parent._position||"right"===this.parent._position){!r(this.parent.dataSeries)&&0<this.parent.dataSeries.length&&(u=this.parent.dataSeries[0].axisX.convertPixelToValue({x:a}));
for(D=0;D<this.parent.dataSeries.length;D++)(w=this.parent.dataSeries[D].getDataPointAtX(u,!0))&&0<=w.index&&(w.dataSeries=this.parent.dataSeries[D],null!==w.dataPoint.y&&w.dataSeries.visible&&n.push(w));if(0===n.length)return;n.sort(function(a,b){return a.distance-b.distance});D=0;if("rangeColumn"===n[0].dataSeries.type||"rangeArea"===n[0].dataSeries.type||"error"===n[0].dataSeries.type||"rangeSplineArea"===n[0].dataSeries.type||"candlestick"===n[0].dataSeries.type||"ohlc"===n[0].dataSeries.type||
"boxAndWhisker"===n[0].dataSeries.type)for(w=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y[0])),u=t=0;u<n.length;u++)if(n[u].dataPoint.y&&n[u].dataPoint.y.length)for(y=0;y<n[u].dataPoint.y.length;y++)t=Math.abs(d-this.parent.convertValueToPixel(n[u].dataPoint.y[y])),t<w&&(w=t,D=u);else t=Math.abs(d-this.parent.convertValueToPixel(n[u].dataPoint.y)),t<w&&(w=t,D=u);else if("stackedColumn"===n[0].dataSeries.type||"stackedArea"===n[0].dataSeries.type)for(w=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),
u=x=t=0;u<n.length;u++)if(n[u].dataPoint.y&&n[u].dataPoint.y.length)for(y=0;y<n[u].dataPoint.y.length;y++)t=Math.abs(d-this.parent.convertValueToPixel(n[u].dataPoint.y[y])),t<w&&(w=t,D=u);else x+=n[u].dataPoint.y,t=Math.abs(d-this.parent.convertValueToPixel(x)),t<w&&(w=t,D=u);else if("stackedColumn100"===n[0].dataSeries.type||"stackedArea100"===n[0].dataSeries.type)for(w=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),u=A=x=t=0;u<n.length;u++)if(n[u].dataPoint.y&&n[u].dataPoint.y.length)for(y=
0;y<n[u].dataPoint.y.length;y++)t=Math.abs(d-this.parent.convertValueToPixel(n[u].dataPoint.y[y])),t<w&&(w=t,D=u);else x+=n[u].dataPoint.y,A=n[u].dataPoint.x.getTime?n[u].dataPoint.x.getTime():n[u].dataPoint.x,A=100*(x/n[u].dataSeries.plotUnit.dataPointYSums[A]),t=Math.abs(d-this.parent.convertValueToPixel(A)),t<w&&(w=t,D=u);else for(w=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),u=t=0;u<n.length;u++)if(n[u].dataPoint.y&&n[u].dataPoint.y.length)for(y=0;y<n[u].dataPoint.y.length;y++)t=
Math.abs(d-this.parent.convertValueToPixel(n[u].dataPoint.y[y])),t<w&&(w=t,D=u);else t=Math.abs(d-this.parent.convertValueToPixel(n[u].dataPoint.y)),t<w&&(w=t,D=u);y=n[D];b=0;if("rangeColumn"===this.parent.dataSeries[D].type||"rangeArea"===this.parent.dataSeries[D].type||"error"===this.parent.dataSeries[D].type||"rangeSplineArea"===this.parent.dataSeries[D].type||"candlestick"===this.parent.dataSeries[D].type||"ohlc"===this.parent.dataSeries[D].type||"boxAndWhisker"===this.parent.dataSeries[D].type){w=
Math.abs(d-this.parent.convertValueToPixel(y.dataPoint.y[0]));for(u=t=0;u<y.dataPoint.y.length;u++)t=Math.abs(d-this.parent.convertValueToPixel(y.dataPoint.y[u])),t<w&&(w=t,b=u);v=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataPoint.y[b])<<0)+0.5:this.parent.convertValueToPixel(y.dataPoint.y[b])<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.y[b]}):r(this.options.label)?ea(r(c)?y.dataPoint.y[b]:c,this.valueFormatString,
this.chart._cultureInfo):this.label;this.value=y.dataPoint.y[b]}else if("stackedColumn"===this.parent.dataSeries[D].type||"stackedArea"===this.parent.dataSeries[D].type){w=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y));x=t=0;for(u=D;0<=u;u--)x+=n[u].dataPoint.y,t=Math.abs(d-this.parent.convertValueToPixel(x)),t<w&&(w=t,b=u);v=1===q.lineWidth%2?(this.parent.convertValueToPixel(x)<<0)+0.5:this.parent.convertValueToPixel(x)<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,
axis:this.parent.options,crosshair:this.options,value:y.dataPoint.y}):r(this.options.label)?ea(r(c)?y.dataPoint.y:c,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=x}else if("stackedColumn100"===this.parent.dataSeries[D].type||"stackedArea100"===this.parent.dataSeries[D].type){w=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y));x=t=0;for(u=D;0<=u;u--)x+=n[u].dataPoint.y,A=n[u].dataPoint.x.getTime?n[u].dataPoint.x.getTime():n[u].dataPoint.x,A=100*(x/n[u].dataSeries.plotUnit.dataPointYSums[A]),
t=Math.abs(d-this.parent.convertValueToPixel(A)),t<w&&(w=t,b=u);v=1===q.lineWidth%2?(this.parent.convertValueToPixel(A)<<0)+0.5:this.parent.convertValueToPixel(A)<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:A}):r(this.options.label)?ea(r(c)?A:c,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=A}else"waterfall"===this.parent.dataSeries[D].type?(v=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataSeries.dataPointEOs[y.index].cumulativeSum)<<
...
this.parent._position||"right"===this.parent._position){A=!1;if(this.parent.labels)for(n=Math.ceil(this.parent.interval),u=0;u<this.parent.viewportMaximum;u+=n)if(this.parent.labels[u])A=!0;else{A=!1;break}if(A){if("axisX"===this.parent.type)for(u=this.parent.convertPixelToValue({y:d}),w=null,D=0;D<this.parent.dataSeries.length;D++)(w=this.parent.dataSeries[D].getDataPointAtX(u,!0))&&0<=w.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,
...
2,k.x+k.width>this.chart.bounds.x2&&(k.x=this.chart.bounds.x2-k.width),k.x<this.chart.bounds.x1&&(k.x=this.chart.bounds.x1),"bottom"===this.parent._position?k.y=this.parent.lineCoordinates.y2+k.fontSize/2+2:"top"===this.parent._position&&(k.y=this.parent.lineCoordinates.y1-k.height+k.fontSize/2+2)}else if("bottom"===this.parent._position||"top"===this.parent._position){A=!1;n="";if(this.parent.labels)for(n=Math.ceil(this.parent.interval),u=0;u<this.parent.viewportMaximum;u+=n)if(this.parent.labels[u])A=
!0;else{A=!1;break}if(A){if("axisX"===this.parent.type)for(u=this.parent.convertPixelToValue({x:a}),w=null,D=0;D<this.parent.dataSeries.length;D++)(w=this.parent.dataSeries[D].getDataPointAtX(u,!0))&&0<=w.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:r(c)?this.parent.convertPixelToValue(a):c}):r(this.options.label)?r(c)?w.dataPoint.label:c:this.label)}else"dateTime"===this.parent.valueType?k.text=this.labelFormatter?
...
"right"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(v);this._textBlock=k;r(c)||this.renderLabel();q.globalAlpha=g};da.prototype.renderLabel=function(){r(this._textBlock)||(r(this._textBlock.text)||!("number"===typeof this._textBlock.text.valueOf()||0<this._textBlock.text.length)||this._hidden)||this._textBlock.render(!0)};pa(V,Y);V.prototype._initialize=function(){this.updateOption("updated");this.updateOption("hidden");if(this.enabled){this.container=document.createElement("div");
...
dataSeriesIndex:f[b].dataSeries._index});d={chart:this.chart,toolTip:this.options,content:c,entries:d};this._entries=f;this.dispatchEvent("updated",d,this)}}else this.hide(),this.enabled&&this.dispatchEvent("hidden",{chart:this.chart,toolTip:this},this)}};V.prototype.highlightObjects=function(a){var d=this.chart.overlaidCanvasCtx;if(r(this.chart.clearedOverlayedCanvas)||"toolTip"===this.chart.clearedOverlayedCanvas)this.chart.resetOverlayedCanvas(),d.clearRect(0,0,this.chart.width,this.chart.height),
...
e.lineColor,d.lineWidth=2*e.lineThickness,0<e.lineThickness&&(d.beginPath(),d.moveTo(e.x1,e.y5),d.lineTo(e.x2,e.y5),d.stroke()),d.restore(),d.globalAlpha=1):"error"===b.type&&F(d,e.x1,e.y1,e.x2,e.y2,"white",e.whiskerProperties,e.stemProperties,e.isXYSwapped,0.3))}}d.restore();d.globalAlpha=1;d.beginPath()};V.prototype.getToolTipInnerHTML=function(a){a=a.entries;var d=null,c=null,b=null,e=0,f="";this.isToolTipDefinedInData=!0;for(var h=0;h<a.length;h++)if(a[h].dataSeries.toolTipContent||a[h].dataPoint.toolTipContent){this.isToolTipDefinedInData=
...
F.version="v3.7.1 GA";window.CanvasJS&&(F&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=F)})();
